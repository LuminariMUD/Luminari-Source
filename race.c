...
const char *get_region_info(int region)
{
  switch (region)
  {
    ...
    case REGION_SCHALLSEA: return "";
    case REGION_SILVANESTI: return "";
    case REGION_SOLAMNIA: return "";
    case REGION_SOUTHERN_ERGOTH: return "";
    case REGION_TAMAN_BUSUK: return "";
    case REGION_TARSIS: return "";
    case REGION_TEYR: return "";
    case REGION_THORADIN: return "";
    case REGION_THORBARDIN: return "";
    case REGION_THROTL: return "";
  }
  return "Undefined";
}
#else
