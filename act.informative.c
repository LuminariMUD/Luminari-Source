...
/*0*/    {"summonable", PRF_SUMMONABLE, 0,
    "You are now safe from summoning by other players.\r\n",
    "You may now be summoned by other players.\r\n"},
/*1*/    {"nohassle", PRF_NOHASSLE, LVL_IMMORT,
    "Nohassle disabled.\r\n",
    "Nohassle enabled.\r\n"},
/*2*/    {"brief", PRF_BRIEF, 0,
    "Brief mode off.\r\n",
    "Brief mode on.\r\n"},
/*3*/    {"compact", PRF_COMPACT, 0,
    "Compact mode off.\r\n",
    "Compact mode on.\r\n"},
/*4*/    {"notell", PRF_NOTELL, 0,
    "You can now hear tells.\r\n",
    "You are now deaf to tells.\r\n"},
/*5*/    {"noauction", PRF_NOAUCT, 0,
    "You can now hear auctions.\r\n",
    "You are now deaf to auctions.\r\n"},
/*6*/    {"noshout", PRF_NOSHOUT, 0,
    "You can now hear shouts.\r\n",
    "You are now deaf to shouts.\r\n"},
/*7*/    {"nogossip", PRF_NOGOSS, 0,
    "You can now hear gossip.\r\n",
    "You are now deaf to gossip.\r\n"},
/*8*/    {"nograts", PRF_NOGRATZ, 0,
    "You can now hear gratz.\r\n",
    "You are now deaf to gratz.\r\n"},
/*9*/    {"nowiz", PRF_NOWIZ, LVL_IMMORT,
    "You can now hear the Wiz-channel.\r\n",
    "You are now deaf to the Wiz-channel.\r\n"},
/*10*/    {"quest", PRF_QUEST, 0,
    "You are no longer part of the Quest.\r\n",
    "Okay, you are part of the Quest.\r\n"},
/*11*/    {"showvnums", PRF_SHOWVNUMS, LVL_IMMORT,
    "You will no longer see the vnums.\r\n",
    "You will now see the vnums.\r\n"},
/*12*/    {"norepeat", PRF_NOREPEAT, 0,
    "You will now have your communication repeated.\r\n",
    "You will no longer have your communication repeated.\r\n"},
/*13*/    {"holylight", PRF_HOLYLIGHT, LVL_IMMORT,
    "HolyLight mode off.\r\n",
    "HolyLight mode on.\r\n"},
/*14*/    {"slownameserver", 0, LVL_IMPL,
...
/*15*/    {"autoexits", PRF_AUTOEXIT, 0,
    "Autoexits disabled.\r\n",
    "Autoexits enabled.\r\n"},
/*16*/    {"trackthru", 0, LVL_IMPL,
    "Players can no longer track through doors.\r\n",
    "Players can now track through doors.\r\n"},
/*17*/    {"clsolc", PRF_CLS, LVL_BUILDER,
    "You will no longer clear screen in OLC.\r\n",
    "You will now clear screen in OLC.\r\n"},
/*18*/    {"buildwalk", PRF_BUILDWALK, LVL_BUILDER,
    "Buildwalk is now Off.\r\n",
    "Buildwalk is now On.\r\n"},
/*19*/    {"afk", PRF_AFK, 0,
    "AFK is now Off.\r\n",
    "AFK is now On.\r\n"},
/*20*/    {"autoloot", PRF_AUTOLOOT, 0,
    "Autoloot disabled.\r\n",
    "Autoloot enabled.\r\n"},
/*21*/    {"autogold", PRF_AUTOGOLD, 0,
    "Autogold disabled.\r\n",
    "Autogold enabled.\r\n"},
/*22*/    {"autosplit", PRF_AUTOSPLIT, 0,
    "Autosplit disabled.\r\n",
    "Autosplit enabled.\r\n"},
/*23*/    {"autosac", PRF_AUTOSAC, 0,
    "Autosac disabled.\r\n",
    "Autosac enabled.\r\n"},
/*24*/    {"autoassist", PRF_AUTOASSIST, 0,
    "Autoassist disabled.\r\n",
    "Autoassist enabled.\r\n"},
/*25*/    {"automap", PRF_AUTOMAP, 1,
    "You will no longer see the mini-map.\r\n",
    "You will now see a mini-map at the side of room descriptions.\r\n"},
/*26*/    {"autokey", PRF_AUTOKEY, 0,
...
/*28*/    {"clantalk", PRF_NOCLANTALK, LVL_GOD,
     "You can now hear all clan's clantalk.\r\n",
     "All clantalk will now be hidden.\r\n"},
/*29*/    {"color", 0, 0, "\n", "\n"},
/*30*/    {"syslog", 0, LVL_IMMORT, "\n", "\n"},
/*31*/    {"wimpy", 0, 0, "\n", "\n"},
/*32*/    {"pagelength", 0, 0, "\n", "\n"},
/*33*/    {"screenwidth", 0, 0, "\n", "\n"},
/*34*/    {"autoscan", PRF_AUTOSCAN, 0,
    "Autoscan disabled.\r\n",
    "Autoscan enabled.\r\n"},
/*LAST*/    {"\n", 0, -1, "\n", "\n"} /* must be last */
  };
