...
#
# Usage: ./scripts/deployment/setup.sh
################################################################################
...
echo "  ./bin/luminari -d lib"
echo ""
echo "Default port is 4100. Connect with:"
echo "  telnet localhost 4100"
echo ""
echo "For more options, see: ./bin/luminari -h"
