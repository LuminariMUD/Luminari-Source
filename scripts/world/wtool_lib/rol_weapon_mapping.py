...
_RULES: list[tuple[str, Callable[[str], bool], int | _Resolver]] = [
    ...
    (
        "bastard sword",
        _phrase("bastard sword", "bastardsword", "hand and a half", "hand and a half sword"),
    ...
    ("rapier", _phrase("rapier", "foil", "epee", "estoc"), WEAPON_TYPE_IDS["WEAPON_TYPE_RAPIER"]),
    ("falchion", _phrase("falchion"), WEAPON_TYPE_IDS["WEAPON_TYPE_FALCHION"]),
    (
        "scimitar",
        _phrase("scimitar", "cutlass", "saber", "sabre", "tulwar", "talwar", "shamshir", "falcata"),
        lambda ctx: (
            WEAPON_TYPE_IDS["WEAPON_TYPE_FALCHION"]
            if ctx.two_handed
    ...
    ("knife", _phrase("knife", "knives", "scalpel", "shiv"), WEAPON_TYPE_IDS["WEAPON_TYPE_KNIFE"]),
    (
        "machete",
        _phrase("machete", "cleaver"),
        lambda ctx: (
            WEAPON_TYPE_IDS["WEAPON_TYPE_SHORT_SWORD"]
            if ctx.verb in SOURCE_VERB_SLASH
            else WEAPON_TYPE_IDS["WEAPON_TYPE_KNIFE"]
        ),
    ),
    (
        "katana",
        _phrase("katana", "nodachi", "no dachi", "daito"),
        lambda ctx: (
            WEAPON_TYPE_IDS["WEAPON_TYPE_GREAT_SWORD"]
            if ctx.two_handed
    ...
    (
        "generic sword",
        _phrase("sword", "swords", "blade", "blades", "mageblade", "moonblade"),
        lambda ctx: (
            WEAPON_TYPE_IDS["WEAPON_TYPE_GREAT_SWORD"]
            if ctx.two_handed
            else WEAPON_TYPE_IDS["WEAPON_TYPE_LONG_SWORD"]
    ...
    (
        "dwarven urgosh",
        _phrase("urgosh", "dwarven urgosh"),
        WEAPON_TYPE_IDS["WEAPON_TYPE_DWARVEN_URGOSH"],
    ),
    (
        "dwarven war axe",
        _phrase("dwarven war axe", "dwarven waraxe", "dwarven axe", "dwarven battle axe"),
        WEAPON_TYPE_IDS["WEAPON_TYPE_DWARVEN_WAR_AXE"],
    ),
    (
        "double axe",
        _phrase("double axe", "doubleaxe", "double bladed axe", "twin axe", "twin bladed axe"),
        WEAPON_TYPE_IDS["WEAPON_TYPE_DOUBLE_AXE"],
    ),
    (
        "throwing axe",
        _phrase("throwing axe", "throwing axes"),
        WEAPON_TYPE_IDS["WEAPON_TYPE_THROWING_AXE"],
    ),
    (
        "hand axe",
        _phrase("hand axe", "handaxe", "hatchet", "tomahawk", "francisca"),
        WEAPON_TYPE_IDS["WEAPON_TYPE_HAND_AXE"],
    ),
    (
        "great axe",
        _phrase("great axe", "greataxe", "greater axe", "huge axe", "massive axe"),
        WEAPON_TYPE_IDS["WEAPON_TYPE_GREAT_AXE"],
    ),
    (
        "pick",
        _phrase("pick", "pickaxe", "pick axe", "mattock"),
        lambda ctx: (
            WEAPON_TYPE_IDS["WEAPON_TYPE_HEAVY_PICK"]
            if ctx.two_handed
    ...
    ("glaive", _phrase("glaive", "naginata", "fauchard"), WEAPON_TYPE_IDS["WEAPON_TYPE_GLAIVE"]),
    (
        "guisarme",
        _phrase("guisarme", "bill hook", "billhook"),
        WEAPON_TYPE_IDS["WEAPON_TYPE_GUISARME"],
    ),
    ("ranseur", _phrase("ranseur", "partisan", "spetum"), WEAPON_TYPE_IDS["WEAPON_TYPE_RANSEUR"]),
    (
        "generic polearm",
        _phrase("polearm", "pole arm", "pole weapon"),
        WEAPON_TYPE_IDS["WEAPON_TYPE_HALBERD"],
    ),
    (
        "footmans lance",
        _phrase("footman s lance", "footmans lance"),
        WEAPON_TYPE_IDS["WEAPON_TYPE_FOOTMANS_LANCE"],
    ),
    ("lance", _phrase("lance"), WEAPON_TYPE_IDS["WEAPON_TYPE_LANCE"]),
    ("trident", _phrase("trident", "fork", "pitchfork"), WEAPON_TYPE_IDS["WEAPON_TYPE_TRIDENT"]),
    ("javelin", _phrase("javelin", "harpoon"), WEAPON_TYPE_IDS["WEAPON_TYPE_JAVELIN"]),
    (
        "longspear",
        _phrase("longspear", "long spear", "pike", "lugged spear"),
        WEAPON_TYPE_IDS["WEAPON_TYPE_LONGSPEAR"],
    ),
    (
        "shortspear",
        _phrase("shortspear", "short spear", "half spear"),
        WEAPON_TYPE_IDS["WEAPON_TYPE_SHORTSPEAR"],
    ),
    (
        "spear",
        _phrase("spear", "spears", "lance head", "assegai"),
        lambda ctx: (
            WEAPON_TYPE_IDS["WEAPON_TYPE_LONGSPEAR"]
            if ctx.two_handed
    ...
    (
        "battle axe",
        _phrase("battleaxe", "battle axe", "war axe", "waraxe"),
        lambda ctx: (
            WEAPON_TYPE_IDS["WEAPON_TYPE_GREAT_AXE"]
            if ctx.two_handed
    ...
    (
        "morningstar",
        _phrase("morningstar", "morning star"),
        WEAPON_TYPE_IDS["WEAPON_TYPE_MORNINGSTAR"],
    ),
    (
        "dire flail",
        _phrase("dire flail", "double flail"),
        WEAPON_TYPE_IDS["WEAPON_TYPE_DIRE_FLAIL"],
    ),
    (
        "flail",
        _phrase("flail", "flindbar", "nine tails", "cat o nine"),
        lambda ctx: (
            WEAPON_TYPE_IDS["WEAPON_TYPE_HEAVY_FLAIL"]
            if ctx.two_handed
    ...
    (
        "hooked hammer",
        _phrase("hooked hammer", "gnome hooked hammer"),
        WEAPON_TYPE_IDS["WEAPON_TYPE_HOOKED_HAMMER"],
    ),
    (
        "light hammer",
        _phrase("light hammer", "throwing hammer", "tack hammer"),
    ...
    (
        "warhammer",
        _phrase("warhammer", "war hammer", "hammer", "mallet"),
        lambda ctx: (
            WEAPON_TYPE_IDS["WEAPON_TYPE_WARMAUL"]
            if ctx.two_handed
    ...
    (
        "mace",
        _phrase("mace", "scepter", "sceptre", "flanged mace"),
        lambda ctx: (
            WEAPON_TYPE_IDS["WEAPON_TYPE_HEAVY_MACE"]
            if ctx.two_handed
    ...
    (
        ...
        lambda ctx: (
            WEAPON_TYPE_IDS["WEAPON_TYPE_GREAT_CLUB"]
            if ctx.two_handed
    ...
    (
        "spiked chain",
        _phrase("spiked chain", "chain", "chains", "kusari", "manriki", "meteor hammer"),
        WEAPON_TYPE_IDS["WEAPON_TYPE_SPIKED_CHAIN"],
    ),
    (
        "nunchaku",
        _phrase("nunchaku", "nunchucks", "nunchuck", "nunchakus"),
    ...
    (
        "shuriken",
        _phrase("shuriken", "throwing star", "chakram"),
    ...
    (
        "weak razor",
        _phrase("razor", "razorblade", "razors", "carver", "skinner"),
        WEAPON_TYPE_IDS["WEAPON_TYPE_KNIFE"],
    ),
    ("weak hook", _phrase("hook", "hooks", "gaff"), WEAPON_TYPE_IDS["WEAPON_TYPE_KNIFE"]),
    (
        "weak rod",
        _phrase("rod", "rods", "wand", "baton"),
        lambda ctx: (
            WEAPON_TYPE_IDS["WEAPON_TYPE_GREAT_CLUB"]
            if ctx.two_handed
            else WEAPON_TYPE_IDS["WEAPON_TYPE_CLUB"]
    ...
    (
        "weak shard",
        _phrase("shard", "shards", "splinter", "spike", "spikes", "sliver", "thorn"),
        WEAPON_TYPE_IDS["WEAPON_TYPE_DAGGER"],
    ),
    (
        "weak bone",
    ...
    (
        "weak tooth",
        _phrase("tooth", "teeth", "sting", "quill", "spur"),
        WEAPON_TYPE_IDS["WEAPON_TYPE_DAGGER"],
    ),
    (
        "weak stone",
        _phrase("rock", "rocks", "stone", "stones", "boulder", "lump", "brick"),
        lambda ctx: (
            WEAPON_TYPE_IDS["WEAPON_TYPE_GREAT_CLUB"]
            if ctx.two_handed
            else WEAPON_TYPE_IDS["WEAPON_TYPE_CLUB"]
...
def weapon_context(record: Any) -> WeaponContext:
    ...
    text = normalize_text(f"{strings.get('aliases', '')} {strings.get('short_description', '')}")
...
def classify(
    context: WeaponContext, overrides: dict[int, dict[str, Any]] | None = None
) -> WeaponInference:
...
_LAUNCHER_NAME_RULES: list[tuple[str, Callable[[str], bool], str]] = [
    (
        "crossbow",
        _phrase("crossbow", "cross bow", "bolt thrower", "arbalest"),
        "WEAPON_TYPE_LIGHT_CROSSBOW",
    ),
    ("short bow", _phrase("short bow", "shortbow"), "WEAPON_TYPE_SHORT_BOW"),
    (
        "composite bow",
        _phrase("composite bow", "composite longbow", "elven longbow", "elven long bow"),
        "WEAPON_TYPE_COMPOSITE_LONGBOW",
    ),
    ("bow", _phrase("bow", "longbow", "long bow", "warbow"), "WEAPON_TYPE_LONG_BOW"),
    ("sling", _phrase("sling", "slingshot"), "WEAPON_TYPE_SLING"),
    ("dart launcher", _phrase("blowgun", "blow gun", "dart gun", "dartgun"), "WEAPON_TYPE_BLOWGUN"),
]
...
_AMMUNITION_NAME_RULES: list[tuple[str, Callable[[str], bool], str]] = [
    ...
    (
        "sling stone",
        _phrase("sling stone", "slingstone", "sling bullet", "pebble", "pebbles"),
        "AMMO_TYPE_STONE",
    ),
...
class AmmoInference:
    ...
    def diagnostic(self) -> str:
        ...
        return (
            f"inferred ammo type {self.ammo_type} ({self.name}) from {self.tier} rule '{self.rule}'"
        )
...
def classify_ammunition(
    ...
    for rule, matches, name in _AMMUNITION_NAME_RULES:
        if matches(context.text):
            return AmmoInference(TARGET_ITEM_MISSILE, AMMO_TYPE_IDS[name], 0, name, "keyword", rule)
...
def missile_break_probability(durability: int) -> int:
    ...
    clamped = min(SOURCE_MISSILE_MAX_DURABILITY, max(SOURCE_MISSILE_MIN_DURABILITY, durability))
...
def audit(records: Iterable[Any]) -> dict[str, Any]:
    ...
    return {
        "weapons": sum(1 for row in rows if row["source_item_type"] == SOURCE_ITEM_TYPE_WEAPON),
        "ranged_weapons": sum(
            1 for row in rows if row["source_item_type"] == SOURCE_ITEM_TYPE_FIREWEAPON
        ),
        "ammunition": sum(1 for row in rows if row["source_item_type"] == SOURCE_ITEM_TYPE_MISSILE),
