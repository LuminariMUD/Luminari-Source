...
def refs_for_record(
    ...
    outgoing = [
        edge for edge in edges if edge.source_type == canonical and edge.source_vnum == vnum
    ]
    incoming = [
        edge for edge in edges if edge.target_type == canonical and edge.target_vnum == vnum
    ]
