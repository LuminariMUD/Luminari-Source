...
ADAPTED_HANDLER_NAMES = {
    ...
    "broadsword_dancing_shadows": "RoL Weapon Proc",
    "bards_glaive": "RoL Weapon Proc",
    "bhaal_rogue_weapon": "RoL Weapon Proc",
    "bhaal_warrior_weapon": "RoL Weapon Proc",
    "crystalSword": "RoL Weapon Proc",
    "obsidianSword": "RoL Weapon Proc",
    "proc_frostbite_cold": "RoL Weapon Proc",
    "um2_drowSnakeWhip": "RoL Weapon Proc",
    "um2_searingRod": "RoL Weapon Proc",
    "um2_astralForged": "RoL Weapon Proc",
    "um2_torinGeneral": "RoL Weapon Proc",
    "um2_torinChainLightning": "RoL Weapon Proc",
    ...
    "demon_succubusCharm": "RoL Monster Combat",
    "demon_succubusCharmed": "RoL Monster Combat",
    "demon_vrockDanceOfRuin": "RoL Monster Combat",
...
COMPOSABLE_MOBILE_RUNTIME_HANDLERS = {
    ...
    "um2_goldenKnight": "converted mobile death profile",
    "um2_platinumKnight": "converted mobile death profile",
    "um2_silverKnight": "converted mobile death profile",
