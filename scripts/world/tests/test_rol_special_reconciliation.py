...
class RolSpecialReconciliationTests(unittest.TestCase):
  ...
  def test_production_inputs_generate_complete_progress_ledgers(self) -> None:
    with tempfile.TemporaryDirectory() as temporary:
      ...
      self.assertEqual(539, summary["direct_bindings_by_status"]["resolved"])
      self.assertEqual(608, summary["direct_bindings_by_status"]["pending"])
      self.assertEqual(86, summary["source_handlers_by_status"]["resolved"])
      self.assertEqual(476, summary["source_handlers_by_status"]["pending"])
      self.assertEqual(168, summary["direct_bindings_by_strategy"]["NATIVE_ADAPTED"])
