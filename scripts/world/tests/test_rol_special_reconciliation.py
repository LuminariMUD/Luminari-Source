...
class RolSpecialReconciliationTests(unittest.TestCase):
  ...
  def test_production_inputs_generate_complete_progress_ledgers(self) -> None:
    with tempfile.TemporaryDirectory() as temporary:
      ...
      self.assertEqual(489, summary["direct_bindings_by_status"]["resolved"])
      self.assertEqual(658, summary["direct_bindings_by_status"]["pending"])
      self.assertEqual(63, summary["source_handlers_by_status"]["resolved"])
      self.assertEqual(499, summary["source_handlers_by_status"]["pending"])
      self.assertEqual(139, summary["direct_bindings_by_strategy"]["NATIVE_ADAPTED"])
      self.assertEqual(848, summary["act_spec_records"])
      self.assertEqual(552, summary["act_spec_by_status"]["resolved"])
      self.assertEqual(296, summary["act_spec_by_status"]["pending"])
      self.assertEqual(
