...
class RolSpecialReconciliationTests(unittest.TestCase):
  ...
  def test_production_inputs_generate_complete_progress_ledgers(self) -> None:
    with tempfile.TemporaryDirectory() as temporary:
      ...
      self.assertEqual(562, summary["direct_bindings_by_status"]["resolved"])
      self.assertEqual(585, summary["direct_bindings_by_status"]["pending"])
      self.assertEqual(92, summary["source_handlers_by_status"]["resolved"])
      self.assertEqual(470, summary["source_handlers_by_status"]["pending"])
      self.assertEqual(191, summary["direct_bindings_by_strategy"]["NATIVE_ADAPTED"])
