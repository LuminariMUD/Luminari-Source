...
class RolSpecialReconciliationTests(unittest.TestCase):
  ...
  def test_production_inputs_generate_complete_progress_ledgers(self) -> None:
    with tempfile.TemporaryDirectory() as temporary:
      ...
      self.assertEqual(531, summary["direct_bindings_by_status"]["resolved"])
      self.assertEqual(616, summary["direct_bindings_by_status"]["pending"])
      self.assertEqual(85, summary["source_handlers_by_status"]["resolved"])
      self.assertEqual(477, summary["source_handlers_by_status"]["pending"])
      self.assertEqual(160, summary["direct_bindings_by_strategy"]["NATIVE_ADAPTED"])
