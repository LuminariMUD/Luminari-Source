...
class RolMobileIdentityTests(unittest.TestCase):
    ...
    def _record(self, basename: str, vnum: int):
        ...
        return next(
            record for record in self.mobiles if record.basename == basename and record.vnum == vnum
        )
    ...
    def _fixture(self, race_row: str, aliases: str, short_description: str):
        ...
        records, corpus = parse_rol_source_file(path, "areas/mob/fixture.mob", "mob", "fixture")
    ...
    def test_source_registry_and_base_matrix_are_complete(self) -> None:
        ...
        self.assertEqual(
            set(self.registry),
            {code for profile in self.policy["base_profiles"] for code in profile["codes"]},
        )
    ...
    def test_compound_phrase_wins_as_one_atomic_profile(self) -> None:
        ...
        selection = select_mobile_conversion(record, self.policy, self.manifest, self.registry)
    ...
    def test_tiamat_serialization_preserves_each_runtime_phase_budget(self) -> None:
        ...
        self.assertEqual("tiamat-dracolich-v1", dracolich.ledger["calculator"]["custom_profile"])
    ...
    def test_regular_serialization_preserves_base_autoroll_hit_die_shape(self) -> None:
        ...
        self.assertEqual(base_hit_points, emitted.ledger["serialization"]["hit_point_bonus"])
    ...
    def test_full_active_corpus_resolves_without_manual_review(self) -> None:
        ...
        self.assertEqual({"AUTO_EXACT", "AUTO_PHRASE", "AUTO_FALLBACK"}, set(statuses))
    ...
    def test_aggression_list_never_changes_owner_identity(self) -> None:
        ...
        plain_selection = select_mobile_conversion(plain, self.policy, self.manifest, self.registry)
