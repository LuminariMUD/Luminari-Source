...
class RolCapabilityAuditTests(unittest.TestCase):
    ...
    def test_diagnostic_ownership_separates_references_and_generic_gaps(self) -> None:
        ...
        self.assertEqual(
            "reference-gap",
            classify_transform_diagnostic(
                "excluded unresolved shop product 10: no identity for obj 10"
            ),
        )
        self.assertEqual(
            "inert-omission",
    ...
    def test_active_corpus_audit_emits_every_convertible_record(self) -> None:
        ...
        self.assertEqual(
            {"mob": 12_407, "obj": 10_377, "qst": 5_076, "shp": 453, "wld": 41_354, "zon": 255},
        ...
        actions = [
            json.loads(line)
            for line in (output_dir.parent / "plan/reconciliation.jsonl")
