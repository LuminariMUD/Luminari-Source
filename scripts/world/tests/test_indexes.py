...
class IndexTests(unittest.TestCase):
  ...
  def test_qst_indexes_are_required_but_may_describe_an_empty_dataset(self) -> None:
    with tempfile.TemporaryDirectory() as directory:
      ...
      qst_findings = [finding for finding in empty.findings if finding.span.path.startswith("qst/")]
  ...
  def test_missing_qst_mini_index_uses_the_standard_error(self) -> None:
    with tempfile.TemporaryDirectory() as directory:
      ...
      findings = [finding for finding in result.findings if finding.span.path == "qst/index.mini"]
