...
class RolIdentityTests(unittest.TestCase):
    ...
    def test_mytheast_requires_exact_evidence_backed_normalization(self) -> None:
        self.assertEqual(20817, canonical_destination("zon", 81700, "mytheast", self.policy))
        self.assertEqual(2081700, canonical_destination("wld", 81700, "mytheast", self.policy))
        self.assertEqual(2081899, canonical_destination("mob", 81899, "mytheast", self.policy))
    ...
    def test_historic_lineage_cannot_override_formula(self) -> None:
        ...
        self.assertEqual(2001007, canonical_destination("obj", 1007, "quests", self.policy))
