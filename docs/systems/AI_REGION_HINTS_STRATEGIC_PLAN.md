...
01. **atmosphere** - General mood and visual character
02. **fauna** - Animal life and wildlife
03. **flora** - Plant life and vegetation
04. **geography** - Landforms and geological features
05. **weather_influence** - How weather affects the region
06. **resources** - Resource availability hints
07. **landmarks** - Notable features or structures
08. **sounds** - Ambient audio elements
09. **scents** - Ambient smells and air quality
