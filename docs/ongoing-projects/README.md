...
|----------|--------|--------------|
| [bardic-performance-msdp-overflow-audit.md](bardic-performance-msdp-overflow-audit.md) | Mechanics and text complete | Run the final sanitizer, protocol, build, test, and install matrix, then close the audit. |
