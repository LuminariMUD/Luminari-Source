...
| [BUGS_LIST.md](BUGS_LIST.md) | Local code backlog | 26 verified dev/local source-code items drawn from 28 production records. |
| [LIB-BUGS.md](LIB-BUGS.md) | Production data backlog | 13 verified production/remote `lib/`, help, world, quest, script, and shop items drawn from 16 records. Ghost Wolf records #111 and #114 are split across both bug lists. |
