...
|----------|--------|--------------|
| [necromancer-class-end-to-end-audit.md](necromancer-class-end-to-end-audit.md) | Audit complete; remediation open | The class and all level grants are present, but spell progression, Bone Armor, Touch of Undeath, summon resource use/caps/scaling, one-shot empowerment, cohort evolution handling, help, and regression coverage remain open. |
