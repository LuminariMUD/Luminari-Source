...
|----------|--------|--------------|
| [bardic-performance-msdp-overflow-audit.md](bardic-performance-msdp-overflow-audit.md) | Safety, lifecycle, and base-song repairs complete | Repair and test the remaining Spellsinger and Warchanter integrations, align their runtime and design text to the no-round-pool contract, then close the audit. |
