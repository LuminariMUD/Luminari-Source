...
|----------|--------|--------------|
| [necromancer-class-end-to-end-audit.md](necromancer-class-end-to-end-audit.md) | Implementation in progress | NEC-001 through NEC-016 are being repaired and verified on `codex/necromancer-completion-20260806`; the audit is the live implementation and release-gate ledger. |
