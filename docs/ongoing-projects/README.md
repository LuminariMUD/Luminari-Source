...
| [world-doc-audit-checklist.md](world-doc-audit-checklist.md) | Complete | All eleven world-building documents audited and fixed on 2026-08-04; three new format references written (`ZONE_FILE_FORMAT.md`, `SHOP_FILE_FORMAT.md`, `BUILDER_QUICKSTART.md`) and the `docs/web/guides/` HTML duplication resolved with a generator. Largest finding: 93 of 103 line-number citations in the flag docs were stale, and the OLC and wilderness documents contained substantial fabricated content. Outcome in [CHANGELOG.md](../CHANGELOG.md); five source bugs filed in [known-issues.md](../known-issues.md). Retained as the record of what was checked; deletable once reviewed. |
| [world-validator-cli-plan.md](world-validator-cli-plan.md) | Not started, premise revised | Build plan for `wtool`, a standalone Python world-data validator and flag-lookup CLI. No code exists yet; `lib/world/validate-zone.sh` is still the 33-line stub it replaces. **Read section 6 of the doc-audit checklist before starting**: the flag tables that Phase 4 was meant to fix were already correct, so that phase is drift-prevention rather than repair, and the checks that actually found defects are listed there. |
