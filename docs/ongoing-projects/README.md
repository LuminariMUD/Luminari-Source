...
|----------|--------|--------------|
| [bardic-instrument-slot-audit.md](bardic-instrument-slot-audit.md) | Implementation in progress | Dedicated-first instrument discovery and its first regression matrix pass 401/401 tests. Construction/persistence coverage, breakability reconciliation, and flame-kissed transform/display hardening remain. |
