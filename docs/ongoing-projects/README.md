...
| [BUGS_LIST.md](BUGS_LIST.md) | Backlog | Production in-game bug queue snapshot from 2026-08-03: 146 submissions consolidated into 129 distinct reports, with production statuses retained. |
