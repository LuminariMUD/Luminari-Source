...
|----------|--------|--------------|
| [bardic-performance-msdp-overflow-audit.md](bardic-performance-msdp-overflow-audit.md) | Safety and lifecycle repairs complete | Reconcile timing, targeting, all base songs, and remaining Spellsinger/Warchanter behavior against the selected no-round-pool contract; then align player-facing text and finish mechanics coverage. |
