...
|----------|--------|--------------|
| [bardic-performance-msdp-overflow-audit.md](bardic-performance-msdp-overflow-audit.md) | Mechanics repairs complete | Align Spellsinger and Warchanter runtime and design text to the no-round-pool contract, run the final validation matrix, then close the audit. |
