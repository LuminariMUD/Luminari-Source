...
|----------|--------|--------------|
| [bardic-performance-msdp-overflow-audit.md](bardic-performance-msdp-overflow-audit.md) | Final validation | Clean warning-free ASan/UBSan passes 399/399 and focused protocol coverage passes 22/22. Run the optimized build, test, and install checks, then close the audit. |
