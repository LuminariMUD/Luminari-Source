...
|----------|--------|--------------|
| [bardic-instrument-slot-audit.md](bardic-instrument-slot-audit.md) | Implementation in progress | Dedicated-first discovery, durability semantics, subtype safety, and field terminology pass 404/404 tests. Construction/persistence coverage and flame-kissed transform hardening remain. |
