...
- 1,445 resolved and 276 pending live static bindings, with 602 resolved and 193 pending
...
`rol-phase6-special-bc771a97be7031ca`. The older 1,112/1,147 binding, 538/562 handler,
...
remaining measured scope is 276 live static bindings across 193 direct handler names in
...
resistance, affect state, waits, damage, and owner restrictions. Next, finish the remaining 13
Avernus bindings across 12 stateful handlers as a coherent source-file family before selecting
the next dependency-complete combat, death, or utility group.
...
excluded with behavior evidence. The measured remaining Phase 6 planning envelope is 17-37
sessions, or 34-148 focused engineering hours. The first twelve corrected batches closed 199
bindings across 64 handlers, leaving an arithmetic binding projection near 17 sessions and a
handler-diversity projection near 37. The published range allows shared runtime families to
outperform the handler projection while recognizing that 163 of the remaining 193 handlers are
...
envelope, the current remaining project range is 73-121 sessions, or 146-484 focused
