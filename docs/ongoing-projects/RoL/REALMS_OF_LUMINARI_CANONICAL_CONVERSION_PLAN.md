...
- 1,386 resolved and 335 pending live static bindings, with 575 resolved and 220 pending
...
`rol-phase6-special-6cfc16c58f7802e2`. The older 1,112/1,147 binding, 538/562 handler,
...
remaining measured scope is 335 live static bindings across 220 direct handler names in
...
nonstacking Constitution loss, and the king's slow-poison-dependent lethal branch. Next, group
the remaining Undermountain, planar, Avernus, Scornubel, Darkhold, and other source families by
...
excluded with behavior evidence. The measured remaining Phase 6 planning envelope is 18-42
sessions, or 36-168 focused engineering hours. The first seven corrected batches closed 140
bindings across 37 handlers, leaving an arithmetic binding projection near 17 sessions and a
handler-diversity projection near 42. The published range allows shared runtime families to
outperform the handler projection while recognizing that 176 of the remaining 220 handlers are
...
envelope, the current remaining project range is 74-126 sessions, or 148-504 focused
