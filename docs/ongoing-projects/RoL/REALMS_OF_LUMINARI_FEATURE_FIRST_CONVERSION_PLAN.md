...
Phase 4 pilot replaced the provisional ranges. Fourteen completed Phase 6 delivery
sessions are archived in the changelog. The remaining Phases 6-8 forecast is 82-142
sessions, or 164-568 focused engineering hours at the defined session size.
...
### Phase 6: Special-procedure reconciliation (34-66 remaining sessions)
