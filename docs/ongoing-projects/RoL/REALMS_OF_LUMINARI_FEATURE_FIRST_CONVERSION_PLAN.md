...
Phase 4 pilot replaced the provisional ranges. Seventeen completed Phase 6 delivery
sessions are archived in the changelog. The remaining Phases 6-8 forecast is 79-139
sessions, or 158-556 focused engineering hours at the defined session size.
...
### Phase 6: Special-procedure reconciliation (31-63 remaining sessions)
