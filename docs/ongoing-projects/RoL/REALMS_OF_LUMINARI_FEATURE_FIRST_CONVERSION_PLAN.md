...
Phase 4 pilot replaced the provisional ranges. Twenty-three completed Phase 6 delivery
sessions are archived in the changelog. The remaining Phases 6-8 forecast is 73-133
sessions, or 146-532 focused engineering hours at the defined session size.
...
### Phase 6: Special-procedure reconciliation (25-57 remaining sessions)
