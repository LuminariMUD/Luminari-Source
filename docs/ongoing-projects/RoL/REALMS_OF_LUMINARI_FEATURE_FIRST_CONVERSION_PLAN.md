...
Phase 4 pilot replaced the provisional ranges. Twelve completed Phase 6 delivery
sessions are archived in the changelog. The remaining Phases 6-8 forecast is 84-144
sessions, or 168-576 focused engineering hours at the defined session size.
...
### Phase 6: Special-procedure reconciliation (36-68 remaining sessions)
