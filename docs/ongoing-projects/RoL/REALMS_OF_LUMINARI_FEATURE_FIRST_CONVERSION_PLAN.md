...
Phase 4 pilot replaced the provisional ranges. Twenty-five completed Phase 6 delivery
sessions are archived in the changelog. The remaining Phases 6-8 forecast is 71-131
sessions, or 142-524 focused engineering hours at the defined session size.
...
### Phase 6: Special-procedure reconciliation (23-55 remaining sessions)
