...
Phase 4 pilot replaced the provisional ranges. Nineteen completed Phase 6 delivery
sessions are archived in the changelog. The remaining Phases 6-8 forecast is 77-137
sessions, or 154-548 focused engineering hours at the defined session size.
...
### Phase 6: Special-procedure reconciliation (29-61 remaining sessions)
