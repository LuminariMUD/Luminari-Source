...
Phase 4 pilot replaced the provisional ranges. Thirteen completed Phase 6 delivery
sessions are archived in the changelog. The remaining Phases 6-8 forecast is 83-143
sessions, or 166-572 focused engineering hours at the defined session size.
...
### Phase 6: Special-procedure reconciliation (35-67 remaining sessions)
