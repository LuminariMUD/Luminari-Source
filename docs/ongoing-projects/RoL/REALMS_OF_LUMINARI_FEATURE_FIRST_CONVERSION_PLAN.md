...
Phase 4 pilot replaced the provisional ranges. Twenty-six completed Phase 6 delivery
sessions are archived in the changelog. The remaining Phases 6-8 forecast is 70-130
sessions, or 140-520 focused engineering hours at the defined session size.
...
### Phase 6: Special-procedure reconciliation (22-54 remaining sessions)
