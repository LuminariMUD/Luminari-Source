...
Phases 6-8 forecast is 54-88 sessions, or 108-352 focused engineering hours at the
...
### Phase 6: Special-procedure reconciliation (6-12 remaining sessions)

The current reconciliation leaves 284 active direct bindings across 230 source handlers
and 82 pending `ACT_SPEC` records.
