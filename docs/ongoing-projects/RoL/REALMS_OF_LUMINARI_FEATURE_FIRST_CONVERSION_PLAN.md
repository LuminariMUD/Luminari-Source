...
Phase 4 pilot replaced the provisional ranges. Twenty-two completed Phase 6 delivery
sessions are archived in the changelog. The remaining Phases 6-8 forecast is 74-134
sessions, or 148-536 focused engineering hours at the defined session size.
...
### Phase 6: Special-procedure reconciliation (26-58 remaining sessions)
