...
are now archived. The remaining evidence-based forecast is 85-145 sessions, or 170-580
...
|------:|-------|---------:|
| 6 | Reconcile/reuse/patch/port special procedures | 37-69 remaining |
...
Completed Phases 0-5 and the first eleven Phase 6 delivery sessions have been removed from
...
Continue Phase 6 with the 770 pending direct bindings and 331 pending `ACT_SPEC`
