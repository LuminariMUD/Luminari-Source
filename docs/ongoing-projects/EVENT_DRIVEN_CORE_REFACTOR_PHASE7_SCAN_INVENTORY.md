...
| 5 s | Luminari pulse | Mixed character and affected-room work | **Converted:** affected rooms retain explicit owners. Full-population character admission was rejected at production scale; regeneration, hazards, afflictions, weapon effects, mount/grapple cleanup, and other work use state-specific admission and retirement. |
...
| 6 s | damage/effects and player misc | Character/descriptor state | **Converted:** connected-player work remains connection-owned where appropriate; NPC/character damage, effects, cooldowns, and recovery use concrete state or deadlines and retire when no work remains. |
