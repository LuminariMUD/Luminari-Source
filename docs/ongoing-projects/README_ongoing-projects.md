...
|----------|--------|--------------|
| [REALMS_OF_LUMINARI_FEATURE_FIRST_CONVERSION_PLAN.md](RoL/REALMS_OF_LUMINARI_FEATURE_FIRST_CONVERSION_PLAN.md) | Implementation underway | Inventory the writable development baseline, capture diagnostics, complete the typed dependency closure, reconcile prior conversions, and prove the no-clobber walking skeleton. |
| [REALMS_OF_LUMINARI_ZONE_CONVERSION_SCOPE.md](RoL/REALMS_OF_LUMINARI_ZONE_CONVERSION_SCOPE.md) | Implementation underway | Convert active working content only, preserve equivalent Luminari/OLC work, auto-approve converted HLQs, and resolve technical branches through traced evidence and pilot tests. |
| [RoL-Changelog.md](RoL/RoL-Changelog.md) | Completed milestone record | Preserve delivered RoL inventory behavior, acceptance evidence, and delivery commits outside the active plans. |
| [REALMS_OF_LUMINARI_WORKNOTES.md](RoL/REALMS_OF_LUMINARI_WORKNOTES.md) | Active handoff log | Preserve inventory evidence, verification commands, checkpoints, and immediate continuation steps. |
