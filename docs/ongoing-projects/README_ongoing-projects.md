...
|----------|--------|--------------|
| [CAMPAIGN_VARIANT_RETIREMENT_SCOPE.md](CAMPAIGN_VARIANT_RETIREMENT_SCOPE.md) | Implementation in progress | Compiler-led source and runtime retirement are complete. Setup, tooling, templates, and current-documentation cleanup are in progress; campaign-framework preservation or redesign remains out of scope. Supersedes `CAMPAIGN_VARIANT_REMOVAL_SCOPE.md`. |
