...
|----------|--------|--------------|
| [REALMS_OF_LUMINARI_FEATURE_FIRST_CONVERSION_PLAN.md](REALMS_OF_LUMINARI_FEATURE_FIRST_CONVERSION_PLAN.md) | Decisions locked; implementation not started | Inventory active RoL input roots and the writable development baseline, capture diagnostics, complete the typed dependency closure, reconcile prior conversions, and prove the no-clobber walking skeleton. |
| [REALMS_OF_LUMINARI_ZONE_CONVERSION_SCOPE.md](REALMS_OF_LUMINARI_ZONE_CONVERSION_SCOPE.md) | Decisions locked; conversion not started | Convert active working content only, preserve equivalent Luminari/OLC work, auto-approve converted HLQs, and resolve technical branches through traced evidence and pilot tests. |
