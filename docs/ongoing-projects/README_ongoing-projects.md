...
|----------|--------|--------------|
| [ROL_CONVERSION_ACCURACY_RECOVERY_PLAN.md](ROL_CONVERSION_ACCURACY_RECOVERY_PLAN.md) | Active plan; structural import complete, semantic fidelity reopened | Add safe record-level maintenance regeneration, create the accuracy ledger, implement authoritative C-based mobile auto-stats and persisted encounter tiers, audit every active RoL record and directive, repair systemic conversion defects in dependency-complete waves, and validate before any release. |
