...
|----------|--------|--------------|
| [REALMS_OF_LUMINARI_FEATURE_FIRST_CONVERSION_PLAN.md](RoL/REALMS_OF_LUMINARI_FEATURE_FIRST_CONVERSION_PLAN.md) | Implementation underway | Complete grammar and typed dependency discovery, reconcile prior conversions, establish deterministic planning/bundling, and prove the no-clobber walking skeleton. |
...
| [RoL-Changelog.md](RoL/RoL-Changelog.md) | Completed milestone record | Preserve delivered RoL inventory and Phase 0 baseline behavior, acceptance evidence, and delivery commits outside the active plans. |
