...
The completed Realms of Luminari conversion is documented in the
[world-tool reference](../utilities/WORLD_VALIDATOR_CLI.md), the
[testing guide](../guides/TESTING_GUIDE.md), and the
[main changelog](../CHANGELOG.md); its temporary planning workspace has been
retired.
