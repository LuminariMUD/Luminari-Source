...
Statuses below were re-verified against the source tree on 2026-08-07.

| Document | Status | What remains |
|----------|--------|--------------|
| [spec-todo.md](spec-todo.md) | Complete; retained as the close record | Phases 00-06 are delivered. The final audit intentionally adds neither a general persisted chain nor zone/world lifecycle events because no approved second consumer exists; reopen conditions are recorded in the [Phase 06 validation](../testing/SPECIAL_PROCEDURE_PHASE_06_VALIDATION.md). Delivered evidence also remains in the [Phase 00](../testing/SPECIAL_PROCEDURE_PHASE_00_VALIDATION.md), [Phase 01](../testing/SPECIAL_PROCEDURE_PHASE_01_VALIDATION.md), [Phase 02](../testing/SPECIAL_PROCEDURE_PHASE_02_VALIDATION.md), [Phase 03](../testing/SPECIAL_PROCEDURE_PHASE_03_VALIDATION.md), [Phase 04](../testing/SPECIAL_PROCEDURE_PHASE_04_VALIDATION.md), and [Phase 05](../testing/SPECIAL_PROCEDURE_PHASE_05_VALIDATION.md) matrices. No implementation work remains. |
