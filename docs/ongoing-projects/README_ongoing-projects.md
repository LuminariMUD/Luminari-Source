...
|----------|--------|--------------|
| [AUTOSTAT_TIER_DAMAGE_ASSESSMENT.md](AUTOSTAT_TIER_DAMAGE_ASSESSMENT.md) | Corrected and verified in development | Base autostat restored; Tier is an autoroll-only saved-stat bonus; all 12,407 converted mobiles were regenerated and the 222 corrected files applied. |
...
| [ROL_CONVERSION_DONE.md](ROL_CONVERSION_DONE.md) | Completed-work record with invalid autostat/tier sections | Structural history remains useful, but its replacement autostat/tier design is superseded by the active correction plan. |
