...
|----------|--------|--------------|
| [EVENT_DRIVEN_CORE_REFACTOR_SPEC.md](EVENT_DRIVEN_CORE_REFACTOR_SPEC.md) | Controlling specification v1.4; Phases 1 through 6b accepted, Phase 7 next | Inventory heartbeat scans and migrate selected high-value world work to active/cooling-down/dormant ownership, scheduled deadlines, and typed wakeups. |
