...
|----------|--------|--------------|
| [spec-todo.md](spec-todo.md) | Phases 00-04 complete; Phase 05 next | Content ownership and narrow shared mechanics are complete; typed handlers and conditional composition/lifecycle hooks remain. Delivered behavior is recorded in the [Phase 00](../testing/SPECIAL_PROCEDURE_PHASE_00_VALIDATION.md), [Phase 01](../testing/SPECIAL_PROCEDURE_PHASE_01_VALIDATION.md), [Phase 02](../testing/SPECIAL_PROCEDURE_PHASE_02_VALIDATION.md), [Phase 03](../testing/SPECIAL_PROCEDURE_PHASE_03_VALIDATION.md), and [Phase 04](../testing/SPECIAL_PROCEDURE_PHASE_04_VALIDATION.md) validation matrices. |
