...
|----------|--------|--------------|
| [EVENT_DRIVEN_CORE_REFACTOR_SPEC.md](EVENT_DRIVEN_CORE_REFACTOR_SPEC.md) | Controlling specification v0.8; Phases 1 and 2 accepted, Phase 2.5 next | Implement and accept the pre-reactor owner/lifecycle foundation: generation-aware handles and index, owner cancellation/capacity/inspection, lifecycle and descriptor-copyover semantics, MUD-event adaptation, and cleanup/cancellation validation. Phase 3 remains blocked until that gate passes. |
| [EVENT_DRIVEN_CORE_REFACTOR_SPEC_REVIEW.md](EVENT_DRIVEN_CORE_REFACTOR_SPEC_REVIEW.md) | Adversarial review complete 2026-08-30; incorporated by specification v0.8 | Historical review of v0.4 with 28 findings. Version 0.8 records each disposition, inserts the blocking Phase 2.5 foundation, and assigns reactor dependency, monotonic clock, fd, signal, copyover, CI, observability, rollback, encounter, and activity obligations to explicit gates. Runtime work remains to implement them. |
