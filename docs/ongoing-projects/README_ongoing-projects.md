...
Statuses below were re-verified against the source tree on 2026-08-08.

| Document | Status | What remains |
|----------|--------|--------------|
| [spec-todo.md](spec-todo.md) | In progress | Fold `src/spec_assign.c` into shallow `src/spec/` assignment owners, replace `src/spec_procs.h` with direct narrow owner interfaces, remove both transitional files, and delete the todo after all acceptance gates pass. Completed phase evidence lives in the [Phase 00](../testing/SPECIAL_PROCEDURE_PHASE_00_VALIDATION.md), [Phase 01](../testing/SPECIAL_PROCEDURE_PHASE_01_VALIDATION.md), [Phase 02](../testing/SPECIAL_PROCEDURE_PHASE_02_VALIDATION.md), [Phase 03](../testing/SPECIAL_PROCEDURE_PHASE_03_VALIDATION.md), [Phase 04](../testing/SPECIAL_PROCEDURE_PHASE_04_VALIDATION.md), [Phase 05](../testing/SPECIAL_PROCEDURE_PHASE_05_VALIDATION.md), and [Phase 06](../testing/SPECIAL_PROCEDURE_PHASE_06_VALIDATION.md) matrices rather than the ongoing-work file. |
