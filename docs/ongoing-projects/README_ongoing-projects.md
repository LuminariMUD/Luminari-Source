...
Statuses below were re-verified against the source tree on 2026-08-16. Most retained legacy notes
are grouped in [`todo-zusuk/`](todo-zusuk/); current cross-cutting plans may live beside this index.

| Document | Status | What remains |
|----------|--------|--------------|
| [ROL_CONVERSION_ACCURACY_RECOVERY_PLAN.md](ROL_CONVERSION_ACCURACY_RECOVERY_PLAN.md) | Active plan; unfinished work only | Add safe record-level maintenance regeneration, create the accuracy ledger, finish the authoritative C mobile calculator and converter bridge, classify RoL 51+ mobiles and named world bosses, repair systemic defects in dependency-complete waves, and validate before release. |
| [ROL_CONVERSION_DONE.md](ROL_CONVERSION_DONE.md) | Completed-work record | Nothing active; preserves the structural-import, mechanics-study, encounter-tier implementation, and verification evidence removed from the remaining-work plan. |
