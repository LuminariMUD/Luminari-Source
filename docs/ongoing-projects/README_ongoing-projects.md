...
| [ROL_TAIL_SLOT_IMPLEMENTATION.md](ROL_TAIL_SLOT_IMPLEMENTATION.md) | Complete; runtime, converter, help, and full validation pass | RoL tail-slot constants, Yuan-Ti eligibility, dual-location rings, wear flow, AC behavior, display, persistence, world-data encoding, compatibility traps, and the LuminariMUD port surface. |
