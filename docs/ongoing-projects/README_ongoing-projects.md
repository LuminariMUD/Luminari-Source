...
|----------|--------|--------------|
| [EVENT_DRIVEN_CORE_REFACTOR_SPEC.md](EVENT_DRIVEN_CORE_REFACTOR_SPEC.md) | Controlling specification v1.8; Phases 1 through 6b and three Phase 7 owner slices accepted | Continue explicit character-state, room behavior, vessel, and mixed-pulse decomposition before encounter compatibility. |
