...
|----------|--------|--------------|
| [spec-todo.md](spec-todo.md) | Phases 00-02 complete; Phase 03 in progress | Content extraction is underway; shared mechanics, typed handlers, and conditional composition/lifecycle hooks remain. Delivered behavior is recorded in the [Phase 00](../testing/SPECIAL_PROCEDURE_PHASE_00_VALIDATION.md), [Phase 01](../testing/SPECIAL_PROCEDURE_PHASE_01_VALIDATION.md), and [Phase 02](../testing/SPECIAL_PROCEDURE_PHASE_02_VALIDATION.md) validation matrices. The exact extraction resume point is in the [Phase 03 progress record](../testing/SPECIAL_PROCEDURE_PHASE_03_PROGRESS.md). |
