...
|----------|--------|--------------|
| [spec-todo.md](spec-todo.md) | Phase 00 complete; Phases 01-06 not started | Special-procedure gateway compatibility, declarative assignments, content extraction, shared mechanics, typed handlers, and conditional composition/lifecycle hooks. Delivered Phase 00 behavior is recorded in the [validation matrix](../testing/SPECIAL_PROCEDURE_PHASE_00_VALIDATION.md). |
