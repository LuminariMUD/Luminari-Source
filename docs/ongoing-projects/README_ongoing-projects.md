...
| [ROL_TAIL_SLOT_IMPLEMENTATION.md](ROL_TAIL_SLOT_IMPLEMENTATION.md) | Runtime and converter implemented; help/docs validation remains | RoL tail-slot constants, Yuan-Ti eligibility, dual-location rings, wear flow, AC behavior, display, persistence, world-data encoding, compatibility traps, and the LuminariMUD port surface. |
