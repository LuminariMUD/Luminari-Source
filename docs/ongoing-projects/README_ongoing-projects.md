...
|----------|--------|--------------|
| [EVENT_DRIVEN_CORE_REFACTOR_SPEC.md](EVENT_DRIVEN_CORE_REFACTOR_SPEC.md) | Controlling specification v1.0; Phases 1 through 3 accepted, Phase 4 next | Bridge scheduler deadlines into the reactor, add bounded due-work dispatch and production hardening, retain the compatibility heartbeat for unmigrated work, and collect the representative workload and large-advance evidence required by the Phase 4 gate. |
