...
|----------|--------|--------------|
| [REALMS_OF_LUMINARI_FEATURE_FIRST_CONVERSION_PLAN.md](REALMS_OF_LUMINARI_FEATURE_FIRST_CONVERSION_PLAN.md) | Implementation underway; deterministic source-list inventory complete | Inventory the writable development baseline, capture diagnostics, complete the typed dependency closure, reconcile prior conversions, and prove the no-clobber walking skeleton. |
| [REALMS_OF_LUMINARI_ZONE_CONVERSION_SCOPE.md](REALMS_OF_LUMINARI_ZONE_CONVERSION_SCOPE.md) | Implementation underway; source-list inventory complete | Convert active working content only, preserve equivalent Luminari/OLC work, auto-approve converted HLQs, and resolve technical branches through traced evidence and pilot tests. |
| [REALMS_OF_LUMINARI_WORKNOTES.md](REALMS_OF_LUMINARI_WORKNOTES.md) | Active handoff log | Preserve inventory evidence, verification commands, checkpoints, and immediate continuation steps. |
