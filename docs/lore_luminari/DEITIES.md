...
Reference for engine loading entry point: [assign_deities()](../../src/character/deities.c#L201). Source file: [src/character/deities.c](../../src/character/deities.c#L1)
...
Luminari entries below provide Suggested Domains (for mechanics) and Favored Weapon where applicable. Importers may call [add_deity_new()](../../src/character/deities.c#L156) for roleplay fields, and optionally extend with domain/weapon data (hybrid import) if desired.
...
This document now contains every data field required by the engine to import Luminari deities via [assign_deities()](../../src/character/deities.c#L201), using [add_deity_new()](../../src/character/deities.c#L156) primarily, with optional domain/weapon mechanics available for hybrid imports through [add_deity()](../../src/character/deities.c#L101).
