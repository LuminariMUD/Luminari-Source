# Unified Vessel System - Technical Product Requirements Document
...
### Strategic Decision
Use Greyhawk naval system as foundation with wilderness integration, replacing three separate legacy vessel systems with one maintainable solution.
...
### Phase 1: Foundation & Wilderness Integration
...
### Phase 2: Multi-Room Interiors
**Status:** Code exists, wiring incomplete
...
### Phase 4: Simple Vehicle Support (Planned)
