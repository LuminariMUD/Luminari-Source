...
| [WEB_ACCOUNT_CHARACTER_CREATION_EXPERIENCE.md](WEB_ACCOUNT_CHARACTER_CREATION_EXPERIENCE.md) | Partial | Cross-repository secure web account login, account lobby, character creator, and default-off protocol-v2 role-play suite. Engineering is built through Phase 3; non-production acceptance, security/release review, canary, and rollback remain. |
