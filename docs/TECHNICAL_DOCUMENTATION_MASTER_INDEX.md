...
- **[World Validator CLI](utilities/WORLD_VALIDATOR_CLI.md)** - World parsing, validation, typed lookup, RoL inventory and baseline evidence, flags, and documentation checks
