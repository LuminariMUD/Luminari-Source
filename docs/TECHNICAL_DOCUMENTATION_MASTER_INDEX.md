...
- **[Duris racial innates as feats plan](ongoing-projects/DURIS_RACIAL_INNATES_AS_FEATS_PLAN.md)** - Coverage matrix and implementation plan for every uncovered Duris racial innate as a non-selectable feat
