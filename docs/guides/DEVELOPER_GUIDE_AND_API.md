...
`src/spec/spec_zone_shadow_dragon.h` for the Shadow Dragon encounter callback. Use `is_wearing()`
from `handler.h` for the established same-VNUM equipment predicate.
