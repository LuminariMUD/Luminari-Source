...
void load_weapons(void) {
  ...
  setweapon(WEAPON_TYPE_COMPOSITE_LONGBOW, "composite long bow (str 1)", 1, 8, 0, 3,
  ...
  setweapon(WEAPON_TYPE_COMPOSITE_LONGBOW_2, "composite long bow (str 2)", 1, 8, 0, 3,
          WEAPON_FLAG_MARTIAL | WEAPON_FLAG_RANGED, 20000, DAMAGE_TYPE_PIERCING, 3, 110,
          WEAPON_FAMILY_BOW, SIZE_LARGE, MATERIAL_WOOD, HANDLE_TYPE_STRING, HEAD_TYPE_BOW);
  setweapon(WEAPON_TYPE_COMPOSITE_LONGBOW_3, "composite long bow (str 3)", 1, 8, 0, 3,
          WEAPON_FLAG_MARTIAL | WEAPON_FLAG_RANGED, 30000, DAMAGE_TYPE_PIERCING, 3, 110,
          WEAPON_FAMILY_BOW, SIZE_LARGE, MATERIAL_WOOD, HANDLE_TYPE_STRING, HEAD_TYPE_BOW);
  setweapon(WEAPON_TYPE_COMPOSITE_LONGBOW_4, "composite long bow (str 4)", 1, 8, 0, 3,
          WEAPON_FLAG_MARTIAL | WEAPON_FLAG_RANGED, 40000, DAMAGE_TYPE_PIERCING, 3, 110,
          WEAPON_FAMILY_BOW, SIZE_LARGE, MATERIAL_WOOD, HANDLE_TYPE_STRING, HEAD_TYPE_BOW);
  setweapon(WEAPON_TYPE_COMPOSITE_LONGBOW_5, "composite long bow (str 5)", 1, 8, 0, 3,
  ...
  setweapon(WEAPON_TYPE_COMPOSITE_SHORTBOW, "composite short bow (str 1)", 1, 6, 0, 3,
  ...
  setweapon(WEAPON_TYPE_COMPOSITE_SHORTBOW_2, "composite short bow (str 2)", 1, 6, 0, 3,
          WEAPON_FLAG_MARTIAL | WEAPON_FLAG_RANGED, 17500, DAMAGE_TYPE_PIERCING, 2, 70,
          WEAPON_FAMILY_BOW, SIZE_SMALL, MATERIAL_WOOD, HANDLE_TYPE_STRING, HEAD_TYPE_BOW);
  setweapon(WEAPON_TYPE_COMPOSITE_SHORTBOW_3, "composite short bow (str 3)", 1, 6, 0, 3,
          WEAPON_FLAG_MARTIAL | WEAPON_FLAG_RANGED, 27500, DAMAGE_TYPE_PIERCING, 2, 70,
          WEAPON_FAMILY_BOW, SIZE_SMALL, MATERIAL_WOOD, HANDLE_TYPE_STRING, HEAD_TYPE_BOW);
  setweapon(WEAPON_TYPE_COMPOSITE_SHORTBOW_4, "composite short bow (str 4)", 1, 6, 0, 3,
          WEAPON_FLAG_MARTIAL | WEAPON_FLAG_RANGED, 37500, DAMAGE_TYPE_PIERCING, 2, 70,
          WEAPON_FAMILY_BOW, SIZE_SMALL, MATERIAL_WOOD, HANDLE_TYPE_STRING, HEAD_TYPE_BOW);
  setweapon(WEAPON_TYPE_COMPOSITE_SHORTBOW_5, "composite short bow (str 5)", 1, 6, 0, 3,
