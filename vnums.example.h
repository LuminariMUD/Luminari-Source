// This file contains the vnums of all gear, mobs etc. used by the rest
// of the code. It is HIGHLY recommended to record all vnums here with
// #defines so that you can easily change them later if needed.
...
// The below are for Chronicles of Krynn
...
// The following are for LuminariMUD and Faerun
...
// The following are for Chronicles of Krynn
