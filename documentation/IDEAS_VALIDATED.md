# LuminariMUD Validated Ideas List

This file contains player-submitted ideas for game improvements and new features that have been audited and validated. These ideas:
1. Have NOT been implemented yet
2. Are objectively good ideas that would improve the game
3. Are technically feasible to implement

Bug reports and typos are tracked separately.
