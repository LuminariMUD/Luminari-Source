...
cpp_extern const struct command_info cmd_info[] = {
    ...
    {"ai", "ai", POS_DEAD, do_ai, LVL_GRGOD, 0, TRUE, ACTION_NONE, {0, 0}, NULL},
    ...
    {"containaoes", "cont", POS_RECLINING, do_gen_tog, 0, SCMD_CONTAIN_AOES, FALSE, ACTION_NONE, {0, 0}, NULL},
    ...
    {"evobreath", "evobreath", POS_FIGHTING, do_evobreath, 0, 0, FALSE, ACTION_STANDARD, {0, 0}, NULL},
