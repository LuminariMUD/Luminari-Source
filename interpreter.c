...
cpp_extern const struct command_info cmd_info[] = {
  ...
  { "breathe"     , "breathe"     , POS_FIGHTING, do_breathe     , 1, 0 },
  { "blank"   , "blank"	, POS_RESTING , do_gen_forget   , 0, SCMD_BLANK },
  { "boosts"    , "boost"      , POS_RESTING , do_boosts , 1, 0 },
  { "buck"    , "buck"      , POS_FIGHTING , do_buck , 1, 0 },

  { "cast"     , "c"       , POS_SITTING , do_cast     , 1, 0 },
  { "cedit"    , "cedit"   , POS_DEAD    , do_oasis_cedit, LVL_IMPL, 0 },
  { "chat"   , "chat"     , POS_SLEEPING, do_gen_comm , 0, SCMD_GOSSIP },
  ...
  { "clan"     , "cla"     , POS_DEAD    , do_clan     , 1, 0},
  { "clanset"  , "clans"   , POS_DEAD    , do_clanset  , LVL_IMPL, 0},
  { "clantalk" , "cl"      , POS_DEAD    , do_clantalk , 1, 0 },
  { "clear"    , "cle"     , POS_DEAD    , do_gen_ps   , 0, SCMD_CLEAR },
  { "cls"      , "cls"     , POS_DEAD    , do_gen_ps   , 0, SCMD_CLEAR },
  { "consider" , "con"     , POS_RESTING , do_consider , 0, 0 },
  { "commune" , "commune", POS_RESTING , do_gen_memorize , 0, SCMD_COMMUNE },
  ...
  { "crystalfist" , "crystalfist"    , POS_FIGHTING , do_crystalfist , 0, 0 },
  { "crystalbody" , "crystalbody"    , POS_FIGHTING , do_crystalbody , 0, 0 },
  ...
  { "expertise"     , "expertise"     , POS_FIGHTING, do_expertise     , 1, 0 },
  ...
  { "innates"    , "innates"      , POS_DEAD    , do_innates    , 0, 0 },
  ...
  { "layonhands"   , "layonhands"    , POS_FIGHTING, do_layonhands   , 1, 0 },
  ...
  { "noclantalk", "noclant" ,POS_DEAD    , do_gen_tog  , LVL_IMMORT, SCMD_NOCLANTALK },
  ...
  { "powerattack"     , "powerattack", POS_FIGHTING, do_powerattack , 1, 0 },
...
//  { "savemobs"  , "savemobs" , POS_DEAD    , do_savemobs  , LVL_IMPL, 0},
  ...
  { "smite"    , "smite"   , POS_FIGHTING, do_smite    , 1, 0 },  
  ...
  { "taunt"     , "taunt"     , POS_FIGHTING, do_taunt     , 1, 0 },
  ...
  { "treatinjury"   , "treatinjury"    , POS_FIGHTING, do_treatinjury   , 1, 0 },
  ...
  { "uncommune"   , "uncommune"	, POS_RESTING , do_gen_forget   , 0, SCMD_UNCOMMUNE },
  ...
  { "zlist"    , "zlist"   , POS_DEAD    , do_oasis_list, 0, SCMD_OASIS_ZLIST },
