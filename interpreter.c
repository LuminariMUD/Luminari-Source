...
cpp_extern const struct command_info cmd_info[] = {
  ...
  { "at", "at", POS_DEAD, do_at, LVL_IMMORT, 0, FALSE},
  ...
  { "ask", "ask", POS_RESTING, do_spec_comm, 0, SCMD_ASK, FALSE},
  { "astat", "ast", POS_DEAD, do_astat, 0, 0, FALSE},
  { "attach", "attach", POS_DEAD, do_attach, LVL_BUILDER, 0, FALSE},
  { "attacks", "attacks", POS_DEAD, do_attacks, 0, 0, FALSE},
  { "auction", "auc", POS_SLEEPING, do_gen_comm, 0, SCMD_AUCTION, FALSE},
  { "augment", "augment", POS_STANDING, do_not_here, 1, 0, FALSE},
  { "autoexits", "autoex", POS_DEAD, do_gen_tog, 0, SCMD_AUTOEXIT, FALSE},
  { "autoassist", "autoass", POS_DEAD, do_gen_tog, 0, SCMD_AUTOASSIST, FALSE},
  { "autodoor", "autodoor", POS_DEAD, do_gen_tog, 0, SCMD_AUTODOOR, FALSE},
  { "autogold", "autogold", POS_DEAD, do_gen_tog, 0, SCMD_AUTOGOLD, FALSE},
  { "autokey", "autokey", POS_DEAD, do_gen_tog, 0, SCMD_AUTOKEY, FALSE},
  { "autoloot", "autoloot", POS_DEAD, do_gen_tog, 0, SCMD_AUTOLOOT, FALSE},
  { "automap", "automap", POS_DEAD, do_gen_tog, 0, SCMD_AUTOMAP, FALSE},
  { "autosac", "autosac", POS_DEAD, do_gen_tog, 0, SCMD_AUTOSAC, FALSE},
  { "autoscan", "autoscan", POS_DEAD, do_gen_tog, 0, SCMD_AUTOSCAN, FALSE},
  { "autosplit", "autospl", POS_DEAD, do_gen_tog, 0, SCMD_AUTOSPLIT, FALSE},
  { "abilityset", "abilityset", POS_SLEEPING, do_abilityset, LVL_GRGOD, 0, FALSE},
  { "autocraft", "autocraft", POS_STANDING, do_not_here, 1, 0, FALSE},
  { "adjure", "adjure", POS_RESTING, do_gen_memorize, 0, SCMD_ADJURE, FALSE},

  { "backstab", "ba", POS_STANDING, do_backstab, 1, 0, FALSE},
  { "ban", "ban", POS_DEAD, do_ban, LVL_GRGOD, 0, FALSE},
  { "balance", "bal", POS_STANDING, do_not_here, 1, 0, FALSE},
  { "bash", "bas", POS_FIGHTING, do_bash, 1, 0, FALSE},
  { "brief", "br", POS_DEAD, do_gen_tog, 0, SCMD_BRIEF, FALSE},
  { "buildwalk", "buildwalk", POS_STANDING, do_gen_tog, LVL_BUILDER, SCMD_BUILDWALK, FALSE},
  { "buy", "bu", POS_STANDING, do_not_here, 0, 0, FALSE},
  { "bug", "bug", POS_DEAD, do_ibt, 0, SCMD_BUG, FALSE},
  ...
  { "clan", "cla", POS_DEAD, do_clan, 1, 0, FALSE},
  { "clanset", "clans", POS_DEAD, do_clanset, LVL_IMPL, 0, FALSE},
  { "clantalk", "cl", POS_DEAD, do_clantalk, 1, 0, FALSE},
  { "clear", "cle", POS_DEAD, do_gen_ps, 0, SCMD_CLEAR, FALSE},
  { "cls", "cls", POS_DEAD, do_gen_ps, 0, SCMD_CLEAR, FALSE},
  { "consider", "con", POS_RESTING, do_consider, 0, 0, FALSE},
  { "commune", "commune", POS_RESTING, do_gen_memorize, 0, SCMD_COMMUNE, FALSE},
  { "commands", "com", POS_DEAD, do_commands, 0, SCMD_COMMANDS, FALSE},
  { "compact", "comp", POS_DEAD, do_gen_tog, 0, SCMD_COMPACT, FALSE},
  { "copyover", "copyover", POS_DEAD, do_copyover, LVL_GRGOD, 0, FALSE},
  { "credits", "cred", POS_DEAD, do_gen_ps, 0, SCMD_CREDITS, FALSE},
  { "ct", "ct", POS_DEAD, do_clantalk, 1, 0, FALSE},
  ...
  { "date", "da", POS_DEAD, do_date, 1, SCMD_DATE, FALSE},
  { "dc", "dc", POS_DEAD, do_dc, LVL_GOD, 0, FALSE},
  { "deposit", "depo", POS_STANDING, do_not_here, 1, 0, FALSE},
  { "detach", "detach", POS_DEAD, do_detach, LVL_BUILDER, 0, FALSE},
  { "diagnose", "diag", POS_RESTING, do_diagnose, 0, 0, FALSE},
  { "dig", "dig", POS_DEAD, do_dig, LVL_BUILDER, 0, FALSE},
  { "display", "disp", POS_DEAD, do_display, 0, 0, FALSE},
  ...
  { "echo", "ec", POS_SLEEPING, do_echo, LVL_IMMORT, SCMD_ECHO, FALSE},
  { "emote", "em", POS_RESTING, do_echo, 0, SCMD_EMOTE, FALSE},
  { ":", ":", POS_RESTING, do_echo, 1, SCMD_EMOTE, FALSE},
  { "enter", "ent", POS_STANDING, do_enter, 0, 0, FALSE},
  { "equipment", "eq", POS_SLEEPING, do_equipment, 0, 0, FALSE},
  { "exits", "ex", POS_RESTING, do_exits, 0, 0, FALSE},
  { "examine", "exa", POS_RESTING, do_examine, 0, 0, FALSE},
  { "expertise", "expertise", POS_FIGHTING, do_expertise, 1, 0, FALSE},
  { "export", "export", POS_DEAD, do_export_zone, LVL_IMPL, 0, FALSE},

  { "force", "force", POS_SLEEPING, do_force, LVL_GOD, 0, FALSE},
  { "fill", "fil", POS_STANDING, do_pour, 0, SCMD_FILL, FALSE},
  { "file", "file", POS_SLEEPING, do_file, LVL_GOD, 0, FALSE},
  ...
  { "freeze", "freeze", POS_DEAD, do_wizutil, LVL_GRGOD, SCMD_FREEZE, FALSE},
  ...
  { "gecho", "gecho", POS_DEAD, do_gecho, LVL_GOD, 0, FALSE},
  { "gemote", "gem", POS_SLEEPING, do_gen_comm, 0, SCMD_GEMOTE, FALSE},
  ...
  { "help", "h", POS_DEAD, do_help, 0, 0, FALSE},
  { "happyhour", "ha", POS_DEAD, do_happyhour, 0, 0, FALSE},
  { "hedit", "hedit", POS_DEAD, do_oasis_hedit, LVL_GOD, 0, FALSE},
  { "helpcheck", "helpch", POS_DEAD, do_helpcheck, LVL_GOD, 0, FALSE},
  ...
  { "idea", "ide", POS_DEAD, do_ibt, 0, SCMD_IDEA, FALSE},
  { "imotd", "imo", POS_DEAD, do_gen_ps, LVL_IMMORT, SCMD_IMOTD, FALSE},
  { "immlist", "imm", POS_DEAD, do_gen_ps, 0, SCMD_IMMLIST, FALSE},
  { "info", "info", POS_SLEEPING, do_gen_ps, 0, SCMD_INFO, FALSE},
  { "invis", "invi", POS_DEAD, do_invis, LVL_IMMORT, 0, FALSE},
  { "innates", "innates", POS_DEAD, do_innates, 0, 0, FALSE},
  ...
  { "medit", "med", POS_DEAD, do_oasis_medit, LVL_BUILDER, 0, FALSE},
  { "meditate", "meditate", POS_RESTING, do_gen_memorize, 0, SCMD_MEDITATE, FALSE},
  { "mlist", "mlist", POS_DEAD, do_oasis_list, LVL_BUILDER, SCMD_OASIS_MLIST, FALSE},
  { "mcopy", "mcopy", POS_DEAD, do_oasis_copy, LVL_GOD, CON_MEDIT, FALSE},
  { "motd", "motd", POS_DEAD, do_gen_ps, 0, SCMD_MOTD, FALSE},
  { "msgedit", "msgedit", POS_DEAD, do_msgedit, LVL_GOD, 0, FALSE},
  { "mute", "mute", POS_DEAD, do_wizutil, LVL_GOD, SCMD_MUTE, FALSE},
  { "mount", "mount", POS_FIGHTING, do_mount, 0, 0, FALSE},

  { "news", "news", POS_SLEEPING, do_gen_ps, 0, SCMD_NEWS, FALSE},
  { "noauction", "noauction", POS_DEAD, do_gen_tog, 0, SCMD_NOAUCTION, FALSE},
  { "noclantalk", "noclant", POS_DEAD, do_gen_tog, LVL_IMMORT, SCMD_NOCLANTALK, FALSE},
  { "nogossip", "nogossip", POS_DEAD, do_gen_tog, 0, SCMD_NOGOSSIP, FALSE},
  { "nograts", "nograts", POS_DEAD, do_gen_tog, 0, SCMD_NOGRATZ, FALSE},
  { "nohassle", "nohassle", POS_DEAD, do_gen_tog, LVL_IMMORT, SCMD_NOHASSLE, FALSE},
  { "norepeat", "norepeat", POS_DEAD, do_gen_tog, 0, SCMD_NOREPEAT, FALSE},
  { "noshout", "noshout", POS_SLEEPING, do_gen_tog, 1, SCMD_NOSHOUT, FALSE},
  { "nosummon", "nosummon", POS_DEAD, do_gen_tog, 1, SCMD_NOSUMMON, FALSE},
  { "notell", "notell", POS_DEAD, do_gen_tog, 1, SCMD_NOTELL, FALSE},
  { "notitle", "notitle", POS_DEAD, do_wizutil, LVL_GOD, SCMD_NOTITLE, FALSE},
  { "nowiz", "nowiz", POS_DEAD, do_gen_tog, LVL_IMMORT, SCMD_NOWIZ, FALSE},
  ...
  { "olc", "olc", POS_DEAD, do_show_save_list, LVL_BUILDER, 0, FALSE},
  { "olist", "olist", POS_DEAD, do_oasis_list, LVL_BUILDER, SCMD_OASIS_OLIST, FALSE},
  { "oedit", "oedit", POS_DEAD, do_oasis_oedit, LVL_BUILDER, 0, FALSE},
  { "oset", "oset", POS_DEAD, do_oset, LVL_BUILDER, 0, FALSE},
  { "ocopy", "ocopy", POS_DEAD, do_oasis_copy, LVL_GOD, CON_OEDIT, FALSE},
  ...
  { "peace", "pe", POS_DEAD, do_peace, LVL_BUILDER, 0, FALSE},
  ...
  { "pardon", "pardon", POS_DEAD, do_wizutil, LVL_GOD, SCMD_PARDON, FALSE},
  { "plist", "plist", POS_DEAD, do_plist, LVL_GOD, 0, FALSE},
  { "policy", "pol", POS_DEAD, do_gen_ps, 0, SCMD_POLICIES, FALSE},
  { "pour", "pour", POS_STANDING, do_pour, 0, SCMD_POUR, FALSE},
  { "powerattack", "powerattack", POS_FIGHTING, do_powerattack, 1, 0, FALSE},
  { "prompt", "pro", POS_DEAD, do_display, 0, 0, FALSE},
  { "prefedit", "pre", POS_DEAD, do_oasis_prefedit, 0, 0, FALSE},
  { "purify", "purify", POS_FIGHTING, do_purify, 1, 0, FALSE},
  { "purge", "purge", POS_DEAD, do_purge, LVL_BUILDER, 0, FALSE},
  { "prayer", "prayer", POS_RESTING, do_gen_memorize, 0, SCMD_PRAY, FALSE},
  { "perform", "perform", POS_FIGHTING, do_perform, 1, 0, FALSE},

  { "qedit", "qedit", POS_DEAD, do_oasis_qedit, LVL_BUILDER, 0, FALSE},
  { "qlist", "qlist", POS_DEAD, do_oasis_list, LVL_BUILDER, SCMD_OASIS_QLIST, FALSE},
  { "quaff", "qua", POS_RESTING, do_use, 0, SCMD_QUAFF, FALSE},
  { "qecho", "qec", POS_DEAD, do_qcomm, LVL_GOD, SCMD_QECHO, FALSE},
  { "quest", "que", POS_DEAD, do_quest, 0, 0, FALSE},
  { "qui", "qui", POS_DEAD, do_quit, 0, 0, FALSE},
  { "quit", "quit", POS_DEAD, do_quit, 0, SCMD_QUIT, FALSE},
  { "qsay", "qsay", POS_RESTING, do_qcomm, 0, SCMD_QSAY, FALSE},

  { "rest", "res", POS_RESTING, do_rest, 0, 0, FALSE},
  { "reply", "r", POS_SLEEPING, do_reply, 0, 0, FALSE},
  { "read", "rea", POS_RESTING, do_look, 0, SCMD_READ, FALSE},
  { "reload", "reload", POS_DEAD, do_reboot, LVL_IMPL, 0, FALSE},
  { "recite", "reci", POS_RESTING, do_use, 0, SCMD_RECITE, FALSE},
  { "receive", "rece", POS_STANDING, do_not_here, 1, 0, FALSE},
  { "recent", "recent", POS_DEAD, do_recent, LVL_IMMORT, 0, FALSE},
  { "remove", "rem", POS_RESTING, do_remove, 0, 0, FALSE},
  { "rent", "rent", POS_STANDING, do_not_here, 1, 0, FALSE},
  { "report", "repo", POS_RESTING, do_report, 0, 0, FALSE},
  { "reroll", "rero", POS_DEAD, do_wizutil, LVL_GRGOD, SCMD_REROLL, FALSE},
  { "rescue", "resc", POS_FIGHTING, do_rescue, 1, 0, FALSE},
  { "restore", "resto", POS_DEAD, do_restore, LVL_GOD, 0, FALSE},
  { "return", "retu", POS_DEAD, do_return, 0, 0, FALSE},
  { "redit", "redit", POS_DEAD, do_oasis_redit, LVL_BUILDER, 0, FALSE},
  { "rlist", "rlist", POS_DEAD, do_oasis_list, LVL_BUILDER, SCMD_OASIS_RLIST, FALSE},
  { "rcopy", "rcopy", POS_DEAD, do_oasis_copy, LVL_GOD, CON_REDIT, FALSE},
  { "roomflags", "roomflags", POS_DEAD, do_gen_tog, LVL_IMMORT, SCMD_SHOWVNUMS, FALSE},
  ...
  { "sedit", "sedit", POS_DEAD, do_oasis_sedit, LVL_BUILDER, 0, FALSE},
  { "send", "send", POS_SLEEPING, do_send, LVL_GOD, 0, FALSE},
  { "set", "set", POS_DEAD, do_set, LVL_IMMORT, 0, FALSE},
  { "shout", "sho", POS_RESTING, do_gen_comm, 0, SCMD_SHOUT, FALSE},
  { "show", "show", POS_DEAD, do_show, LVL_IMMORT, 0, FALSE},
  { "shutdow", "shutdow", POS_DEAD, do_shutdown, LVL_IMPL, 0, FALSE},
  { "shutdown", "shutdown", POS_DEAD, do_shutdown, LVL_IMPL, SCMD_SHUTDOWN, FALSE},
  { "sip", "sip", POS_RESTING, do_drink, 0, SCMD_SIP, FALSE},
  { "skillset", "skillset", POS_SLEEPING, do_skillset, LVL_GRGOD, 0, FALSE},
  { "sleep", "sl", POS_SLEEPING, do_sleep, 0, 0, FALSE},
  { "slist", "slist", POS_SLEEPING, do_oasis_list, LVL_BUILDER, SCMD_OASIS_SLIST, FALSE},
  { "smite", "smite", POS_FIGHTING, do_smite, 1, 0, FALSE},
  { "sneak", "sneak", POS_STANDING, do_sneak, 1, 0, FALSE},
  { "snoop", "snoop", POS_DEAD, do_snoop, LVL_GOD, 0, FALSE},
  { "socials", "socials", POS_DEAD, do_commands, 0, SCMD_SOCIALS, FALSE},
  ...
  { "stat", "stat", POS_DEAD, do_stat, LVL_IMMORT, 0, FALSE},
  ...
  { "teleport", "tele", POS_DEAD, do_teleport, LVL_BUILDER, 0, FALSE},
  { "tedit", "tedit", POS_DEAD, do_tedit, LVL_GOD, 0, FALSE}, /* XXX: Oasisify */
  { "thaw", "thaw", POS_DEAD, do_wizutil, LVL_GRGOD, SCMD_THAW, FALSE},
  { "title", "title", POS_DEAD, do_title, 0, 0, FALSE},
  { "time", "time", POS_DEAD, do_time, 0, 0, FALSE},
  { "toggle", "toggle", POS_DEAD, do_toggle, 0, 0, FALSE},
  { "track", "track", POS_STANDING, do_track, 0, 0, FALSE},
  { "train", "tr", POS_RESTING, do_train, 1, 0, FALSE},
  { "transfer", "transfer", POS_SLEEPING, do_trans, LVL_GOD, 0, FALSE},
  { "treatinjury", "treatinjury", POS_FIGHTING, do_treatinjury, 1, 0, FALSE},
  { "trip", "trip", POS_FIGHTING, do_trip, 1, 0, FALSE},
  { "trigedit", "trigedit", POS_DEAD, do_oasis_trigedit, LVL_BUILDER, 0, FALSE},
  { "typo", "typo", POS_DEAD, do_ibt, 0, SCMD_TYPO, FALSE},
  { "tlist", "tlist", POS_DEAD, do_oasis_list, LVL_BUILDER, SCMD_OASIS_TLIST, FALSE},
  { "tcopy", "tcopy", POS_DEAD, do_oasis_copy, LVL_GOD, CON_TRIGEDIT, FALSE},
  { "tstat", "tstat", POS_DEAD, do_tstat, LVL_BUILDER, 0, FALSE},
  ...
  { "unban", "unban", POS_DEAD, do_unban, LVL_GRGOD, 0, FALSE},
  { "unaffect", "unaffect", POS_DEAD, do_wizutil, LVL_GOD, SCMD_UNAFFECT, FALSE},
  { "uncommune", "uncommune", POS_RESTING, do_gen_forget, 0, SCMD_UNCOMMUNE, FALSE},
  { "uptime", "uptime", POS_DEAD, do_date, LVL_GOD, SCMD_UPTIME, FALSE},
  { "use", "use", POS_SITTING, do_use, 1, SCMD_USE, FALSE},
  { "users", "users", POS_DEAD, do_users, LVL_GOD, 0, FALSE},
  { "unadjure", "unadjure", POS_RESTING, do_gen_forget, 0, SCMD_UNADJURE, FALSE},

  { "value", "val", POS_STANDING, do_not_here, 0, 0, FALSE},
  { "version", "ver", POS_DEAD, do_gen_ps, 0, SCMD_VERSION, FALSE},
  { "visible", "vis", POS_RESTING, do_visible, 1, 0, FALSE},
  { "vnum", "vnum", POS_DEAD, do_vnum, LVL_IMMORT, 0, FALSE},
  { "vstat", "vstat", POS_DEAD, do_vstat, LVL_IMMORT, 0, FALSE},
  { "vdelete", "vdelete", POS_DEAD, do_vdelete, LVL_BUILDER, 0, FALSE},

  { "wake", "wake", POS_SLEEPING, do_wake, 0, 0, FALSE},
  { "wear", "wea", POS_RESTING, do_wear, 0, 0, FALSE},
  { "weather", "weather", POS_RESTING, do_weather, 0, 0, FALSE},
  { "who", "wh", POS_DEAD, do_who, 0, 0, FALSE},
  { "whois", "whoi", POS_DEAD, do_whois, 0, 0, FALSE},
  { "whoami", "whoami", POS_DEAD, do_gen_ps, 0, SCMD_WHOAMI, FALSE},
  { "where", "where", POS_RESTING, do_where, 1, 0, FALSE},
  { "whirlwind", "whirl", POS_FIGHTING, do_whirlwind, 0, 0, FALSE},
  { "whisper", "whisper", POS_RESTING, do_spec_comm, 0, SCMD_WHISPER, FALSE},
  { "wield", "wie", POS_RESTING, do_wield, 0, 0, FALSE},
  { "withdraw", "withdraw", POS_STANDING, do_not_here, 1, 0, FALSE},
  { "wiznet", "wiz", POS_DEAD, do_wiznet, LVL_IMMORT, 0, FALSE},
  { ";", ";", POS_DEAD, do_wiznet, LVL_IMMORT, 0, FALSE},
  { "wizhelp", "wizhelp", POS_SLEEPING, do_commands, LVL_IMMORT, SCMD_WIZHELP, FALSE},
  { "wizlist", "wizlist", POS_DEAD, do_gen_ps, 0, SCMD_WIZLIST, FALSE},
  { "wizupdate", "wizupde", POS_DEAD, do_wizupdate, LVL_GRGOD, 0, FALSE},
  { "wizlock", "wizlock", POS_DEAD, do_wizlock, LVL_IMPL, 0, FALSE},
  { "write", "write", POS_STANDING, do_write, 1, 0, FALSE},

  { "zreset", "zreset", POS_DEAD, do_zreset, LVL_BUILDER, 0, FALSE},
  { "zedit", "zedit", POS_DEAD, do_oasis_zedit, LVL_BUILDER, 0, FALSE},
  { "zlist", "zlist", POS_DEAD, do_oasis_list, 0, SCMD_OASIS_ZLIST, FALSE},
  { "zlock", "zlock", POS_DEAD, do_zlock, LVL_GOD, 0, FALSE},
  { "zunlock", "zunlock", POS_DEAD, do_zunlock, LVL_GOD, 0, FALSE},
  { "zcheck", "zcheck", POS_DEAD, do_zcheck, LVL_BUILDER, 0, FALSE},
  { "zpurge", "zpurge", POS_DEAD, do_zpurge, LVL_BUILDER, 0, FALSE},
