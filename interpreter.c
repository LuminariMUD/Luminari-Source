...
//  { "acconvert", "acconvert", POS_DEAD, do_acconvert, LVL_IMPL, 0, TRUE, ACTION_NONE, {0, 0}, NULL},
  ...
  { "auction", "auc", POS_SLEEPING, do_gen_comm, 0, SCMD_AUCTION, TRUE, ACTION_NONE, {0, 0}, NULL},
  ...
  { "charge", "charge", POS_FIGHTING, do_charge, 1, 0, FALSE, ACTION_STANDARD | ACTION_MOVE, {6, 6}, NULL},
  ...
  { "disarm", "disarm", POS_FIGHTING, do_process_attack, 1, AA_DISARM, FALSE, ACTION_NONE, {0, 0}, NULL},
  ...
  { "dracbreath", "dracbreath", POS_FIGHTING, do_sorcerer_breath_weapon, 1, 0, FALSE, ACTION_STANDARD, {6, 0}, NULL},
  { "dracclaws", "dracclaws", POS_FIGHTING, do_sorcerer_claw_attack, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
  ...
  { "frightful", "frightful", POS_FIGHTING, do_frightful, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
...
//  { "mail", "mail", POS_STANDING, do_not_here, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
  ...
  { "quaff", "qua", POS_RECLINING, do_use, 0, SCMD_QUAFF, FALSE, ACTION_MOVE, {0, 6}, NULL},
  ...
  { "recite", "reci", POS_RECLINING, do_use, 0, SCMD_RECITE, FALSE, ACTION_NONE, {0, 0}, NULL},
  ...
  { "rescue", "resc", POS_FIGHTING, do_rescue, 1, 0, FALSE, ACTION_STANDARD | ACTION_MOVE, {6, 6}, NULL},
  { "resistances", "res", POS_DEAD, do_affects, 0, SCMD_RESISTANCES, TRUE, ACTION_NONE, {0, 0}, NULL},
  { "restore", "resto", POS_DEAD, do_restore, LVL_IMMORT, 0, TRUE, ACTION_NONE, {0, 0}, NULL},
  ...
  { "set", "set", POS_DEAD, do_set, LVL_IMMORT, 0, TRUE, ACTION_NONE, {0, 0}, NULL},
  ...
  { "smiteevil", "smiteevil", POS_FIGHTING, do_smiteevil, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
  { "smitegood", "smitegood", POS_FIGHTING, do_smitegood, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
  ...
  { "stunningfist", "stunningfist", POS_FIGHTING, do_stunningfist, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
  ...
  { "sap", "sap", POS_FIGHTING, do_sap, 1, 0, FALSE, ACTION_STANDARD | ACTION_MOVE, {6, 6}, NULL},
  { "shieldpunch", "shieldp", POS_FIGHTING, do_process_attack, 1, AA_SHIELDPUNCH, FALSE, ACTION_NONE, {0, 0}, NULL},
  { "shieldcharge", "shieldc", POS_FIGHTING, do_shieldcharge, 1, 0, FALSE, ACTION_STANDARD | ACTION_MOVE, {6, 6}, NULL},
  { "shieldslam", "shields", POS_FIGHTING, do_shieldslam, 1, 0, FALSE, ACTION_STANDARD | ACTION_MOVE, {6, 6}, NULL},
  { "springleap", "springleap", POS_SITTING, do_springleap, 1, 0, FALSE, ACTION_MOVE, {0, 6}, NULL},
  { "supriseaccuracy", "supriseaccuracy", POS_FIGHTING, do_supriseaccuracy, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
  { "struggle", "struggle", POS_RECLINING, do_struggle, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
  { "seekerarrow", "seekerarrow", POS_FIGHTING, do_seekerarrow, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
  ...
  { "taunt", "taunt", POS_FIGHTING, do_taunt, 1, 0, FALSE, ACTION_STANDARD, {6, 0}, NULL},
  ...
  { "treatinjury", "treatinjury", POS_RECLINING, do_treatinjury, 1, 0, FALSE, ACTION_STANDARD, {6, 0}, NULL},
...
//  { "_trip", "_trip", POS_FIGHTING, do_trip, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
  ...
  { "turnundead", "turnundead", POS_FIGHTING, do_turnundead, 1, 0, FALSE, ACTION_STANDARD, {6, 0}, NULL},
  ...
  { "tailsweep", "tailsweep", POS_FIGHTING, do_tailsweep, 1, 0, FALSE, ACTION_STANDARD | ACTION_MOVE, {6, 6}, NULL},
  ...
  { "use", "use", POS_SITTING, do_use, 1, SCMD_USE, FALSE, ACTION_STANDARD, {6, 0}, NULL},
  ...
  { "whirlwind", "whirl", POS_FIGHTING, do_whirlwind, 0, 0, FALSE, ACTION_STANDARD | ACTION_MOVE, {6, 6}, NULL},
  ...
  { "wholenessofbody", "wholenessofbody", POS_RECLINING, do_wholenessofbody, 1, 0, FALSE, ACTION_STANDARD, {6, 0}, NULL},
  ...
  { "\n", "zzzzzzz", 0, 0, 0, 0, FALSE, ACTION_NONE, {0, 0}, NULL}
}; /* this must be last */
