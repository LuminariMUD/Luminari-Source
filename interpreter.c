...
cpp_extern const struct command_info cmd_info[] = {
    ...
    {"autoblast", "autoblast", POS_FIGHTING, do_autoblast, 1, 0, FALSE, ACTION_NONE, {1, 0}, can_eldritchblast},
    ...
    {"eldritchblast", "blast", POS_FIGHTING, do_eldritchblast, 1, 0, FALSE, ACTION_STANDARD, {0, 0}, can_eldritchblast},
