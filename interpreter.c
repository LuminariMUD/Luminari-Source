...
cpp_extern const struct command_info cmd_info[] = {
  ...
  { "north", "n", POS_RECLINING, do_move, 0, SCMD_NORTH, FALSE},
  { "east", "e", POS_RECLINING, do_move, 0, SCMD_EAST, FALSE},
  { "south", "s", POS_RECLINING, do_move, 0, SCMD_SOUTH, FALSE},
  { "west", "w", POS_RECLINING, do_move, 0, SCMD_WEST, FALSE},
  { "up", "u", POS_RECLINING, do_move, 0, SCMD_UP, FALSE},
  { "down", "d", POS_RECLINING, do_move, 0, SCMD_DOWN, FALSE},
  { "northwest", "northw", POS_RECLINING, do_move, 0, SCMD_NW, FALSE},
  { "nw", "nw", POS_RECLINING, do_move, 0, SCMD_NW, FALSE},
  { "northeast", "northe", POS_RECLINING, do_move, 0, SCMD_NE, FALSE},
  { "ne", "ne", POS_RECLINING, do_move, 0, SCMD_NE, FALSE},
  { "southeast", "southe", POS_RECLINING, do_move, 0, SCMD_SE, FALSE},
  { "se", "se", POS_RECLINING, do_move, 0, SCMD_SE, FALSE},
  { "southwest", "southw", POS_RECLINING, do_move, 0, SCMD_SW, FALSE},
  { "sw", "sw", POS_RECLINING, do_move, 0, SCMD_SW, FALSE},

  /* now, the main list */
  { "abort", "abort", POS_FIGHTING, do_abort, 1, 0, FALSE},
  { "at", "at", POS_DEAD, do_at, LVL_IMMORT, 0, TRUE},
  { "advance", "adv", POS_DEAD, do_advance, LVL_GRSTAFF, 0, TRUE},
  { "aedit", "aed", POS_DEAD, do_oasis_aedit, LVL_STAFF, 0, TRUE},
  ...
  { "ask", "ask", POS_RECLINING, do_spec_comm, 0, SCMD_ASK, TRUE},
  ...
  { "blank", "blank", POS_RECLINING, do_gen_forget, 0, SCMD_BLANK, FALSE},
  { "boosts", "boost", POS_RECLINING, do_boosts, 1, 0, FALSE},
  ...
  { "changelog", "cha", POS_DEAD, do_changelog, LVL_STAFF, 0, TRUE},
  { "check", "ch", POS_STANDING, do_not_here, 1, 0, FALSE},
  { "checkload", "checkl", POS_DEAD, do_checkloadstatus, LVL_STAFF, 0, TRUE},
  ...
  { "consider", "con", POS_RECLINING, do_consider, 0, 0, FALSE},
  ...
  { "copyover", "copyover", POS_DEAD, do_copyover, LVL_GRSTAFF, 0, TRUE},
  ...
  { "diagnose", "diag", POS_RECLINING, do_diagnose, 0, 0, FALSE},
  ...
  { "donate", "don", POS_RECLINING, do_drop, 0, SCMD_DONATE, FALSE},
  { "drink", "dri", POS_RECLINING, do_drink, 0, SCMD_DRINK, FALSE},
  { "drop", "dro", POS_RECLINING, do_drop, 0, SCMD_DROP, FALSE},
  ...
  { "disembark", "disembark", POS_STANDING, do_disembark, 0, 0, FALSE},

  { "eat", "ea", POS_RECLINING, do_eat, 0, SCMD_EAT, FALSE},
  { "echo", "ec", POS_SLEEPING, do_echo, LVL_IMMORT, SCMD_ECHO, TRUE},
  { "emote", "em", POS_RECLINING, do_echo, 0, SCMD_EMOTE, TRUE},
  { ":", ":", POS_RECLINING, do_echo, 1, SCMD_EMOTE, TRUE},
  { "enter", "ent", POS_STANDING, do_enter, 0, 0, FALSE},
  { "equipment", "eq", POS_SLEEPING, do_equipment, 0, 0, TRUE},
  { "exits", "ex", POS_RECLINING, do_exits, 0, 0, TRUE},
  { "examine", "exa", POS_RECLINING, do_examine, 0, 0, FALSE},
  ...
  { "follow", "fol", POS_RECLINING, do_follow, 0, 0, FALSE},
  { "forget", "forget", POS_RECLINING, do_gen_forget, 0, SCMD_FORGET, FALSE},
  ...
  { "group", "gr", POS_RECLINING, do_group, 1, 0, TRUE},
  { "grab", "grab", POS_RECLINING, do_grab, 0, 0, FALSE},
  { "grats", "grat", POS_SLEEPING, do_gen_comm, 0, SCMD_GRATZ, TRUE},
  { "greport", "grepo", POS_RECLINING, do_greport, 0, 0, TRUE},
  ...
  { "hedit", "hedit", POS_DEAD, do_oasis_hedit, LVL_STAFF, 0, TRUE},
  { "helpcheck", "helpch", POS_DEAD, do_helpcheck, LVL_STAFF, 0, TRUE},
  { "hide", "hi", POS_RECLINING, do_hide, 1, 0, FALSE},
  { "hindex", "hind", POS_DEAD, do_hindex, 0, 0, TRUE},
  { "handbook", "handb", POS_DEAD, do_gen_ps, LVL_IMMORT, SCMD_HANDBOOK, TRUE},
  { "hcontrol", "hcontrol", POS_DEAD, do_hcontrol, LVL_GRSTAFF, 0, TRUE},
  { "history", "history", POS_DEAD, do_history, 0, 0, TRUE},
  { "hit", "hit", POS_FIGHTING, do_hit, 0, SCMD_HIT, FALSE},
  { "hold", "hold", POS_RECLINING, do_grab, 1, 0, FALSE},
  { "holler", "holler", POS_RECLINING, do_gen_comm, 1, SCMD_HOLLER, TRUE},
  { "holylight", "holy", POS_DEAD, do_gen_tog, LVL_IMMORT, SCMD_HOLYLIGHT, TRUE},
  { "house", "house", POS_RECLINING, do_house, 0, 0, FALSE},
  ...
  { "junk", "j", POS_RECLINING, do_drop, 0, SCMD_JUNK, FALSE},
  ...
  { "last", "last", POS_DEAD, do_last, LVL_STAFF, 0, TRUE},
  ...
  { "mcopy", "mcopy", POS_DEAD, do_oasis_copy, LVL_STAFF, CON_MEDIT, TRUE},
  ...
  { "ocopy", "ocopy", POS_DEAD, do_oasis_copy, LVL_STAFF, CON_OEDIT, TRUE},
  { "omit", "omit", POS_RECLINING, do_gen_forget, 0, SCMD_OMIT, FALSE},
  //{ "objlist", "objlist", POS_DEAD, do_objlist, LVL_BUILDER, 0, TRUE},
  
  { "put", "p", POS_RECLINING, do_put, 0, 0, FALSE},
...
/*  { "practice", "pr", POS_RECLINING, do_practice, 1, 0, FALSE},*/
  { "page", "pag", POS_DEAD, do_page, 1, 0, FALSE},
  { "pardon", "pardon", POS_DEAD, do_wizutil, LVL_STAFF, SCMD_PARDON, TRUE},
  { "plist", "plist", POS_DEAD, do_plist, LVL_STAFF, 0, TRUE},
  ...
  { "prayer", "prayer", POS_RECLINING, do_gen_memorize, 0, SCMD_PRAY, FALSE},
  ...
  { "quaff", "qua", POS_RECLINING, do_use, 0, SCMD_QUAFF, FALSE},
  { "qecho", "qec", POS_DEAD, do_qcomm, LVL_STAFF, SCMD_QECHO, TRUE},
  ...
  { "recite", "reci", POS_RECLINING, do_use, 0, SCMD_RECITE, FALSE},
  ...
  { "report", "repo", POS_RECLINING, do_report, 0, 0, TRUE},
  { "reroll", "rero", POS_DEAD, do_wizutil, LVL_GRSTAFF, SCMD_REROLL, TRUE},
  { "rescue", "resc", POS_FIGHTING, do_rescue, 1, 0, FALSE},
  { "restore", "resto", POS_DEAD, do_restore, LVL_STAFF, 0, TRUE},
  ...
  { "rcopy", "rcopy", POS_DEAD, do_oasis_copy, LVL_STAFF, CON_REDIT, TRUE},
  ...
  { "sacrifice", "sac", POS_RECLINING, do_sac, 0, 0, FALSE},
  { "say", "s", POS_RECLINING, do_say, 0, 0, TRUE},
  { "score", "sc", POS_DEAD, do_score, 0, 0, TRUE},
  { "scan", "sca", POS_RECLINING, do_scan, 0, 0, FALSE},
  { "scopy", "scopy", POS_DEAD, do_oasis_copy, LVL_STAFF, CON_SEDIT, TRUE},
  { "scribe", "scribe", POS_RESTING, do_scribe, 0, 0, FALSE},
  { "sit", "si", POS_RECLINING, do_sit, 0, 0, FALSE},
  { "'", "'", POS_RECLINING, do_say, 0, 0, TRUE},
  ...
  { "shout", "sho", POS_RECLINING, do_gen_comm, 0, SCMD_SHOUT, TRUE},
  ...
  { "sip", "sip", POS_RECLINING, do_drink, 0, SCMD_SIP, FALSE},
  { "skillset", "skillset", POS_SLEEPING, do_skillset, LVL_GRSTAFF, 0, TRUE},
  ...
  { "snoop", "snoop", POS_DEAD, do_snoop, LVL_STAFF, 0, TRUE},
  { "socials", "socials", POS_DEAD, do_commands, 0, SCMD_SOCIALS, TRUE},
  { "spelllist", "spelllist", POS_RECLINING, do_spelllist, 1, 0, FALSE},
  { "spells", "spells", POS_RECLINING, do_spells, 1, 0, FALSE},
  { "split", "split", POS_SITTING, do_split, 1, 0, FALSE},
  { "spot", "spot", POS_STANDING, do_spot, 1, 0, FALSE},
  { "stand", "st", POS_RECLINING, do_stand, 0, 0, FALSE},
  ...
  { "study", "study", POS_RECLINING, do_study, 1, 0, FALSE},
  { "switch", "switch", POS_DEAD, do_switch, LVL_STAFF, 0, TRUE},
  ...
  { "shieldpunch", "shieldp", POS_FIGHTING, do_shieldpunch, 1, 0, FALSE},
  { "shieldcharge", "shieldc", POS_FIGHTING, do_shieldcharge, 1, 0, FALSE},
  { "shieldslam", "shields", POS_FIGHTING, do_shieldslam, 1, 0, FALSE},
  { "springleap", "springleap", POS_SITTING, do_springleap, 1, 0, FALSE},
  
  { "tell", "t", POS_DEAD, do_tell, 0, 0, TRUE},
  { "take", "ta", POS_RECLINING, do_get, 0, 0, FALSE},
  { "taste", "tas", POS_RECLINING, do_eat, 0, SCMD_TASTE, FALSE},
  { "taunt", "taunt", POS_FIGHTING, do_taunt, 1, 0, FALSE},
  { "teleport", "tele", POS_DEAD, do_teleport, LVL_BUILDER, 0, TRUE},
  { "tedit", "tedit", POS_DEAD, do_tedit, LVL_STAFF, 0, TRUE}, /* XXX: Oasisify */
  { "thaw", "thaw", POS_DEAD, do_wizutil, LVL_GRSTAFF, SCMD_THAW, TRUE},
  ...
  { "train", "tr", POS_RECLINING, do_train, 1, 0, FALSE},
  { "transfer", "transfer", POS_SLEEPING, do_trans, LVL_STAFF, 0, TRUE},
  { "treatinjury", "treatinjury", POS_RECLINING, do_treatinjury, 1, 0, FALSE},
  ...
  { "tcopy", "tcopy", POS_DEAD, do_oasis_copy, LVL_STAFF, CON_TRIGEDIT, TRUE},
  ...
  { "unban", "unban", POS_DEAD, do_unban, LVL_GRSTAFF, 0, TRUE},
  { "unaffect", "unaffect", POS_DEAD, do_wizutil, LVL_STAFF, SCMD_UNAFFECT, TRUE},
  { "uncommune", "uncommune", POS_RECLINING, do_gen_forget, 0, SCMD_UNCOMMUNE, FALSE},
  ...
  { "visible", "vis", POS_RECLINING, do_visible, 1, 0, TRUE},
  ...
  { "wizupdate", "wizupde", POS_DEAD, do_wizupdate, LVL_GRSTAFF, 0, TRUE},
  ...
  { "zlock", "zlock", POS_DEAD, do_zlock, LVL_STAFF, 0, TRUE},
  { "zunlock", "zunlock", POS_DEAD, do_zunlock, LVL_STAFF, 0, TRUE},
