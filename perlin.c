...
*/
   ...
   q = g2[idx][ b00 ] ; u = at2(rx0,ry0);
   q = g2[idx][ b10 ] ; v = at2(rx1,ry0);
   a = lerp(sx, u, v);

   q = g2[idx][ b01 ] ; u = at2(rx0,ry1);
   q = g2[idx][ b11 ] ; v = at2(rx1,ry1);
   b = lerp(sx, u, v);
...
*/
   ...
   q = g3[idx][ b00 + bz0 ] ; u = at3(rx0,ry0,rz0);
   q = g3[idx][ b10 + bz0 ] ; v = at3(rx1,ry0,rz0);
   a = lerp(t, u, v);

   q = g3[idx][ b01 + bz0 ] ; u = at3(rx0,ry1,rz0);
   q = g3[idx][ b11 + bz0 ] ; v = at3(rx1,ry1,rz0);
   b = lerp(t, u, v);

   c = lerp(sy, a, b);

   q = g3[idx][ b00 + bz1 ] ; u = at3(rx0,ry0,rz1);
   q = g3[idx][ b10 + bz1 ] ; v = at3(rx1,ry0,rz1);
   a = lerp(t, u, v);

   q = g3[idx][ b01 + bz1 ] ; u = at3(rx0,ry1,rz1);
   q = g3[idx][ b11 + bz1 ] ; v = at3(rx1,ry1,rz1);
   b = lerp(t, u, v);
...
double PerlinNoise2D(int idx, double x, double y, double alpha, double beta, int scale, int n)
{
   int i;
   double val,sum = 0;
...
double PerlinNoise3D(int idx, double x, double y, double z, double alpha, double beta, int scale, int n)
{
   int i;
   double val,sum = 0;
