...
void populate_crafting_recipes(void)
{
    ...
    craft_recipe(CRAFT_RECIPE_MISC_NECKLACE, ITEM_WORN, ITEM_WEAR_NECK, "necklance", CRAFT_JEWELRY_NECKLACE);
    ...
    craft_recipe(CRAFT_RECIPE_INSTRUMENT_LYRE, ITEM_INSTRUMENT, INSTRUMENT_LYRE, "lyre", INSTRUMENT_LYRE);
        cvariant(CRAFT_RECIPE_INSTRUMENT_LYRE, 0, CRAFT_SKILL_CARPENTER, CRAFT_GROUP_WOOD, 4, CRAFT_GROUP_HARD_METALS, 1, 0, 0, "lyre");
    craft_recipe(CRAFT_RECIPE_INSTRUMENT_FLUTE, ITEM_INSTRUMENT, INSTRUMENT_FLUTE, "flute", INSTRUMENT_FLUTE);
    ...
    craft_recipe(CRAFT_RECIPE_INSTRUMENT_HORN, ITEM_INSTRUMENT, INSTRUMENT_HORN, "horn", INSTRUMENT_HORN);
        cvariant(CRAFT_RECIPE_INSTRUMENT_HORN, 0, CRAFT_SKILL_JEWELER, CRAFT_GROUP_SOFT_METALS, 4, 0, 0, 0, 0, "horn");
    craft_recipe(CRAFT_RECIPE_INSTRUMENT_DRUM, ITEM_INSTRUMENT, INSTRUMENT_DRUM, "drum", INSTRUMENT_DRUM);
    ...
    craft_recipe(CRAFT_RECIPE_INSTRUMENT_HARP, ITEM_INSTRUMENT, INSTRUMENT_HARP, "harp", INSTRUMENT_HARP);
        cvariant(CRAFT_RECIPE_INSTRUMENT_HARP, 0, CRAFT_SKILL_JEWELER, CRAFT_GROUP_SOFT_METALS, 4, CRAFT_GROUP_HARD_METALS, 1, 0, 0, "harp");
    craft_recipe(CRAFT_RECIPE_INSTRUMENT_MANDOLIN, ITEM_INSTRUMENT, INSTRUMENT_MANDOLIN, "mandolin", INSTRUMENT_MANDOLIN);
