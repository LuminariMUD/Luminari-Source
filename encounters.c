...
// CR 1 and Under
    ...
    add_encounter_sector(ENCOUNTER_TYPE_ELK, SECT_TUNDRA);      add_encounter_sector(ENCOUNTER_TYPE_ELK, SECT_TAIGA);
    ...
    add_encounter_record(ENCOUNTER_TYPE_GIANT_FROG, ENCOUNTER_CLASS_COMBAT, 1, 15, ENCOUNTER_GROUP_TYPE_GIANT_FROG, "giant frog", 100, 1, 4, 
      TREASURE_TABLE_NONE, CLASS_WARRIOR, ENCOUNTER_STRENGTH_NORMAL, TRUE_NEUTRAL, RACE_TYPE_ANIMAL, 
      SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, NON_HOSTILE, NON_SENTIENT, SIZE_MEDIUM );
    add_encounter_sector(ENCOUNTER_TYPE_GIANT_FROG, SECT_WATER_SWIM);      add_encounter_sector(ENCOUNTER_TYPE_GIANT_FROG, SECT_MARSHLAND);
    ...
    add_encounter_record(ENCOUNTER_TYPE_GHOUL, ENCOUNTER_CLASS_COMBAT, 1, 15, ENCOUNTER_GROUP_TYPE_GHOUL, "ghoul", 100, 1, 5, 
      ...
      SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, HOSTILE, SENTIENT, SIZE_MEDIUM );
    set_encounter_terrain_all_surface(ENCOUNTER_TYPE_GHOUL);      set_encounter_terrain_all_underdark(ENCOUNTER_TYPE_GHOUL);
    ...
    add_encounter_record(ENCOUNTER_TYPE_GNOLL, ENCOUNTER_CLASS_COMBAT, 1, 15, ENCOUNTER_GROUP_TYPE_GNOLL, "gnoll", 100, 1, 5, 
      ...
      SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, SUBRACE_UNKNOWN, HOSTILE, SENTIENT, SIZE_MEDIUM );
    add_encounter_sector(ENCOUNTER_TYPE_GNOLL, SECT_FIELD);      add_encounter_sector(ENCOUNTER_TYPE_GNOLL, SECT_FOREST);
    add_encounter_sector(ENCOUNTER_TYPE_GNOLL, SECT_HILLS);      add_encounter_sector(ENCOUNTER_TYPE_GNOLL, SECT_DESERT);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_GIANT_GECKO_LIZARD, SECT_FOREST);      add_encounter_sector(ENCOUNTER_TYPE_GIANT_GECKO_LIZARD, SECT_HILLS);
    add_encounter_sector(ENCOUNTER_TYPE_GIANT_GECKO_LIZARD, SECT_MOUNTAIN);      add_encounter_sector(ENCOUNTER_TYPE_GIANT_GECKO_LIZARD, SECT_JUNGLE);
    ...
    set_encounter_terrain_all_underdark(ENCOUNTER_TYPE_MONGRELMAN);      add_encounter_sector(ENCOUNTER_TYPE_MONGRELMAN, SECT_CAVE);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_NIXIE, SECT_WATER_SWIM);      add_encounter_sector(ENCOUNTER_TYPE_NIXIE, SECT_WATER_NOSWIM);
    add_encounter_sector(ENCOUNTER_TYPE_NIXIE, SECT_UNDERWATER);      add_encounter_sector(ENCOUNTER_TYPE_NIXIE, SECT_OCEAN);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_PSEUDODRAGON, SECT_FOREST);      add_encounter_sector(ENCOUNTER_TYPE_PSEUDODRAGON, SECT_JUNGLE);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_RAM, SECT_HILLS);      add_encounter_sector(ENCOUNTER_TYPE_RAM, SECT_MOUNTAIN);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_MANTA_RAY, SECT_WATER_SWIM);      add_encounter_sector(ENCOUNTER_TYPE_MANTA_RAY, SECT_WATER_NOSWIM);
    add_encounter_sector(ENCOUNTER_TYPE_MANTA_RAY, SECT_UNDERWATER);      add_encounter_sector(ENCOUNTER_TYPE_MANTA_RAY, SECT_OCEAN);
    ...
    set_encounter_terrain_all_surface(ENCOUNTER_TYPE_GIANT_SPIDER);      set_encounter_terrain_all_underdark(ENCOUNTER_TYPE_GIANT_SPIDER);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_STRIX, SECT_HILLS);      add_encounter_sector(ENCOUNTER_TYPE_STRIX, SECT_MOUNTAIN);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_TROGLODYTE, SECT_HILLS);      add_encounter_sector(ENCOUNTER_TYPE_TROGLODYTE, SECT_MOUNTAIN);
    add_encounter_sector(ENCOUNTER_TYPE_TROGLODYTE, SECT_MARSHLAND);      add_encounter_sector(ENCOUNTER_TYPE_TROGLODYTE, SECT_CAVE);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_WOLF, SECT_FOREST);      add_encounter_sector(ENCOUNTER_TYPE_WOLF, SECT_HILLS);
    add_encounter_sector(ENCOUNTER_TYPE_WOLF, SECT_TUNDRA);      add_encounter_sector(ENCOUNTER_TYPE_WOLF, SECT_TAIGA);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_HALF_OGRE, SECT_HILLS);      add_encounter_sector(ENCOUNTER_TYPE_HALF_OGRE, SECT_MOUNTAIN);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_MANDRAGORA, SECT_FIELD);      add_encounter_sector(ENCOUNTER_TYPE_MANDRAGORA, SECT_FOREST);
    ...
    set_encounter_terrain_all_surface(ENCOUNTER_TYPE_OGRILLON);      set_encounter_terrain_all_underdark(ENCOUNTER_TYPE_OGRILLON);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_OROG, SECT_HILLS);      add_encounter_sector(ENCOUNTER_TYPE_OROG, SECT_MOUNTAIN);
...
// CR 2
    ...
    set_encounter_terrain_all_surface(ENCOUNTER_TYPE_GIANT_ANT);      set_encounter_terrain_all_underdark(ENCOUNTER_TYPE_GIANT_ANT);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_AXE_BEAK, SECT_FIELD);      add_encounter_sector(ENCOUNTER_TYPE_AXE_BEAK, SECT_BEACH);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_DIRE_BAT, SECT_FOREST);      add_encounter_sector(ENCOUNTER_TYPE_DIRE_BAT, SECT_HILLS);
    add_encounter_sector(ENCOUNTER_TYPE_DIRE_BAT, SECT_FLYING);      add_encounter_sector(ENCOUNTER_TYPE_DIRE_BAT, SECT_MARSHLAND);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_BLINK_DOG, SECT_FIELD);      add_encounter_sector(ENCOUNTER_TYPE_BLINK_DOG, SECT_FOREST);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_BOAR, SECT_FOREST);      add_encounter_sector(ENCOUNTER_TYPE_BOAR, SECT_JUNGLE);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_BUGBEAR, SECT_HILLS);      add_encounter_sector(ENCOUNTER_TYPE_BUGBEAR, SECT_MOUNTAIN);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_CROCODILE, SECT_WATER_SWIM);      add_encounter_sector(ENCOUNTER_TYPE_CROCODILE, SECT_MARSHLAND);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_FAERIE_DRAGON, SECT_FOREST);      add_encounter_sector(ENCOUNTER_TYPE_FAERIE_DRAGON, SECT_JUNGLE);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_HIPPOGRIFF, SECT_FIELD);      add_encounter_sector(ENCOUNTER_TYPE_HIPPOGRIFF, SECT_HILLS);
...
// CR 4
    ...
    add_encounter_sector(ENCOUNTER_TYPE_GRIZZLY_BEAR, SECT_FIELD);      add_encounter_sector(ENCOUNTER_TYPE_GRIZZLY_BEAR, SECT_FOREST);
    add_encounter_sector(ENCOUNTER_TYPE_GRIZZLY_BEAR, SECT_HILLS);      add_encounter_sector(ENCOUNTER_TYPE_GRIZZLY_BEAR, SECT_TAIGA);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_GIANT_STAG_BEETLE, SECT_FIELD);      add_encounter_sector(ENCOUNTER_TYPE_GIANT_STAG_BEETLE, SECT_FOREST);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_BISON, SECT_FIELD);      add_encounter_sector(ENCOUNTER_TYPE_BISON, SECT_TUNDRA);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_DIRE_BOAR, SECT_FIELD);      add_encounter_sector(ENCOUNTER_TYPE_DIRE_BOAR, SECT_FOREST);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_BOTFLY_SWARM, SECT_MARSHLAND);      add_encounter_sector(ENCOUNTER_TYPE_BOTFLY_SWARM, SECT_JUNGLE);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_GIANT_DRAGONFLY, SECT_FIELD);      add_encounter_sector(ENCOUNTER_TYPE_GIANT_DRAGONFLY, SECT_FOREST);
    add_encounter_sector(ENCOUNTER_TYPE_GIANT_DRAGONFLY, SECT_HILLS);      add_encounter_sector(ENCOUNTER_TYPE_GIANT_DRAGONFLY, SECT_MOUNTAIN);
    add_encounter_sector(ENCOUNTER_TYPE_GIANT_DRAGONFLY, SECT_MARSHLAND);      add_encounter_sector(ENCOUNTER_TYPE_GIANT_DRAGONFLY, SECT_JUNGLE);
    add_encounter_sector(ENCOUNTER_TYPE_GIANT_DRAGONFLY, SECT_TUNDRA);      add_encounter_sector(ENCOUNTER_TYPE_GIANT_DRAGONFLY, SECT_BEACH);
    ...
    add_encounter_sector(ENCOUNTER_TYPE_FOREST_DRAKE, SECT_FOREST);      add_encounter_sector(ENCOUNTER_TYPE_FOREST_DRAKE, SECT_TAIGA);
