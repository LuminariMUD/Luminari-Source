...
void Test_spec_rol_toll_keeper_preserves_fees_destinations_and_tickets(CuTest *tc)
{
  ...
  CuAssertIntEquals(tc, 1, rol_toll_keeper_fee_gold(2092000));
  CuAssertIntEquals(tc, 1, rol_toll_keeper_fee_gold(2092002));
  ...
  CuAssertIntEquals(tc, 2092002, rol_toll_keeper_destination(2092000, true));
  CuAssertIntEquals(tc, 2092001, rol_toll_keeper_destination(2092002, false));
...
void Test_spec_rol_utility_object_profiles_preserve_source_boundaries(CuTest *tc)
{
  ...
  CuAssertTrue(tc, rol_utility_spiderhaunt_maggots_trigger("bread"));
  CuAssertTrue(tc, !rol_utility_spiderhaunt_maggots_trigger("maggots"));
  CuAssertTrue(tc, !rol_utility_spiderhaunt_maggots_trigger(NULL));
  CuAssertTrue(tc, rol_utility_spiderhaunt_altar_trigger("worship", POS_SITTING));
  CuAssertTrue(tc, !rol_utility_spiderhaunt_altar_trigger("worship", POS_STANDING));
  CuAssertTrue(tc, !rol_utility_spiderhaunt_altar_trigger("devote", POS_SITTING));
...
void Test_spec_rol_weapon_profiles_cover_converted_bindings(CuTest *tc)
{
  ...
  CuAssertTrue(tc, rol_spiderhaunt_venom_pouch_roll_fires(0));
  CuAssertTrue(tc, !rol_spiderhaunt_venom_pouch_roll_fires(1));
  CuAssertTrue(tc, !rol_spiderhaunt_venom_pouch_roll_fires(60));
...
void Test_spec_rol_monster_combat_profiles_cover_converted_bindings(CuTest *tc)
{
  static const int vnums[] = {
      ...
      2010754, 2010755, 2010756, 2010757, 2010758, 2010759, 2010760, 2010761, 2010762, 2010763,
      2012005, 2012006, 2012024, 2012025, 2012026, 2014015, 2014026, 2014029, 2014601, 2014605,
      2015113, 2015125, 2015204, 2019700, 2019701, 2019750, 2020038, 2020207, 2020217, 2020234,
      2020235, 2020246, 2020247, 2020248, 2020378, 2021786, 2021820, 2026208, 2026216, 2026225,
      2026236, 2026238, 2026241, 2026242, 2026243, 2026244, 2026245, 2032623, 2032629, 2032632,
      2032640, 2032641, 2032642, 2032643, 2032644, 2032645, 2032646, 2032654, 2032659, 2032660,
      2033000, 2033001, 2033003, 2033004, 2033005, 2033008, 2033009, 2033011, 2033014, 2033015,
      2033016, 2033020, 2033021, 2033022, 2033026, 2033027, 2034833, 2041900, 2043358, 2043702,
      ...
      2045182, 2046504, 2046699, 2051246, 2051333, 2051334, 2053264, 2053265, 2053266, 2059815,
      ...
      2062717, 2062721, 2062722, 2080220, 2080240, 2081706, 2081746, 2081747, 2083224, 2089485,
      2089498, 2089793, 2089794, 2092020, 2092022, 2092043, 2092047, 2092052, 2092058, 2092081,
      2092084, 2092095, 2092096, 2092608, 2093002, 2093019, 2093061, 2093102, 2093108, 2093109,
      2093110, 2093111, 2093112, 2093202, 2093204, 2093205, 2093206, 2093209, 2093210, 2093217,
      2093219, 2093303, 2093310, 2093410, 2094505, 2094506, 2094563, 2096631, 2096670, 2096672,
      2097030, 2097061,
  };
  const char *description;
  bool faerie_fire;
