...
SELECT
  ...
  encounter.name,
  hunter.prototype_id,
  hunter.pilot_mob_vnum,
  hunter.min_bounty,
  hunter.pursuit_speed,
  hunter.hunt_duration_seconds,
  hunter.target_grace_seconds,
...
WHERE
  encounter.encounter_id IS NULL
