...
int level_feats[][LEVEL_FEATS] = {
  ...
  {CLASS_BARD, RACE_UNDEFINED, FALSE,  2, FEAT_SONG_OF_PROTECTION},
  {CLASS_BARD, RACE_UNDEFINED, FALSE,  3, FEAT_SONG_OF_FOCUSED_MIND},
  {CLASS_BARD, RACE_UNDEFINED, FALSE,  5, FEAT_SONG_OF_HEROISM},
  {CLASS_BARD, RACE_UNDEFINED, FALSE,  7, FEAT_SONG_OF_REJUVENATION},
  ...
  {CLASS_BARD, RACE_UNDEFINED, FALSE, 15, FEAT_SONG_OF_FORGETFULNESS},
