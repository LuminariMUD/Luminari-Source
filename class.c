...
void load_class_list(void)
{
  ...
  spell_assignment(CLASS_WIZARD, SPELL_MASS_INVISIBILITY, 13);
  /*              class num      spell                   level acquired */
  /* 8th circle */
  ...
  spell_assignment(CLASS_WIZARD, SPELL_MASS_CHARM_MONSTER, 15);
  /*              class num      spell                   level acquired */
  /* 9th circle */
  ...
  feat_assignment(CLASS_WARRIOR, FEAT_DEADLY_AIM, Y, NOASSIGN_FEAT, N);
  ...
  feat_assignment(CLASS_WARRIOR, FEAT_OVERSIZED_TWO_WEAPON_FIGHTING, Y, NOASSIGN_FEAT, N);
  ...
  spell_assignment(CLASS_SORCERER, SPELL_MASS_INVISIBILITY, 14);
  /*              class num      spell                   level acquired */
  /* 8th circle */
  ...
  spell_assignment(CLASS_SORCERER, SPELL_MASS_CHARM_MONSTER, 16);
  /*              class num      spell                   level acquired */
  /* 9th circle */
  ...
  feat_assignment(CLASS_ELDRITCH_KNIGHT, FEAT_DEADLY_AIM, Y, NOASSIGN_FEAT, N);
  ...
  feat_assignment(CLASS_ELDRITCH_KNIGHT, FEAT_OVERSIZED_TWO_WEAPON_FIGHTING, Y, NOASSIGN_FEAT, N);
  ...
  feat_assignment(CLASS_SPELLSWORD, FEAT_DEADLY_AIM, Y, NOASSIGN_FEAT, N);
  ...
  feat_assignment(CLASS_SPELLSWORD, FEAT_OVERSIZED_TWO_WEAPON_FIGHTING, Y, NOASSIGN_FEAT, N);
  ...
  feat_assignment(CLASS_WARLOCK, FEAT_WARLOCK_DR, Y, 3, Y);
  ...
  feat_assignment(CLASS_WARLOCK, FEAT_WARLOCK_DR, Y, 7, Y);
  ...
  feat_assignment(CLASS_WARLOCK, FEAT_ENERGY_RESISTANCE, Y, 8, Y);
  feat_assignment(CLASS_WARLOCK, FEAT_ELDRITCH_BLAST, Y, 11, Y);
  feat_assignment(CLASS_WARLOCK, FEAT_WARLOCK_DR, Y, 11, Y);
  ...
  feat_assignment(CLASS_WARLOCK, FEAT_WARLOCK_DR, Y, 15, Y);
