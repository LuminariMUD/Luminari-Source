...
int level_feats[][LEVEL_FEATS] = {
  ...
  {CLASS_ROGUE, RACE_UNDEFINED, TRUE, 18, FEAT_DIRT_KICK},
  ...
  {CLASS_RANGER, RACE_UNDEFINED, FALSE, 2,  FEAT_DUAL_WEAPON_FIGHTING},
