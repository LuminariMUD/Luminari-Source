...
static const struct spec_definition spec_definitions[] = {
    ...
    {
        .canonical_name = "Pet Keeper",
        .display_name = "Pet Keeper",
        .aliases = NULL,
        .alias_count = 0,
        .owner_mask = SPEC_OWNER_MOBILE,
        .events = command_events,
        ...
        .builder_visibility = SPEC_BUILDER_VISIBLE,
        .category = "Player Services",
        .description = "Lists, stores, and reclaims a player's pets through the stable command.",
        .legacy_handler = pet_keeper,
        .typed_handler = NULL,
    },
    {
