/**************************************************************************
 *  File: spec/spec_zone_kings_castle.c                Part of LuminariMUD *
 *  Usage: King's Castle assignment and mobile procedures.                 *
 *                                                                         *
...
#define castle_mob_spec(mobnum, handler)                                                           \
  castle_mob_spec_recorded((mobnum), (handler), #handler,                                          \
                           "src/spec/spec_zone_kings_castle.c:" CASTLE_SPEC_STRINGIFY(__LINE__))
