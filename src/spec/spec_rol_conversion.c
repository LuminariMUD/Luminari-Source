...
static const struct rol_death_profile rol_death_profiles[] = {
    ...
    {2000202, "$n dissipates into a cloud of oily green smoke.", NULL, 0, 0, ROL_DEATH_EFFECT_NONE,
     true},
    {2000325, "The weretiger slowly fades away into oblivion, hissing softly...", NULL, 0, 0,
     ROL_DEATH_EFFECT_NONE, true},
    {2000326, "The werefox yelps, and vanishes into thin air...", NULL, 0, 0, ROL_DEATH_EFFECT_NONE,
     true},
    {2000327, "The weretiger slowly fades away into oblivion, hissing softly...", NULL, 0, 0,
     ROL_DEATH_EFFECT_NONE, true},
    {2000328, "The weretiger slowly fades away into oblivion, hissing softly...", NULL, 0, 0,
     ROL_DEATH_EFFECT_NONE, true},
