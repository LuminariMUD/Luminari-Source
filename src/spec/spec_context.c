...
{
  return event != SPEC_EVENT_OBJECT_AUTOMATIC && event != SPEC_EVENT_MOVING_ROOM_RELOCATION &&
...
{
  return event == SPEC_EVENT_MOBILE_HIT || event == SPEC_EVENT_MOBILE_WAS_HIT ||
         event == SPEC_EVENT_WEAPON_HIT || event == SPEC_EVENT_DEFENSE_REACTION ||
