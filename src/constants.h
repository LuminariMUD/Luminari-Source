...
extern const char *trap_type[NUM_TRAP_TRIGGERS + 1];
extern const char *trap_effects[NUM_TRAP_SPECIAL_EFFECTS + 1];
...
extern const char *affected2_bit_descs[];
...
extern size_t affected2_bits_count;
extern size_t extra_bits_count;
extern size_t wear_bits_count;
extern const int druid_slots[][NUM_CIRCLES + 1];
extern const int cleric_slots[][NUM_CIRCLES + 1];
extern const int paladin_slots[][NUM_CIRCLES + 1];
extern const int ranger_slots[][NUM_CIRCLES + 1];
extern const int warlock_known[][NUM_CIRCLES + 1];
extern const int bard_known[][NUM_CIRCLES + 1];
extern const int summoner_known[][NUM_CIRCLES + 1];
extern const int inquisitor_known[][NUM_CIRCLES + 1];
extern const int sorcerer_known[][NUM_CIRCLES + 1];
extern const int bard_slots[][NUM_CIRCLES + 1];
extern const int inquisitor_slots[][NUM_CIRCLES + 1];
extern const int sorcerer_slots[][NUM_CIRCLES + 1];
extern const int wizard_slots[][NUM_CIRCLES + 1];
extern const int alchemist_slots[][NUM_CIRCLES + 1];
extern const int summoner_slots[][NUM_CIRCLES + 1];
...
extern const char *eidolon_base_form_names[];
...
extern const char *zone_entrances_fr[NUM_ZONE_ENTRANCES + 1][3];
...
extern const char *crafting_material_descriptions[];
