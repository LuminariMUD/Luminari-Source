 ...
 * - Initialization of deity data based on campaign setting
 * - Domain grants for divine casters (clerics, paladins)
 * - Alignment and ethos restrictions
 * - Deity-specific roleplay elements
 *
 * The deity system is campaign-specific:
 * - CAMPAIGN_FR: Loads Forgotten Realms deities
 * - CAMPAIGN_DL: Loads DragonLance deities
 * - Default: Uses FR deities for generic D&D setting
 *
 ...
 *
 * Called by: assign_deities() before loading campaign-specific deities
 */
...
/**
 * @brief Master function to load all deity data based on campaign setting
 *
 * This is the main initialization function for the deity system. It:
 * 1. Calls init_deities() to set safe defaults for all slots
 * 2. Loads campaign-specific deity data using add_deity() or add_deity_new()
 * 3. Is called once at boot time from the main initialization sequence
 *
 * The deities loaded depend on compile-time campaign flags:
 * - CAMPAIGN_FR: Forgotten Realms deities (119 deities across 9 pantheons)
 * - CAMPAIGN_DL: DragonLance deities (21 deities in 3 alignment groups)
 * - Default: Uses FR deities for generic D&D compatibility
 *
...
/* Deity loading based on campaign setting:
 * - If CAMPAIGN_FR is defined: Load Forgotten Realms deities
 * - If CAMPAIGN_DL is defined: Load DragonLance deities (see #elif below)
 * - Otherwise (neither defined): Load Luminari's original deities
 *
 * Note: Fixed typo from CAMPAING_FR to CAMPAIGN_FR on August 12, 2025
 * Note: Added proper Luminari deity support on current date
 */
#if defined(CAMPAIGN_FR) /* Forgotten Realms deities */
  /* Special entry for characters who worship no deity */
  add_deity(
      DEITY_NONE, "None", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_UNARMED,
      DEITY_PANTHEON_ALL, "The Faithless",
  ...
  add_deity(DEITY_ILMATER, "Ilmater", ETHOS_LAWFUL, ALIGNMENT_GOOD, DOMAIN_GOOD, DOMAIN_HEALING,
            DOMAIN_LAW, DOMAIN_STRENGTH, DOMAIN_SUFFERING, DOMAIN_UNDEFINED, WEAPON_TYPE_UNARMED,
            DEITY_PANTHEON_FAERUNIAN, "Endurance, Suffering, Martyrdom, Perseverance",
            "Ilmater is a generous and self-sacrificing deity.  He is willing to shoulder any "
            "burden for another\r\n"
            "person, whether it ius a heavy load or a terrible pain.  A gentle god, Ilmater is "
            "quiet, kind and\r\n"
            "good-spirited.  He appreciates a humorous story and is always slow to anger.  While "
            "most consider\r\n"
            "him non-violent, in the face of extreme cruelty or atrocities, his anger rises and "
            "his wrath is\r\n"
            "terrible to behold.  He takes great care to reassure and protect children and young "
            "creatures, and\r\n"
            "he takes exceptional offense at those that would harm them.\r\n"
            "\r\n"
            "Unlike most other faiths, the church of Ilmater has many saints.  Perceived by most "
            "as a puzzling\r\n"
            "crowd of martyrs, the church of Ilmater spends most of its efforts on providing "
            "healing to those\r\n"
            "that have been hurt.  It sends its clerics to impoverished areas, places struck by "
            "plague, and war-\r\n"
            "torn lands in order to allieviate the suffering of others.\r\n"
            "\r\n"
            "Ilmater's clerics are the most sensative and caring beings in the world.  While some "
            "grow cynical\r\n"
            "at all the suffering they see, they still are compelled to help those in need "
            "whenever they\r\n"
            "encounter them.  His clerics share whatever they have with the needy and act on "
            "behalf of those\r\n"
            "who cannot act for or defend themselves.  Many learn to brew potions so they can help "
            "those beyond\r\n"
            "their immediate reach.\r\n"
            "\r\n"
            "Clerics of Ilmater pray for spells in the morning, although they still have to pray "
            "to Ilmater at\r\n"
            "least six times per day altogether.  They have no annual holy days, but occasionally "
            "a cleric asks\r\n"
            "for a Plea of Rest.  This allows him a tenday of respite from Ilmater's dictates, "
            "which prevents the\r\n"
            "cleric from suffering emotiuonal exhaustion, or allows him to perform some act that "
            "Ilmater normally\r\n"
            "frowns upon.  One group of monks of Ilmater act as the defenders of the faithful and "
            "the church\r\n"
            "temples.  These monks often multiclass as clerics.\r\n");

  add_deity(DEITY_TEMPUS, "Tempus", ETHOS_CHAOTIC, ALIGNMENT_NEUTRAL, DOMAIN_CHAOS,
            DOMAIN_PROTECTION, DOMAIN_STRENGTH, DOMAIN_WAR, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
            WEAPON_TYPE_BATTLE_AXE, DEITY_PANTHEON_FAERUNIAN, "War, Battle, Warriors",
  ...
  add_deity(DEITY_UTHGAR, "Uthgar", ETHOS_CHAOTIC, ALIGNMENT_NEUTRAL, DOMAIN_ANIMAL, DOMAIN_CHAOS,
            DOMAIN_RETRIBUTION, DOMAIN_STRENGTH, DOMAIN_WAR, DOMAIN_UNDEFINED,
            WEAPON_TYPE_BATTLE_AXE, DEITY_PANTHEON_FAERUNIAN,
            "Uthgardt Barabrian Tribes, Physical Strength",
            "\r\n"
  ...
  add_deity(DEITY_UBTAO, "Ubtao", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DOMAIN_PLANNING, DOMAIN_PLANT,
            DOMAIN_PROTECTION, DOMAIN_SCALYKIND, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
            WEAPON_TYPE_HEAVY_PICK, DEITY_PANTHEON_FAERUNIAN,
            "Creation, Jungles, Cult, the Chultans, Dinosaurs",
            "\r\n"
  ...
  add_deity(DEITY_TYMORA, "Tymora", ETHOS_CHAOTIC, ALIGNMENT_GOOD, DOMAIN_CHAOS, DOMAIN_GOOD,
            DOMAIN_LUCK, DOMAIN_PROTECTION, DOMAIN_TRAVEL, DOMAIN_UNDEFINED, WEAPON_TYPE_SHURIKEN,
            DEITY_PANTHEON_FAERUNIAN, "Good Fortune, Skill, Victory, Adventurers",
  ...
  add_deity(DEITY_MASK, "Mask", ETHOS_NEUTRAL, ALIGNMENT_EVIL, DOMAIN_DARKNESS, DOMAIN_EVIL,
            DOMAIN_LUCK, DOMAIN_TRICKERY, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
            WEAPON_TYPE_LONG_SWORD, DEITY_PANTHEON_FAERUNIAN, "Thieves, Thievery, Shadows",
            "\r\n"
  ...
  add_deity(
      DEITY_LLIIRA, "Lliira", ETHOS_CHAOTIC, ALIGNMENT_GOOD, DOMAIN_CHAOS, DOMAIN_CHARM,
      DOMAIN_FAMILY, DOMAIN_GOOD, DOMAIN_TRAVEL, DOMAIN_UNDEFINED, WEAPON_TYPE_SHURIKEN,
      DEITY_PANTHEON_FAERUNIAN, "Joy, Happiness, Dance, Festivals, Freedom, Liberty",
  ...
  add_deity(DEITY_HELM, "Helm", ETHOS_LAWFUL, ALIGNMENT_NEUTRAL, DOMAIN_LAW, DOMAIN_PROTECTION,
            DOMAIN_STRENGTH, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
            WEAPON_TYPE_BASTARD_SWORD, DEITY_PANTHEON_FAERUNIAN,
  ...
  add_deity(
      DEITY_SHAR, "Shar", ETHOS_NEUTRAL, ALIGNMENT_EVIL, DOMAIN_CAVERN, DOMAIN_DARKNESS,
      DOMAIN_EVIL, DOMAIN_KNOWLEDGE, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_KUKRI,
      DEITY_PANTHEON_FAERUNIAN, "Dark, Night, Loss, Secrets, Underdark",
  ...
  add_deity(
      DEITY_MYSTRA, "Mystra", ETHOS_NEUTRAL, ALIGNMENT_GOOD, DOMAIN_GOOD, DOMAIN_ILLUSION,
      DOMAIN_RUNE, DOMAIN_KNOWLEDGE, DOMAIN_MAGIC, DOMAIN_SPELL, WEAPON_TYPE_SHURIKEN,
      DEITY_PANTHEON_FAERUNIAN, "Magic, Spells, The Weave",
  ...
  add_deity_new(
      DEITY_AKADI, "Akadi", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DEITY_PANTHEON_FAERUNIAN,
      "Lady of the Winds, The Lady of Air, Queen of Air",
      "Elemental Air, Movement, Speed, Flying Creatures", "a white cloud on a blue background",
      "True Neutral, Lawful Neutral, Chaotic Neutral, Neutral Evil", "Akadian(s)",
  ...
  add_deity_new(
      DEITY_AURIL, "Auril", ETHOS_NEUTRAL, ALIGNMENT_EVIL, DEITY_PANTHEON_FAERUNIAN,
      "Frostmaiden, Icedawn, the Cold Goddess, Lady Frostkiss, Frost Sprite Queen", "Cold, Winter",
      "a six-pointed snowflake in a diamond", "Lawful Evil, Neutral Evil, Chaotic Evil",
      "Aurilian(s), Aurilite(s)",
  ...
  add_deity_new(
      DEITY_AZUTH, "Azuth", ETHOS_LAWFUL, ALIGNMENT_NEUTRAL, DEITY_PANTHEON_FAERUNIAN,
  ...
  add_deity_new(
      DEITY_BANE, "Bane", ETHOS_LAWFUL, ALIGNMENT_EVIL, DEITY_PANTHEON_FAERUNIAN,
      "God of Tyranny, The Black Lord, The Black Hand, Lord of Darkness",
      "Strife, Hatred, Tyranny, Fear", "an upright black right hand, thumb and fingers together",
      "Lawful Neutral, Lawful Evil, Neutral Evil", "Banite(s)",
  ...
  add_deity_new(
      DEITY_BESHABA, "Beshaba", ETHOS_CHAOTIC, ALIGNMENT_EVIL, DEITY_PANTHEON_FAERUNIAN,
      "The Maid of Misfortune, Lady Doom, Black Bess",
      "Random Mischief, Misfortune, Bad Luck, Accidents", "some black antlers on a red field",
      "Neutral Evil, Chaotic Evil, Chaotic Neutral", "Beshaban(s)",
  ...
  add_deity(DEITY_CHAUNTEA, "Chauntea", ETHOS_NEUTRAL, ALIGNMENT_GOOD, DOMAIN_ANIMAL, DOMAIN_EARTH,
            DOMAIN_GOOD, DOMAIN_PLANT, DOMAIN_PROTECTION, DOMAIN_RENEWAL, WEAPON_TYPE_SCYTHE,
            DEITY_PANTHEON_FAERUNIAN, "Agriculture, Gardeners, Farmers, Summer",
            "Chauntea (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_CYRIC, "Cyric", ETHOS_CHAOTIC, ALIGNMENT_EVIL, DOMAIN_CHAOS, DOMAIN_EVIL,
            DOMAIN_DESTRUCTION, DOMAIN_ILLUSION, DOMAIN_TRICKERY, DOMAIN_UNDEFINED,
            WEAPON_TYPE_LONG_SWORD, DEITY_PANTHEON_FAERUNIAN,
            "Murder, Lies, Intrigue, Strife, Deception, Illusion",
            "Cyric (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_DENEIR, "Deneir", ETHOS_NEUTRAL, ALIGNMENT_GOOD, DOMAIN_GOOD, DOMAIN_KNOWLEDGE,
            DOMAIN_RUNE, DOMAIN_PROTECTION, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_DAGGER,
            DEITY_PANTHEON_FAERUNIAN, "Glyphs, Images, Literature, Scribes, Cartography",
            "Deneir (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_ELDATH, "Eldath", ETHOS_NEUTRAL, ALIGNMENT_GOOD, DOMAIN_FAMILY, DOMAIN_GOOD,
            DOMAIN_PLANT, DOMAIN_PROTECTION, DOMAIN_WATER, DOMAIN_UNDEFINED, WEAPON_TYPE_NET,
            DEITY_PANTHEON_FAERUNIAN, "Quiet Places, Springs, Pools, Peace, Waterfalls",
            "Eldath (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_FINDER_WYVERNSPUR, "Finder Wyvernspur", ETHOS_CHAOTIC, ALIGNMENT_NEUTRAL,
            DOMAIN_CHAOS, DOMAIN_CHARM, DOMAIN_RENEWAL, DOMAIN_SCALYKIND, DOMAIN_UNDEFINED,
            DOMAIN_UNDEFINED, WEAPON_TYPE_BASTARD_SWORD, DEITY_PANTHEON_FAERUNIAN,
            "Cycle of Life, Transformation of Art, Saurials",
            "Finder Wyvernspur (Description not done yet.  If you wish to write it, let Gicker "
            "know.)\r\n");

  add_deity(DEITY_GARAGOS, "Garagos", ETHOS_CHAOTIC, ALIGNMENT_NEUTRAL, DOMAIN_CHAOS,
            DOMAIN_DESTRUCTION, DOMAIN_STRENGTH, DOMAIN_WAR, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
            WEAPON_TYPE_LONG_SWORD, DEITY_PANTHEON_FAERUNIAN,
            "War, Skill-at-Arms, Destruction, Plunder",
            "Garagos (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_GARGAUTH, "Gargauth", ETHOS_LAWFUL, ALIGNMENT_EVIL, DOMAIN_CHARM, DOMAIN_EVIL,
            DOMAIN_LAW, DOMAIN_TRICKERY, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_DAGGER,
            DEITY_PANTHEON_FAERUNIAN, "Betrayal, Cruelty, Politcal Corruption, Powerbrokers",
            "Gargauth (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_GOND, "Gond", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DOMAIN_CRAFT, DOMAIN_EARTH,
            DOMAIN_FIRE, DOMAIN_KNOWLEDGE, DOMAIN_METAL, DOMAIN_PLANNING, WEAPON_TYPE_WARHAMMER,
            DEITY_PANTHEON_FAERUNIAN, "Artifice, Craft, COnstruction, Smithwork",
            "Gond (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_GRUMBAR, "Grumbar", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DOMAIN_CAVERN, DOMAIN_EARTH,
            DOMAIN_METAL, DOMAIN_TIME, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_WARHAMMER,
            DEITY_PANTHEON_FAERUNIAN, "Elemental Earth, Solidity, Changelessness, Oaths",
            "Grumbar (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_GWAERON_WINDSTROM, "Dwaeron Windstrom", ETHOS_NEUTRAL, ALIGNMENT_GOOD,
            DOMAIN_ANIMAL, DOMAIN_GOOD, DOMAIN_KNOWLEDGE, DOMAIN_PLANT, DOMAIN_TRAVEL,
            DOMAIN_UNDEFINED, WEAPON_TYPE_GREAT_SWORD, DEITY_PANTHEON_FAERUNIAN,
            "Tracking, Rangers of the North",
            "Gwaeron Windstrom (Description not done yet.  If you wish to write it, let Gicker "
            "know.)\r\n");

  add_deity(DEITY_HOAR, "Hoar", ETHOS_LAWFUL, ALIGNMENT_NEUTRAL, DOMAIN_FATE, DOMAIN_LAW,
            DOMAIN_RETRIBUTION, DOMAIN_TRAVEL, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
            WEAPON_TYPE_JAVELIN, DEITY_PANTHEON_FAERUNIAN, "Revenge, Retribution, Poetic Justice",
            "Hoar (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_ISTISHIA, "Istishia", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DOMAIN_DESTRUCTION,
            DOMAIN_OCEAN, DOMAIN_STORM, DOMAIN_TRAVEL, DOMAIN_WATER, DOMAIN_UNDEFINED,
            WEAPON_TYPE_WARHAMMER, DEITY_PANTHEON_FAERUNIAN,
            "Elemental Water, Purification, Wetness",
            "Istishia (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_JERGAL, "Jergal", ETHOS_LAWFUL, ALIGNMENT_NEUTRAL, DOMAIN_DEATH, DOMAIN_FATE,
            DOMAIN_LAW, DOMAIN_RUNE, DOMAIN_SUFFERING, DOMAIN_UNDEFINED, WEAPON_TYPE_SCYTHE,
            DEITY_PANTHEON_FAERUNIAN, "Fatalism, Proper Burial, Guardianship of Tombs",
            "Jergal (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_KELEMVOR, "Kelemvor", ETHOS_LAWFUL, ALIGNMENT_NEUTRAL, DOMAIN_DEATH, DOMAIN_FATE,
            DOMAIN_LAW, DOMAIN_PROTECTION, DOMAIN_TRAVEL, DOMAIN_UNDEFINED,
            WEAPON_TYPE_BASTARD_SWORD, DEITY_PANTHEON_FAERUNIAN, "Death, the Dead",
            "Kelemvor (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_KOSSUTH, "Kossuth", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DOMAIN_DESTRUCTION,
            DOMAIN_FIRE, DOMAIN_RENEWAL, DOMAIN_SUFFERING, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
            WEAPON_TYPE_SPIKED_CHAIN, DEITY_PANTHEON_FAERUNIAN,
            "Elemental Fire, Purification through Fire",
            "Kossuth (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_LATHANDER, "Lathander", ETHOS_NEUTRAL, ALIGNMENT_GOOD, DOMAIN_GOOD,
            DOMAIN_NOBILITY, DOMAIN_PROTECTION, DOMAIN_RENEWAL, DOMAIN_STRENGTH, DOMAIN_SUN,
            WEAPON_TYPE_HEAVY_MACE, DEITY_PANTHEON_FAERUNIAN,
            "Spring, Dawn, Youth, Birth, Vitality, Athletics",
            "Lathander (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_LOVIATAR, "Loviatar", ETHOS_LAWFUL, ALIGNMENT_EVIL, DOMAIN_EVIL, DOMAIN_LAW,
            DOMAIN_RETRIBUTION, DOMAIN_SUFFERING, DOMAIN_STRENGTH, DOMAIN_UNDEFINED,
            WEAPON_TYPE_SPIKED_CHAIN, DEITY_PANTHEON_FAERUNIAN,
            "Pain, Hurt, Agony, Torment, Suffering Torture",
            "Loviatar (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_LURUE, "Lurue", ETHOS_CHAOTIC, ALIGNMENT_GOOD, DOMAIN_ANIMAL, DOMAIN_CHAOS,
            DOMAIN_GOOD, DOMAIN_HEALING, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_SHORTSPEAR,
            DEITY_PANTHEON_FAERUNIAN, "Talking Beasts, Intelligent Non-Humanoid Creatures",
            "Lurue (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_MALAR, "Malar", ETHOS_CHAOTIC, ALIGNMENT_EVIL, DOMAIN_ANIMAL, DOMAIN_CHAOS,
            DOMAIN_EVIL, DOMAIN_MOON, DOMAIN_STRENGTH, DOMAIN_UNDEFINED, WEAPON_TYPE_UNARMED,
            DEITY_PANTHEON_FAERUNIAN, "Hunters, Stalking, Bloodlust, Evil Lycanthropes",
            "Malar (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_MIELIKKI, "Meilikki", ETHOS_NEUTRAL, ALIGNMENT_GOOD, DOMAIN_ANIMAL, DOMAIN_GOOD,
            DOMAIN_PLANT, DOMAIN_TRAVEL, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_SCIMITAR,
            DEITY_PANTHEON_FAERUNIAN, "Forests, Forest Creatures, Rangers, Dryads, Autumn",
            "Meilikki (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_MILIL, "Milil", ETHOS_NEUTRAL, ALIGNMENT_GOOD, DOMAIN_CHARM, DOMAIN_GOOD,
            DOMAIN_KNOWLEDGE, DOMAIN_MOBILITY, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
            WEAPON_TYPE_RAPIER, DEITY_PANTHEON_FAERUNIAN, "Poetry, Song, Eloquence",
            "Milil (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_NOBANION, "Nobanion", ETHOS_LAWFUL, ALIGNMENT_GOOD, DOMAIN_ANIMAL, DOMAIN_GOOD,
            DOMAIN_LAW, DOMAIN_NOBILITY, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_HEAVY_PICK,
            DEITY_PANTHEON_FAERUNIAN, "Royalty, Lions and Feline Beasts, Good Beasts",
            "Nobanion (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_OGHMA, "Oghma", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DOMAIN_CHARM, DOMAIN_LUCK,
            DOMAIN_KNOWLEDGE, DOMAIN_TRAVEL, DOMAIN_TRICKERY, DOMAIN_UNDEFINED,
            WEAPON_TYPE_LONG_SWORD, DEITY_PANTHEON_FAERUNIAN,
            "Knowledge, Invention, Inspiration, Bards",
            "Oghma (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(
      DEITY_RED_KNIGHT, "Red Knight", ETHOS_LAWFUL, ALIGNMENT_NEUTRAL, DOMAIN_LAW, DOMAIN_NOBILITY,
      DOMAIN_PLANNING, DOMAIN_WAR, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_LONG_SWORD,
      DEITY_PANTHEON_FAERUNIAN, "Strategy, Planning, Tactics",
      "Red Knight (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_SAVRAS, "Savras", ETHOS_LAWFUL, ALIGNMENT_NEUTRAL, DOMAIN_FATE, DOMAIN_KNOWLEDGE,
            DOMAIN_LAW, DOMAIN_MAGIC, DOMAIN_SPELL, DOMAIN_UNDEFINED, WEAPON_TYPE_DAGGER,
            DEITY_PANTHEON_FAERUNIAN, "Divination, Fate, Truth",
            "Savras (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_SELUNE, "Selune", ETHOS_CHAOTIC, ALIGNMENT_GOOD, DOMAIN_CHAOS, DOMAIN_GOOD,
            DOMAIN_MOON, DOMAIN_PROTECTION, DOMAIN_TRAVEL, DOMAIN_UNDEFINED, WEAPON_TYPE_HEAVY_MACE,
  ...
  add_deity(DEITY_SHARESS, "Sharess", ETHOS_CHAOTIC, ALIGNMENT_GOOD, DOMAIN_CHAOS, DOMAIN_CHARM,
            DOMAIN_GOOD, DOMAIN_TRAVEL, DOMAIN_TRICKERY, DOMAIN_UNDEFINED, WEAPON_TYPE_UNARMED,
            DEITY_PANTHEON_FAERUNIAN, "Hedonism, Sensual Fulfilment, Festhalls, Cats",
            "Sharess (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(
      DEITY_SHAUNDAKUL, "Shaundakul", ETHOS_CHAOTIC, ALIGNMENT_NEUTRAL, DOMAIN_AIR, DOMAIN_CHAOS,
      DOMAIN_PORTAL, DOMAIN_PROTECTION, DOMAIN_TRADE, DOMAIN_TRAVEL, WEAPON_TYPE_GREAT_SWORD,
      DEITY_PANTHEON_FAERUNIAN, "Travel, Exploration, Caravans, Portals",
      "Shaundakul (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_SHIALLIA, "Shiallia", ETHOS_NEUTRAL, ALIGNMENT_GOOD, DOMAIN_ANIMAL, DOMAIN_PLANT,
            DOMAIN_GOOD, DOMAIN_RENEWAL, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
            WEAPON_TYPE_QUARTERSTAFF, DEITY_PANTHEON_FAERUNIAN,
  ...
  add_deity(DEITY_SIAMORPHE, "Siamorphe", ETHOS_LAWFUL, ALIGNMENT_NEUTRAL, DOMAIN_KNOWLEDGE,
            DOMAIN_LAW, DOMAIN_NOBILITY, DOMAIN_PLANNING, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
            WEAPON_TYPE_LIGHT_MACE, DEITY_PANTHEON_FAERUNIAN,
            "Nobles, Rightful Rule of Nobility, Human Royalty",
            "Siamorphe (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_SILVANUS, "Silvanus", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DOMAIN_ANIMAL,
            DOMAIN_PLANT, DOMAIN_RENEWAL, DOMAIN_PROTECTION, DOMAIN_WATER, DOMAIN_UNDEFINED,
            WEAPON_TYPE_GREAT_CLUB, DEITY_PANTHEON_FAERUNIAN, "Wild Nature, Druids",
            "Silvanus (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_SUNE, "Sune", ETHOS_CHAOTIC, ALIGNMENT_GOOD, DOMAIN_CHAOS, DOMAIN_CHARM,
            DOMAIN_GOOD, DOMAIN_PROTECTION, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_WHIP,
            DEITY_PANTHEON_FAERUNIAN, "Beauty, Love, Passion",
            "Sune (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_TALONA, "Talona", ETHOS_CHAOTIC, ALIGNMENT_EVIL, DOMAIN_DESTRUCTION, DOMAIN_CHAOS,
            DOMAIN_EVIL, DOMAIN_SUFFERING, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_UNARMED,
            DEITY_PANTHEON_FAERUNIAN, "Disease, Poison",
            "Talona (Description not done yet.  If you wish to write it, let Gicker know.)\r\n");

  add_deity(DEITY_TALOS, "Talos", ETHOS_CHAOTIC, ALIGNMENT_EVIL, DOMAIN_DESTRUCTION, DOMAIN_FIRE,
            DOMAIN_CHAOS, DOMAIN_EVIL, DOMAIN_STORM, DOMAIN_UNDEFINED, WEAPON_TYPE_SPEAR,
            DEITY_PANTHEON_FAERUNIAN,
  ...
  add_deity(DEITY_TIAMAT, "Tiamat", ETHOS_LAWFUL, ALIGNMENT_EVIL, DOMAIN_EVIL, DOMAIN_LAW,
            DOMAIN_SCALYKIND, DOMAIN_TYRANNY, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
            WEAPON_TYPE_HEAVY_PICK, DEITY_PANTHEON_FAERUNIAN,
            "Evil Dragons && Reptiles, Greed, Chessenta",
            "Tiamat (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(
      DEITY_TORM, "Torm", ETHOS_LAWFUL, ALIGNMENT_GOOD, DOMAIN_GOOD, DOMAIN_HEALING, DOMAIN_LAW,
      DOMAIN_PROTECTION, DOMAIN_STRENGTH, DOMAIN_UNDEFINED, WEAPON_TYPE_GREAT_SWORD,
      DEITY_PANTHEON_FAERUNIAN, "Duty, Loyalty, Obedience, Paladins",
      "Torm (Description not done yet.  If you wish to write it, email to ilmater@@gmail.com)\r\n");

  add_deity(
      DEITY_TYR, "Tyr", ETHOS_LAWFUL, ALIGNMENT_GOOD, DOMAIN_GOOD, DOMAIN_KNOWLEDGE, DOMAIN_LAW,
      DOMAIN_RETRIBUTION, DOMAIN_WAR, DOMAIN_UNDEFINED, WEAPON_TYPE_LONG_SWORD,
      DEITY_PANTHEON_FAERUNIAN, "Justice",
      "Tyr (Description not done yet.  If you wish to write it, email to ilmater@@gmail.com)\r\n");

  add_deity(DEITY_UMBERLEE, "Umberlee", ETHOS_CHAOTIC, ALIGNMENT_EVIL, DOMAIN_DESTRUCTION,
            DOMAIN_CHAOS, DOMAIN_EVIL, DOMAIN_OCEAN, DOMAIN_STORM, DOMAIN_WATER,
            WEAPON_TYPE_TRIDENT, DEITY_PANTHEON_FAERUNIAN, "Oceans, Currents, Waves, Sea Winds",
            "Umberlee (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_VALKUR, "Valkur", ETHOS_CHAOTIC, ALIGNMENT_GOOD, DOMAIN_AIR, DOMAIN_CHAOS,
            DOMAIN_GOOD, DOMAIN_OCEAN, DOMAIN_PROTECTION, DOMAIN_UNDEFINED, WEAPON_TYPE_SCIMITAR,
            DEITY_PANTHEON_FAERUNIAN, "Sailors, Ships, Favorable Winds, Naval Combat",
            "Valkur (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_VELSHAROON, "Velsharoon", ETHOS_NEUTRAL, ALIGNMENT_EVIL, DOMAIN_DEATH,
            DOMAIN_EVIL, DOMAIN_MAGIC, DOMAIN_UNDEATH, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
            WEAPON_TYPE_QUARTERSTAFF, DEITY_PANTHEON_FAERUNIAN,
            "Necromancy, Necormancers, Evil Liches, Undeath, Undead",
            "Velsharoon (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_WAUKEEN, "Waukeen", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DOMAIN_KNOWLEDGE,
            DOMAIN_PROTECTION, DOMAIN_TRADE, DOMAIN_TRAVEL, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
            WEAPON_TYPE_NUNCHAKU, DEITY_PANTHEON_FAERUNIAN, "Trade, Money, Wealth",
            "Waukeen (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");
  ...
  add_deity(DEITY_BERRONAR_TRUESILVER, "Berronar Truesilver", ETHOS_LAWFUL, ALIGNMENT_GOOD,
            DOMAIN_DWARF, DOMAIN_FAMILY, DOMAIN_GOOD, DOMAIN_HEALING, DOMAIN_LAW, DOMAIN_PROTECTION,
            WEAPON_TYPE_HEAVY_MACE, DEITY_PANTHEON_FR_DWARVEN,
            "Safety, Honesty, Home, Healing, The Dwarven Family, Records, Marriage, Faithfulness, "
            "Loyalty, Oaths",
            "Berronar Truesilver (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_ABBATHOR, "Abbathor", ETHOS_NEUTRAL, ALIGNMENT_EVIL, DOMAIN_DWARF, DOMAIN_LUCK,
            DOMAIN_TRADE, DOMAIN_TRICKERY, DOMAIN_EVIL, DOMAIN_UNDEFINED, WEAPON_TYPE_DAGGER,
            DEITY_PANTHEON_FR_DWARVEN, "Greed",
            "Abbathor (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_CLANGEDDIN_SILVERBEARD, "Clangeddin Silverbeard", ETHOS_LAWFUL, ALIGNMENT_GOOD,
            DOMAIN_DWARF, DOMAIN_STRENGTH, DOMAIN_GOOD, DOMAIN_WAR, DOMAIN_LAW, DOMAIN_UNDEFINED,
            WEAPON_TYPE_BATTLE_AXE, DEITY_PANTHEON_FR_DWARVEN,
            "Battle, War, Bravery, Honor in Battle",
            "Clangeddin Silverbeard (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_DEEP_DUERRA, "Deep Duerra", ETHOS_LAWFUL, ALIGNMENT_EVIL, DOMAIN_DWARF,
            DOMAIN_EVIL, DOMAIN_MENTALISM, DOMAIN_WAR, DOMAIN_LAW, DOMAIN_UNDEFINED,
            WEAPON_TYPE_BATTLE_AXE, DEITY_PANTHEON_FR_DWARVEN, "Psionics, COnquest, Expansion",
            "Deep Duerra (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_DUGMAREN_BRIGHTMANTLE, "Dugmaren Brightmantle", ETHOS_CHAOTIC, ALIGNMENT_GOOD,
            DOMAIN_DWARF, DOMAIN_CRAFT, DOMAIN_GOOD, DOMAIN_WAR, DOMAIN_KNOWLEDGE, DOMAIN_RUNE,
            WEAPON_TYPE_SHORT_SWORD, DEITY_PANTHEON_FR_DWARVEN, "Scholarship, Invention, Discovery",
            "Dugmaren Brightmantle (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_DUMATHOIN, "Dumathoin", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DOMAIN_DWARF,
            DOMAIN_CAVERN, DOMAIN_CRAFT, DOMAIN_EARTH, DOMAIN_KNOWLEDGE, DOMAIN_PROTECTION,
            WEAPON_TYPE_GREAT_CLUB, DEITY_PANTHEON_FR_DWARVEN,
            "Buried Wealth, Ores, Gems, Mining, Exploration, Shield Dwarves, Guardian of the Dead",
            "Dumathoin (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_GORM_GULTHYN, "Gorm Gulthyn", ETHOS_LAWFUL, ALIGNMENT_GOOD, DOMAIN_DWARF,
            DOMAIN_PROTECTION, DOMAIN_GOOD, DOMAIN_WAR, DOMAIN_LAW, DOMAIN_UNDEFINED,
            WEAPON_TYPE_BATTLE_AXE, DEITY_PANTHEON_FR_DWARVEN,
            "Guardian of all Dwarves, Defense, Watchfulness",
            "Gorm Gulthyn (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_HAELA_BRIGHTAXE, "Haela Brightaxe", ETHOS_CHAOTIC, ALIGNMENT_GOOD, DOMAIN_DWARF,
            DOMAIN_LUCK, DOMAIN_GOOD, DOMAIN_WAR, DOMAIN_CHAOS, DOMAIN_UNDEFINED,
            WEAPON_TYPE_GREAT_SWORD, DEITY_PANTHEON_FR_DWARVEN,
            "Luck in Battle, Joy of Battle, Dwarven Fighters",
            "Haela Brightaxe (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_LADUGUER, "Laduguer", ETHOS_LAWFUL, ALIGNMENT_EVIL, DOMAIN_DWARF, DOMAIN_CRAFT,
            DOMAIN_EVIL, DOMAIN_WAR, DOMAIN_LAW, DOMAIN_PROTECTION, WEAPON_TYPE_WARHAMMER,
            DEITY_PANTHEON_FR_DWARVEN, "Magic Weapon Creation, Artisans, Duergar, Magic",
            "Laduguer (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_MARTHAMMOR_DUIN, "Marthammor Duin", ETHOS_NEUTRAL, ALIGNMENT_GOOD, DOMAIN_DWARF,
            DOMAIN_PROTECTION, DOMAIN_GOOD, DOMAIN_TRAVEL, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
            WEAPON_TYPE_HEAVY_MACE, DEITY_PANTHEON_FR_DWARVEN,
            "Guides, Explorers, Expatriates, Travelers, Lightning",
            "Marthammor Duin (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_SHARINDLAR, "Sharindlar", ETHOS_CHAOTIC, ALIGNMENT_GOOD, DOMAIN_DWARF,
            DOMAIN_CHARM, DOMAIN_GOOD, DOMAIN_HEALING, DOMAIN_CHAOS, DOMAIN_MOON, WEAPON_TYPE_WHIP,
            DEITY_PANTHEON_FR_DWARVEN,
            "Healing, Mercy, Romantic Love, Fertility, Dancing, Courtship, the Moon",
            "Sharindlar (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_THARD_HARR, "Thard Harr", ETHOS_CHAOTIC, ALIGNMENT_GOOD, DOMAIN_DWARF,
            DOMAIN_ANIMAL, DOMAIN_GOOD, DOMAIN_PLANT, DOMAIN_CHAOS, DOMAIN_UNDEFINED,
            WEAPON_TYPE_UNARMED, DEITY_PANTHEON_FR_DWARVEN,
            "Wild Dwarves, Jungle Survival, Hunting",
            "Thard Harr (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(
      DEITY_VERGADAIN, "Vergadain", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DOMAIN_DWARF, DOMAIN_LUCK,
      DOMAIN_TRADE, DOMAIN_TRICKERY, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_LONG_SWORD,
      DEITY_PANTHEON_FR_DWARVEN,
      "Wealth, Luck, Chance, Non-Evil Thieves, Suspicion, Trickery, Negotiations, Sly Cleverness",
      "Vergadain (Description not done yet.  If you wish to write it, email to "
      "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_MORADIN, "Moradin", ETHOS_LAWFUL, ALIGNMENT_GOOD, DOMAIN_CRAFT, DOMAIN_DWARF,
            DOMAIN_EARTH, DOMAIN_GOOD, DOMAIN_LAW, DOMAIN_PROTECTION, WEAPON_TYPE_WARHAMMER,
            DEITY_PANTHEON_FR_DWARVEN, "Dwarves, Creation, Smithing, Metalcraft, Stonework",
            "\r\n"
  ...
  add_deity(DEITY_AERDRIE_FAENYA, "Aerdrie Faenya", ETHOS_CHAOTIC, ALIGNMENT_GOOD, DOMAIN_ELF,
            DOMAIN_ANIMAL, DOMAIN_GOOD, DOMAIN_AIR, DOMAIN_CHAOS, DOMAIN_STORM,
            WEAPON_TYPE_QUARTERSTAFF, DEITY_PANTHEON_FR_ELVEN,
            "Air, Weather, Avians, Rain, Fertility, Avariels",
            "Aerdrie Faenya (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_ANGHARRADH, "Angharradh", ETHOS_CHAOTIC, ALIGNMENT_GOOD, DOMAIN_ELF,
            DOMAIN_KNOWLEDGE, DOMAIN_GOOD, DOMAIN_PLANT, DOMAIN_CHAOS, DOMAIN_RENEWAL,
            WEAPON_TYPE_SPEAR, DEITY_PANTHEON_FR_ELVEN,
            "Spring, Fertility, Planting, Birth, Defense, Wisdom",
            "Angharradh (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_CORELLON_LARETHIAN, "Corellon Larethian", ETHOS_CHAOTIC, ALIGNMENT_GOOD,
            DOMAIN_ELF, DOMAIN_MAGIC, DOMAIN_GOOD, DOMAIN_PROTECTION, DOMAIN_CHAOS, DOMAIN_WAR,
            WEAPON_TYPE_LONG_SWORD, DEITY_PANTHEON_FR_ELVEN,
            "Magic, Music, Arts, Crafts, War, The Elven Race, Sun Elves, Poetry, Bards, Warriors",
            "Corellon Larethian (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_DEEP_SASHELAS, "Deep Sashelas", ETHOS_CHAOTIC, ALIGNMENT_GOOD, DOMAIN_ELF,
            DOMAIN_KNOWLEDGE, DOMAIN_GOOD, DOMAIN_OCEAN, DOMAIN_CHAOS, DOMAIN_WATER,
            WEAPON_TYPE_TRIDENT, DEITY_PANTHEON_FR_ELVEN, "Oceans, Sea Elves, Creation, Knowledge",
            "Deep Sashelas (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_EREVAN_ILESERE, "Erevan Ilesere", ETHOS_CHAOTIC, ALIGNMENT_NEUTRAL, DOMAIN_ELF,
            DOMAIN_LUCK, DOMAIN_TRICKERY, DOMAIN_CHAOS, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
            WEAPON_TYPE_SHORT_SWORD, DEITY_PANTHEON_FR_ELVEN, "Mischief, Change, Rogues",
            "Erevan Ilesere (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_FENMAREL_MESTARINE, "Fenmarel Mestarine", ETHOS_CHAOTIC, ALIGNMENT_NEUTRAL,
            DOMAIN_ELF, DOMAIN_ANIMAL, DOMAIN_PLANT, DOMAIN_TRAVEL, DOMAIN_CHAOS, DOMAIN_UNDEFINED,
            WEAPON_TYPE_DAGGER, DEITY_PANTHEON_FR_ELVEN,
            "Feral Elves, Outcasts, Scapegoats, Isolation",
            "Fenmarel Mestarine (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_HANALI_CELANIL, "Hanali Celanil", ETHOS_CHAOTIC, ALIGNMENT_GOOD, DOMAIN_ELF,
            DOMAIN_CHARM, DOMAIN_GOOD, DOMAIN_MAGIC, DOMAIN_CHAOS, DOMAIN_PROTECTION,
            WEAPON_TYPE_DAGGER, DEITY_PANTHEON_FR_ELVEN,
            "Love, Romance, Beauty, Enchantment, Magic Item Artistry, Fine Art, Artists",
            "Hanali Celanil (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_LABELAS_ENORETH, "Labelas Enoreth", ETHOS_CHAOTIC, ALIGNMENT_GOOD, DOMAIN_ELF,
            DOMAIN_KNOWLEDGE, DOMAIN_GOOD, DOMAIN_TIME, DOMAIN_CHAOS, DOMAIN_UNDEFINED,
            WEAPON_TYPE_QUARTERSTAFF, DEITY_PANTHEON_FR_ELVEN,
            "Time, Longevity, The Moment of Choice, History",
            "Labelas Enoreth (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_RILLIFANE_RALLATHIL, "Rillifane Rallathil", ETHOS_CHAOTIC, ALIGNMENT_GOOD,
            DOMAIN_ELF, DOMAIN_PLANT, DOMAIN_GOOD, DOMAIN_PROTECTION, DOMAIN_CHAOS,
            DOMAIN_UNDEFINED, WEAPON_TYPE_QUARTERSTAFF, DEITY_PANTHEON_FR_ELVEN,
            "Woodlands, Nature, Wild Elves, Druids",
            "Rillifane Rallathil (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(
      DEITY_SEHANINE_MOONBOW, "Sehanine Moonbow", ETHOS_CHAOTIC, ALIGNMENT_GOOD, DOMAIN_ELF,
      DOMAIN_KNOWLEDGE, DOMAIN_GOOD, DOMAIN_ILLUSION, DOMAIN_CHAOS, DOMAIN_MOON,
      WEAPON_TYPE_QUARTERSTAFF, DEITY_PANTHEON_FR_ELVEN,
      "Mysticism, Dreams, Death, Journeys, Transcendence, the moon, stars && heavens, Moon Elves",
      "Sehanine Moonbow (Description not done yet.  If you wish to write it, email to "
      "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_SHEVARASH, "Shevarash", ETHOS_CHAOTIC, ALIGNMENT_NEUTRAL, DOMAIN_ELF,
            DOMAIN_RETRIBUTION, DOMAIN_WAR, DOMAIN_CHAOS, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
            WEAPON_TYPE_COMPOSITE_LONGBOW, DEITY_PANTHEON_FR_ELVEN,
            "Hatred of the Drow, Vengeance, Crusades, Loss",
            "Shevarash (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_SOLONOR_THELANDIRA, "Solonor Thelandira", ETHOS_CHAOTIC, ALIGNMENT_GOOD,
            DOMAIN_ELF, DOMAIN_PLANT, DOMAIN_GOOD, DOMAIN_WAR, DOMAIN_CHAOS, DOMAIN_UNDEFINED,
            WEAPON_TYPE_COMPOSITE_LONGBOW, DEITY_PANTHEON_FR_ELVEN,
            "Archery, Hunting, Wilderness Survival",
            "Solonor Thelandira (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  // Gnome Pantheon

  add_deity(DEITY_BAERVAN_WILDWANDERER, "Baervan Wildwanderer", ETHOS_NEUTRAL, ALIGNMENT_GOOD,
            DOMAIN_GNOME, DOMAIN_PLANT, DOMAIN_GOOD, DOMAIN_ANIMAL, DOMAIN_TRAVEL, DOMAIN_UNDEFINED,
            WEAPON_TYPE_SHORTSPEAR, DEITY_PANTHEON_FR_GNOME, "Forests, Travel, Nature",
            "Baervan Wildwanderer (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_BARAVAR_CLOAKSHADOW, "Baravar Cloakshadow", ETHOS_NEUTRAL, ALIGNMENT_GOOD,
            DOMAIN_GNOME, DOMAIN_PROTECTION, DOMAIN_GOOD, DOMAIN_TRICKERY, DOMAIN_ILLUSION,
            DOMAIN_UNDEFINED, WEAPON_TYPE_DAGGER, DEITY_PANTHEON_FR_GNOME,
            "Illusions, Deception, Traps, Wards",
            "Daravar Cloakshadow (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_CALLARDURAN_SMOOTHHANDS, "Callarduran Smoothhands", ETHOS_NEUTRAL,
            ALIGNMENT_NEUTRAL, DOMAIN_GNOME, DOMAIN_CAVERN, DOMAIN_CRAFT, DOMAIN_EARTH,
            DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_BATTLE_AXE, DEITY_PANTHEON_FR_GNOME,
            "Stone, The Underdark, Mining, Svirfneblin",
            "Callarduran Smoothhands (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_FLANDAL_STEELSKIN, "Flandal Steelskin", ETHOS_NEUTRAL, ALIGNMENT_GOOD,
            DOMAIN_GNOME, DOMAIN_CRAFT, DOMAIN_GOOD, DOMAIN_METAL, DOMAIN_UNDEFINED,
            DOMAIN_UNDEFINED, WEAPON_TYPE_WARHAMMER, DEITY_PANTHEON_FR_GNOME,
            "Mining, Physical Fitness, Smithing, Metalworking",
            "Flandal Steelskin (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_GAERDAL_IRONHAND, "Gaerdal Ironhand", ETHOS_LAWFUL, ALIGNMENT_GOOD, DOMAIN_GNOME,
            DOMAIN_PROTECTION, DOMAIN_GOOD, DOMAIN_WAR, DOMAIN_LAW, DOMAIN_UNDEFINED,
            WEAPON_TYPE_WARHAMMER, DEITY_PANTHEON_FR_GNOME, "Vigilance, Combat, Martial Defense",
            "Gaerdal Ironhand (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_GARL_GLITTERGOLD, "Garl Glittergold", ETHOS_LAWFUL, ALIGNMENT_GOOD, DOMAIN_GNOME,
            DOMAIN_CRAFT, DOMAIN_GOOD, DOMAIN_PROTECTION, DOMAIN_LAW, DOMAIN_TRICKERY,
            WEAPON_TYPE_BATTLE_AXE, DEITY_PANTHEON_FR_GNOME,
            "Protection, Humor, Gem-Cutting, Trickery, Gnomes",
            "Garl Glittergold (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_SEGOJAN_EARTHCALLER, "Segojan Earthcaller", ETHOS_NEUTRAL, ALIGNMENT_GOOD,
            DOMAIN_GNOME, DOMAIN_CAVERN, DOMAIN_GOOD, DOMAIN_EARTH, DOMAIN_UNDEFINED,
            DOMAIN_UNDEFINED, WEAPON_TYPE_HEAVY_MACE, DEITY_PANTHEON_FR_GNOME,
            "Earth, Nature, the Dead",
            "Segojan Earthcaller (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_URDLEN, "Urdlen", ETHOS_CHAOTIC, ALIGNMENT_EVIL, DOMAIN_GNOME, DOMAIN_CHAOS,
            DOMAIN_EVIL, DOMAIN_EARTH, DOMAIN_HATRED, DOMAIN_UNDEFINED, WEAPON_TYPE_UNARMED,
            DEITY_PANTHEON_FR_GNOME,
            "Greed, Bloodlust, Evil, Hatred, Spriggans, Uncontrolled Impulse",
            "Urdlen (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");


  // Halfing Pantheon

  add_deity(DEITY_ARVOREEN, "Arvoreen", ETHOS_LAWFUL, ALIGNMENT_GOOD, DOMAIN_HALFLING, DOMAIN_LAW,
            DOMAIN_GOOD, DOMAIN_PROTECTION, DOMAIN_WAR, DOMAIN_UNDEFINED, WEAPON_TYPE_SHORT_SWORD,
            DEITY_PANTHEON_FR_HALFLING, "Defense, War, Vigilence, Halfling Warriors, Duty",
            "Arvoreen (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_BRANDOBARIS, "Brandobaris", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DOMAIN_HALFLING,
            DOMAIN_LUCK, DOMAIN_TRAVEL, DOMAIN_TRICKERY, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
            WEAPON_TYPE_DAGGER, DEITY_PANTHEON_FR_HALFLING,
            "Stealth, Thievery, Adventuring, Halfling Rogues",
            "Brandobaris (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_CYRROLLALEE, "Cyrrollalee", ETHOS_LAWFUL, ALIGNMENT_GOOD, DOMAIN_HALFLING,
            DOMAIN_LAW, DOMAIN_GOOD, DOMAIN_FAMILY, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
            WEAPON_TYPE_QUARTERSTAFF, DEITY_PANTHEON_FR_HALFLING,
            "Friendship, Trust, the Hearth, Hospitality, Crafts",
            "Cyrrollalee (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_SHEELA_PERYROYL, "Sheela Peryroyl", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL,
            DOMAIN_HALFLING, DOMAIN_AIR, DOMAIN_CHARM, DOMAIN_PLANT, DOMAIN_UNDEFINED,
            DOMAIN_UNDEFINED, WEAPON_TYPE_SICKLE, DEITY_PANTHEON_FR_HALFLING,
            "Nature, Agriculture, Weather, Song, Dance, Beauty, Romantic Love",
            "Sheela Peryroyl (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_UROGALAN, "Urogalan", ETHOS_LAWFUL, ALIGNMENT_NEUTRAL, DOMAIN_HALFLING,
            DOMAIN_LAW, DOMAIN_DEATH, DOMAIN_PROTECTION, DOMAIN_EARTH, DOMAIN_UNDEFINED,
            WEAPON_TYPE_DIRE_FLAIL, DEITY_PANTHEON_FR_HALFLING,
            "Earth, Death, Protection of the Dead",
            "Urogalan (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_YONDALLA, "Yondalla", ETHOS_LAWFUL, ALIGNMENT_GOOD, DOMAIN_HALFLING, DOMAIN_LAW,
            DOMAIN_GOOD, DOMAIN_PROTECTION, DOMAIN_FAMILY, DOMAIN_UNDEFINED,
            WEAPON_TYPE_SHORT_SWORD, DEITY_PANTHEON_FR_HALFLING,
            "Protection, Bounty, Halflings, Children, Security, Leadership, Wisdom, Creation, "
            "Family, Tradition",
            "Yondalla (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  // Orc Pantheon

  add_deity(DEITY_BAHGTRU, "Bahgtru", ETHOS_CHAOTIC, ALIGNMENT_EVIL, DOMAIN_ORC, DOMAIN_CHAOS,
            DOMAIN_EVIL, DOMAIN_STRENGTH, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_UNARMED,
            DEITY_PANTHEON_FR_ORC, "Loyalty, Stupidity, Brute Strength",
            "Bahgtru (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_GRUUMSH, "Gruumsh", ETHOS_CHAOTIC, ALIGNMENT_EVIL, DOMAIN_ORC, DOMAIN_CHAOS,
            DOMAIN_EVIL, DOMAIN_STRENGTH, DOMAIN_HATRED, DOMAIN_WAR, WEAPON_TYPE_SPEAR,
            DEITY_PANTHEON_FR_ORC, "Orcs, COnquest, Survival, Strength, Territory",
            "Gruumsh (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_ILNEVAL, "Ilneval", ETHOS_NEUTRAL, ALIGNMENT_EVIL, DOMAIN_ORC, DOMAIN_WAR,
            DOMAIN_EVIL, DOMAIN_DESTRUCTION, DOMAIN_PLANNING, DOMAIN_UNDEFINED,
            WEAPON_TYPE_LONG_SWORD, DEITY_PANTHEON_FR_ORC,
            "War, Combat, Overwhelming Numbers, Strategy",
            "Ilneval (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_LUTHIC, "Luthic", ETHOS_NEUTRAL, ALIGNMENT_EVIL, DOMAIN_ORC, DOMAIN_CAVERN,
            DOMAIN_EVIL, DOMAIN_EARTH, DOMAIN_FAMILY, DOMAIN_HEALING, WEAPON_TYPE_UNARMED,
            DEITY_PANTHEON_FR_ORC,
            "Caves, Orc Females, Home, Wisdom, Fertility, Healing, Servitude",
            "Luthic (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_SHARGAAS, "Shargaas", ETHOS_CHAOTIC, ALIGNMENT_EVIL, DOMAIN_ORC, DOMAIN_CHAOS,
            DOMAIN_EVIL, DOMAIN_DARKNESS, DOMAIN_TRICKERY, DOMAIN_UNDEFINED,
            WEAPON_TYPE_SHORT_SWORD, DEITY_PANTHEON_FR_ORC,
            "Night, Thieves, Stealth, Darkness, The Underdark",
            "Shargaas (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_YURTRUS, "Yurtrus", ETHOS_NEUTRAL, ALIGNMENT_EVIL, DOMAIN_ORC, DOMAIN_DEATH,
            DOMAIN_EVIL, DOMAIN_DESTRUCTION, DOMAIN_SUFFERING, DOMAIN_UNDEFINED,
            WEAPON_TYPE_UNARMED, DEITY_PANTHEON_FR_ORC, "Death, Disease",
            "Yurtrus (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  // Drow Pantheon

  add_deity(DEITY_LOLTH, "Lolth", ETHOS_CHAOTIC, ALIGNMENT_EVIL, DOMAIN_CHAOS, DOMAIN_DARKNESS,
            DOMAIN_DESTRUCTION, DOMAIN_DROW, DOMAIN_EVIL, DOMAIN_SPIDER, WEAPON_TYPE_DAGGER,
            DEITY_PANTHEON_FR_DROW, "Spiders, Evil, Darkness, Chaos, Assassins, Drow",
            "Lolth (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_GHAUNADAUR, "Ghaunadaur", ETHOS_CHAOTIC, ALIGNMENT_EVIL, DOMAIN_CAVERN,
            DOMAIN_CHAOS, DOMAIN_DROW, DOMAIN_HATRED, DOMAIN_EVIL, DOMAIN_SLIME,
            WEAPON_TYPE_WARHAMMER, DEITY_PANTHEON_FR_DROW,
            "Oozes, Slimes, Jellies, Outcasts, Ropers, Rebels",
            "Ghaunadaur (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_KIARANSALEE, "Kiaransalee", ETHOS_CHAOTIC, ALIGNMENT_EVIL, DOMAIN_UNDEATH,
            DOMAIN_CHAOS, DOMAIN_DROW, DOMAIN_RETRIBUTION, DOMAIN_EVIL, DOMAIN_UNDEFINED,
            WEAPON_TYPE_DAGGER, DEITY_PANTHEON_FR_DROW, "Undead, Vengeance",
            "Kiaransalee (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_SELVETARM, "Selvetarm", ETHOS_CHAOTIC, ALIGNMENT_EVIL, DOMAIN_WAR, DOMAIN_CHAOS,
            DOMAIN_DROW, DOMAIN_SPIDER, DOMAIN_EVIL, DOMAIN_UNDEFINED, WEAPON_TYPE_HEAVY_MACE,
            DEITY_PANTHEON_FR_DROW, "Drow Warriors",
            "Selvetarm (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(DEITY_VHAERAUN, "Vhaeraun", ETHOS_CHAOTIC, ALIGNMENT_EVIL, DOMAIN_TRAVEL, DOMAIN_CHAOS,
            DOMAIN_DROW, DOMAIN_TRICKERY, DOMAIN_EVIL, DOMAIN_UNDEFINED, WEAPON_TYPE_SHORT_SWORD,
            DEITY_PANTHEON_FR_DROW, "Thievery, Drow Males, Evil Activity on the Surface",
            "Vhaeraun (Description not done yet.  If you wish to write it, email to "
            "ilmater@@gmail.com)\r\n");

  add_deity(
      DEITY_EILISTRAEE, "Eilistraee", ETHOS_CHAOTIC, ALIGNMENT_GOOD, DOMAIN_CHAOS, DOMAIN_CHARM,
      DOMAIN_DROW, DOMAIN_ELF, DOMAIN_GOOD, DOMAIN_MOON, WEAPON_TYPE_BASTARD_SWORD,
      DEITY_PANTHEON_FR_DROW, "Song, Beauty, Dance, Swordwork, Hunting, Moonlight",
  ...
  add_deity(
      DEITY_PALADINE, "Paladine", ETHOS_LAWFUL, ALIGNMENT_GOOD, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      WEAPON_TYPE_LONG_SWORD, DEITY_PANTHEON_ALL, "Good Dragons, Guardians, Rulers",
      ...
      "\r\n");
  add_deity(
      DEITY_MISHAKAL, "Mishakal", ETHOS_LAWFUL, ALIGNMENT_GOOD, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      WEAPON_TYPE_QUARTERSTAFF, DEITY_PANTHEON_ALL, "Healing",
      ...
      "\r\n");
  add_deity(
      DEITY_KIRI_JOLITH, "Kiri-Jolith", ETHOS_LAWFUL, ALIGNMENT_GOOD, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      WEAPON_TYPE_GREAT_SWORD, DEITY_PANTHEON_ALL, "Honor, War",
      ...
      "most-worshipped god by the minotaurs, who also call him \"Emperor\". He is closest to Reorx "
      "and\r\n"
      ...
      "\r\n");
  add_deity(
      DEITY_HABBAKUK, "Habbakuk", ETHOS_NEUTRAL, ALIGNMENT_GOOD, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_SCIMITAR,
      DEITY_PANTHEON_ALL, "Animal Life, Natural Balance",
      ...
      "\r\n");
  add_deity(
      DEITY_MAJERE, "Majere", ETHOS_LAWFUL, ALIGNMENT_GOOD, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_UNARMED,
      DEITY_PANTHEON_ALL, "Meditation, Order",
      "Majere, also known as Mantis of the Rose, Master of Mind, and the\r\n"
      "Dreamsender,The Even-Handed God, represents the godly force of discipline. He believes the "
      "way\r\n"
      ...
      "\r\n");
  add_deity(
      DEITY_BRANCHALA, "Branchala", ETHOS_NEUTRAL, ALIGNMENT_GOOD, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      WEAPON_TYPE_RAPIER, DEITY_PANTHEON_ALL, "Music",
      "Branchala, also known as The Bard King, the Song of Life, and the Songmaster,\r\n"
      "represents the godly power of inspiration. He encourages souls to rise to greater "
      "heights\r\n"
      ...
      "\r\n");
  add_deity(
      DEITY_SOLINARI, "Solinari", ETHOS_LAWFUL, ALIGNMENT_GOOD, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_DAGGER,
      DEITY_PANTHEON_ALL, "Good Magic",
      "Solinari, also known as the Mighty Hand, the Ivory Disk, and God's Eye,\r\n"
      "represents the godly power of magic used for good. He patrons wizards who use their "
      "magic\r\n"
  ...
  add_deity(
      DEITY_GILEAN, "Gilean", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_DAGGER,
      DEITY_PANTHEON_ALL, "Knowledge",
      ...
      "\r\n");
  add_deity(
      DEITY_ZIVILYN, "Zivilyn", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      WEAPON_TYPE_QUARTERSTAFF, DEITY_PANTHEON_ALL, "Wisdom",
      ...
      "\r\n");
  add_deity(
      DEITY_REORX, "Reorx", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_WARHAMMER,
      DEITY_PANTHEON_ALL, "Craft",
      "Reorx, also known as the Forge, the World Smith, and Tamer of Chaos,\r\n"
      "represents the godly force of creation. He desires for souls to grow through crafting "
      "and\r\n"
      ...
      "\r\n");
  add_deity(
      DEITY_CHISLEV, "Chislev", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      WEAPON_TYPE_SICKLE, DEITY_PANTHEON_ALL, "Nature",
      ...
      "\r\n");
  add_deity(
      DEITY_SHINARE, "Shinare", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      WEAPON_TYPE_LIGHT_HAMMER, DEITY_PANTHEON_ALL, "Travel, Wealth",
      ...
      "communicating with other people. She oversees all oaths, negotiations, and partnerships. "
      "She\r\n"
      ...
      "\r\n");
  add_deity(
      DEITY_SIRRION, "Sirrion", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      WEAPON_TYPE_SPIKED_CHAIN, DEITY_PANTHEON_ALL, "Change, Fire",
      ...
      "\r\n");
  add_deity(
      DEITY_LUNITARI, "Lunitari", ETHOS_NEUTRAL, ALIGNMENT_NEUTRAL, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      WEAPON_TYPE_DAGGER, DEITY_PANTHEON_ALL, "Neutral Magic",
  ...
  add_deity(
      DEITY_TAKHISIS, "Takhisis", ETHOS_LAWFUL, ALIGNMENT_EVIL, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      WEAPON_TYPE_HEAVY_MACE, DEITY_PANTHEON_ALL, "Evil Dragons, Hatred, Night",
      ...
      "\r\n");
  add_deity(
      DEITY_SARGONNAS, "Sargonnas", ETHOS_LAWFUL, ALIGNMENT_EVIL, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      WEAPON_TYPE_BATTLE_AXE, DEITY_PANTHEON_ALL, "Fire, Vengeance",
      ...
      "\r\n");
  add_deity(
      DEITY_CHEMOSH, "Chemosh", ETHOS_LAWFUL, ALIGNMENT_EVIL, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_SCYTHE,
      DEITY_PANTHEON_ALL, "Undead",
      ...
      "\r\n");
  add_deity(
      DEITY_HIDDUKEL, "Hiddukel", ETHOS_CHAOTIC, ALIGNMENT_EVIL, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_DAGGER,
      DEITY_PANTHEON_ALL, "Greed, Lies",
      ...
      "\r\n");
  add_deity(
      DEITY_MORGION, "Morgion", ETHOS_NEUTRAL, ALIGNMENT_EVIL, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_FLAIL,
      DEITY_PANTHEON_ALL, "Disease, Secrecy",
      ...
      "complexities to attain their most basic form. He believes mortals should leave Krynn "
      "with\r\n"
      ...
      "\r\n");
  add_deity(
      DEITY_ZEBOIM, "Zeboim", ETHOS_CHAOTIC, ALIGNMENT_EVIL, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_TRIDENT,
      DEITY_PANTHEON_ALL, "Sea, Storms",
      ...
      "\r\n");
  add_deity(
      DEITY_NUITARI, "Nuitari", ETHOS_LAWFUL, ALIGNMENT_EVIL, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED,
      DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, DOMAIN_UNDEFINED, WEAPON_TYPE_DAGGER,
      DEITY_PANTHEON_ALL, "Evil Magic",
...
#else /* LUMINARI ORIGINAL DEITIES */
  /* ============================================================================
 * LUMINARI ORIGINAL DEITY LOADING
 * These deities are loaded when neither CAMPAIGN_FR nor CAMPAIGN_DL is defined
 * ============================================================================ */
...
#endif /* End of campaign-specific deity loading */
