...
#define HAS_MATERIAL(ch, cat, sub, qual, min) (GET_MATERIAL(ch, cat, sub, qual) >= (min))
...
void add_harvested_material(struct char_data *ch, int category, int subtype, int quality,
                            int amount);
int get_material_count(struct char_data *ch, int category, int subtype, int quality);
bool has_material_requirement(struct char_data *ch, int category, int subtype, int min_quality,
                              int amount);
void remove_material_requirement(struct char_data *ch, int category, int subtype, int min_quality,
                                 int amount);
