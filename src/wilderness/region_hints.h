...
/* Context building */
void build_description_context(room_rnum room, struct char_data *ch,
                               struct description_context *context);

/* Hint selection and filtering */
struct region_hint *select_relevant_hints(struct region_hint *all_hints,
                                          struct description_context *context, int max_hints);
...
char *combine_base_with_hints(char *base_description, struct region_hint *selected_hints,
                              struct description_context *context);
