...
#define MOBILE_WORK_RECURRING_MASK                                                                 \
  (MOBILE_WORK_SPEC_ACTIVITY | MOBILE_WORK_ECHO | MOBILE_WORK_SCAVENGE | MOBILE_WORK_PATROL |      \
   MOBILE_WORK_HUNT | MOBILE_WORK_WANDER | MOBILE_WORK_POSTURE | MOBILE_WORK_RESOURCE_RECOVERY)
