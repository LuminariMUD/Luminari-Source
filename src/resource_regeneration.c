...
float get_base_regeneration_rate(int resource_type)
{
  ...
  case RESOURCE_VEGETATION:
    return BASE_REGEN_VEGETATION;
  case RESOURCE_HERBS:
    return BASE_REGEN_HERBS;
  case RESOURCE_WATER:
    return BASE_REGEN_WATER;
  case RESOURCE_GAME:
    return BASE_REGEN_GAME;
  case RESOURCE_WOOD:
    return BASE_REGEN_WOOD;
  case RESOURCE_CLAY:
    return BASE_REGEN_CLAY;
  case RESOURCE_STONE:
    return BASE_REGEN_STONE;
  case RESOURCE_MINERALS:
    return BASE_REGEN_MINERALS;
  case RESOURCE_CRYSTAL:
    return BASE_REGEN_CRYSTAL;
  case RESOURCE_SALT:
    return BASE_REGEN_SALT;
  default:
    return 0.03; /* Default 3% per hour */
  }
}
