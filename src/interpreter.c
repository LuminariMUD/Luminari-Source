...
cpp_extern const struct command_info cmd_info[] = {
    ...
    {"activity", "activity", POS_DEAD, do_activity, 0, 0, TRUE, ACTION_NONE, {0, 0}, NULL,
    ...
    {"eventdebug", "eventdebug", POS_DEAD, do_eventdebug, LVL_IMMORT, 0, TRUE, ACTION_NONE, {0, 0},
     NULL, CMD_FEATURE_ACTIVITY_INFORMATION},
    {"evobreath",
     "evobreath",
     POS_FIGHTING,
     do_evobreath,
    ...
    {"initiative", "initiative", POS_DEAD, do_initiative, 0, 0, TRUE, ACTION_NONE, {0, 0}, NULL,
     CMD_FEATURE_ACTIVITY_INFORMATION},
