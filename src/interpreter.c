...
// {"resize", "resize", POS_STANDING, do_not_here, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
    ...
    {"vedit", "vedit", POS_DEAD, do_vedit, LVL_BUILDER, 0, TRUE, ACTION_NONE, {0, 0}, NULL},
    ...
    {"shipfire", "shipfire", POS_STANDING, do_shipfire, 1, 0, FALSE, ACTION_STANDARD, {6, 0}, NULL},
    {"shiprepair",
     "shiprepair",
     POS_STANDING,
     do_shiprepair,
     ...
     {6, 0},
     NULL},
    {"claimship", "claimship", POS_STANDING, do_claimship, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
    {"shippermit",
     "shippermit",
     POS_RESTING,
     do_shippermit,
    ...
    {"shiprevoke",
     ...
     {0, 0},
     NULL},
    {"shipcrew", "shipcrew", POS_RESTING, do_shipcrew, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
    {"shipdeed", "shipdeed", POS_RESTING, do_shipdeed, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
    {"shipbrowse",
     "shipbrowse",
     POS_RESTING,
     do_shipbrowse,
     ...
     {0, 0},
     NULL},
    {"shipbuy", "shipbuy", POS_STANDING, do_shipbuy, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
    {"shiphire", "shiphire", POS_RESTING, do_shiphire, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
    {"shipdismiss",
     "shipdismiss",
     POS_RESTING,
     do_shipdismiss,
     ...
     {0, 0},
     NULL},
    {"shipwages", "shipwages", POS_RESTING, do_shipwages, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
    {"shipupgrade",
     "shipupgrade",
     POS_RESTING,
     do_shipupgrade,
    ...
    {"shipinsure",
     ...
     {0, 0},
     NULL},
    {"market", "market", POS_RESTING, do_market, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
    {"contracts", "contracts", POS_RESTING, do_contracts, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
    {"plunder", "plunder", POS_STANDING, do_plunder, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
    {"bounty", "bounty", POS_RESTING, do_bounty, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
    {"seastate", "seastate", POS_RESTING, do_seastate, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
    ...
    {"marque", "marque", POS_RESTING, do_marque, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
    {"contractaccept",
     "contractaccept",
     POS_STANDING,
     do_contractaccept,
    ...
    {"contractabandon",
     ...
     {0, 0},
     NULL},
    {"cargobuy", "cargobuy", POS_STANDING, do_cargobuy, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
    {"cargosell", "cargosell", POS_STANDING, do_cargosell, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
    {"cargomanifest",
     "cargomanifest",
     POS_RESTING,
     do_cargomanifest,
...
void command_interpreter(struct char_data *ch, char *argument)
{
           ...
           !is_abbrev(complete_cmd_info[cmd].command, "tell"))
  {
    ...
    case POS_DEAD:
      ...
      mudlog(NRM, LVL_IMMORT, TRUE, "%s found in pos DEAD without die() function being called.",
             GET_NAME(ch));
      die(ch, ch);
      break;
    case POS_INCAP:
...
void show_character_rp_menu(struct descriptor_data *d)
{
  ...
  {
    draw_line(d->character, 80, '-', '-');
    text_line(d->character,
              "\twThese Can be done anytime. Only Short Descriptions are Required Immediately.\tc",
              80, '-', '-');
  }
  draw_line(d->character, 80, '-', '-');
  write_to_output(d, "\tn");
...
bool is_valid_paralyzed_command(char *command)
{
  if (!strcmp(command, "look") || !strcmp(command, "trip") || !strcmp(command, "group") ||
      ...
      !strcmp(command, "wearapplies") || !strcmp(command, "wearlocations") ||
      !strcmp(command, "cast") || !strcmp(command, "spells") || !strcmp(command, "spelllist") ||
      !strcmp(command, "memorize") || !strcmp(command, "prayer") || !strcmp(command, "commune") ||
      !strcmp(command, "chant") || !strcmp(command, "adjure") || !strcmp(command, "compose") ||
      !strcmp(command, "meditate") || !strcmp(command, "concoct") || !strcmp(command, "extracts") ||
      !strcmp(command, "manifest") || !strcmp(command, "powers") || !strcmp(command, "condemn") ||
      !strcmp(command, "compel") || !strcmp(command, "conjure")
