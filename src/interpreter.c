...
cpp_extern const struct command_info cmd_info[] = {
    ...
    {"calm", "calm", POS_FIGHTING, do_calm, 1, 0, FALSE, ACTION_STANDARD, {6, 0}, can_calm},
    {"camp",
     "camp",
     POS_STANDING,
     do_camp,
    ...
    /* Duris racial innates, spell-like abilities (racial_sla_table[] in act.other.c) */
    {"farsee",
     "farsee",
     POS_FIGHTING,
     do_racial_sla,
    ...
    {"summonhorde",
     ...
     {0, 0},
     NULL},
    /* Duris racial innates with their own commands */
    {"flurry", "flurry", POS_FIGHTING, do_racial_flurry, 1, 0, FALSE, ACTION_MOVE, {0, 0}, NULL},
    {"doorbash",
     "doorbash",
     POS_STANDING,
     do_doorbash,
    ...
    {"order", "ord", POS_RECLINING, do_order, 1, 0, FALSE, ACTION_SWIFT, {0, 0}, NULL},
    ...
    {"servant", "servant", POS_STANDING, do_servant, 1, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
    ...
    {"setworldsect",
     ...
     {0, 0},
     NULL},
    {"shadow", "shadow", POS_STANDING, do_shadow, 1, 0, FALSE, ACTION_MOVE, {0, 6}, can_shadow},
    {"shadowcast",
     "shc",
     POS_SITTING,
     do_gen_cast,
    ...
    {"stable", "stable", POS_STANDING, do_not_here, 0, 0, FALSE, ACTION_NONE, {0, 0}, NULL},
