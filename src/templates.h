...
#define LEVELINFO_SYNTAX                                                                           \
  ...
  "-- levelinfo\r\n"                                                                               \
  "----> This lists all of the levels you've done so far including the level id needed for other " \
  "levelinfo commands.\r\n"                                                                        \
  "-- levelinfo (level_id)\r\n"                                                                    \
  "----> This will display levelup info for the level_id specified.\r\n"                           \
  "-- levelinfo search (feat|skill|ability) (keyword(s))\r\n"                                      \
  "----> This will allow you to search your levels for the feat, skill, or ability score "         \
  "mentioned.\r\n"
