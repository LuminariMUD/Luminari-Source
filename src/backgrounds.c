...
int backgrounds_listed_alphabetically[NUM_BACKGROUNDS] = {
    BACKGROUND_NONE,        BACKGROUND_ACOLYTE,   BACKGROUND_CHARLATAN, BACKGROUND_CRIMINAL,
    BACKGROUND_ENTERTAINER, BACKGROUND_FOLK_HERO, BACKGROUND_GLADIATOR, BACKGROUND_HERMIT,
    BACKGROUND_NOBLE,       BACKGROUND_OUTLANDER, BACKGROUND_PIRATE,    BACKGROUND_SAGE,
...
void assign_backgrounds(void)
{
  ...
  backgroundo(
      BACKGROUND_ACOLYTE, "acolyte", ABILITY_SENSE_MOTIVE, ABILITY_RELIGION, FEAT_BG_ACOLYTE,
  ...
  backgroundo(BACKGROUND_CHARLATAN, "charlatan", ABILITY_SLEIGHT_OF_HAND, ABILITY_BLUFF,
              FEAT_BG_CHARLATAN,
              "You have always had a way with people. You know what makes them tick, you can tease "
              "out their "
              "hearts' desires after a few minutes of conversation, and with a few leading "
              "questions you can "
              "read them like they were children's books. It's a useful talent, and one that "
              "you're perfectly "
              "willing to use for your advantage. You know what people want and you deliver, or "
              "rather, you "
              "promise to deliver. Common sense should steer people away from things that sound "
              "too good to "
              "be true, but common sense seems to be in short supply when you're around. The "
              "bottle of pink-colored "
              "liquid will surely cure that unseemly rash, this ointment - nothing more than a bit "
              "of fat with a "
              "sprinkle of silver dust - can restore youth and vigor, and there's a bridge in the "
              "city that just "
              "happens to be for sale. These marvels sound implausible, but you make them sound "
              "like the real deal.");

  backgroundo(BACKGROUND_CRIMINAL, "criminal/spy", ABILITY_BLUFF, ABILITY_STEALTH, FEAT_BG_CRIMINAL,
              "You are an experienced criminal with a history of breaking the law. You have spent "
              "a lot of time "
              "among other criminals and still have contacts within the criminal underworld. "
              "You're far closer "
              "than most people to the world of murder, theft, and violence that pervades the "
              "underbelly of "
              "civilization, and you have survived up to this point by flouting the rules and "
              "regulations of society.");

  backgroundo(BACKGROUND_ENTERTAINER, "entertainer", ABILITY_ACROBATICS, ABILITY_PERFORM,
              FEAT_BG_ENTERTAINER,
              "You thrive in front of an audience. You know how to entrance them, entertain them, "
              "and even inspire them. "
              "Your poetics can stir the hearts of those who hear you, awakening grief or joy, "
              "laughter or anger. Your "
              "music raises their spirits or captures their sorrow. Your dance steps captivate, "
              "your humor cuts to the "
              "quick. Whatever techniques you use, your art is your life.");

  backgroundo(BACKGROUND_FOLK_HERO, "folk hero", ABILITY_HANDLE_ANIMAL, ABILITY_SURVIVAL,
              FEAT_BG_FOLK_HERO,
              "You come from a humble social rank, but you are destined for so much more. Already "
              "the people of your "
              "home village regard you as their champion, and your destiny calls you to stand "
              "against the tyrants and "
              "monsters that threaten the common folk everywhere.");

  backgroundo(BACKGROUND_GLADIATOR, "gladiator", ABILITY_ACROBATICS, ABILITY_PERFORM,
              FEAT_BG_GLADIATOR,
              "A gladiator is as much an entertainer as any minstrel or circus performer, trained "
              "to make the arts "
              "of combat into a spectacle the crowd can enjoy. This kind of flashy combat is your "
              "entertainer routine, "
  ...
  backgroundo(BACKGROUND_TRADER, "trader", ABILITY_SENSE_MOTIVE, ABILITY_DIPLOMACY, FEAT_BG_TRADER,
              "You are a member of an artisan's guild, skilled in a particular field and closely "
              "associated "
              "with other artisans. You are a well-established part of the mercantile world, freed "
              "by talent "
              "and wealth from the constraints of a feudal social order. You learned your skills "
              "as an apprentice "
              "to a master artisan, under the sponsorship of your guild, until you became a master "
              "in your own right.");
  ...
  backgroundo(BACKGROUND_HERMIT, "hermit", ABILITY_HEAL, ABILITY_RELIGION, FEAT_BG_HERMIT,
              ...
              "entirely alone-for "
              "a formative part of your life. In your time apart from the clamor of society, you "
              "found quiet, "
              "solitude, and perhaps some of the answers you were looking for.");

  backgroundo(
      BACKGROUND_SQUIRE, "squire", ABILITY_HISTORY, ABILITY_DIPLOMACY, FEAT_BG_SQUIRE,
  ...
  backgroundo(
      BACKGROUND_NOBLE, "noble", ABILITY_HISTORY, ABILITY_DIPLOMACY, FEAT_BG_NOBLE,
  ...
  backgroundo(
      BACKGROUND_OUTLANDER, "outlander", ABILITY_ATHLETICS, ABILITY_SURVIVAL, FEAT_BG_OUTLANDER,
      "You grew up in the wilds, far from the comforts of town and technology. You've witnessed "
      "the "
      ...
      "any direction. The wilds are in your blood, whether you were a nomad, an explorer, a "
      "recluse, "
      "a hunter-gatherer, or even a marauder. Even in places where you don't know the specific "
      "features "
      "of the terrain, you know the ways of the wild.");

  backgroundo(
      BACKGROUND_PIRATE, "pirate", ABILITY_ATHLETICS, ABILITY_PERCEPTION, FEAT_BG_PIRATE,
      "You sailed on a seagoing vessel for years. In that time, you faced down mighty storms, "
      "monsters "
      "of the deep, and those who wanted to sink your craft to the bottomless depths. Your first "
      "love is "
  ...
  backgroundo(BACKGROUND_SAGE, "sage", ABILITY_ARCANA, ABILITY_HISTORY, FEAT_BG_SAGE,
              ...
              "studied scrolls, "
              "and listened to the greatest experts on the subjects that interest you. Your "
              "efforts have made "
              "you a master in your fields of study.");

  backgroundo(
      BACKGROUND_SAILOR, "sailor", ABILITY_ATHLETICS, ABILITY_PERCEPTION, FEAT_BG_SAILOR,
      "You sailed on a seagoing vessel for years. In that time, you faced down mighty storms, "
      "monsters "
      "of the deep, and those who wanted to sink your craft to the bottomless depths. Your first "
      "love is "
  ...
  backgroundo(BACKGROUND_SOLDIER, "soldier", ABILITY_ATHLETICS, ABILITY_INTIMIDATE, FEAT_BG_SOLDIER,
              ...
              "studied the "
              "use of weapons and armor, learned basic survival techniques, including how to stay "
              "alive on the "
              "battlefield. You might have been part of a standing national army or a mercenary "
              "company, or "
  ...
  backgroundo(BACKGROUND_URCHIN, "urchin", ABILITY_SLEIGHT_OF_HAND, ABILITY_STEALTH, FEAT_BG_URCHIN,
              ...
              "you or to "
              "provide for you, so you learned to provide for yourself. You fought fiercely over "
              "food and kept "
              "a constant watch out for other desperate souls who might steal from you. You slept "
              "on rooftops "
              "and in alleyways, exposed to the elements, and endured sickness without the "
...
ACMDU(do_entertain)
{
  ...
  else
  {
    ...
    snprintf(buf, sizeof(buf), "You impress $N with your performance, who tips you %d coins.",
             gold);
    act(buf, FALSE, ch, 0, vict, TO_CHAR);
    snprintf(buf, sizeof(buf), "You are impressed with $n's performance, and you tip $m %d coins.",
             gold);
    act(buf, FALSE, ch, 0, vict, TO_VICT);
    act("$N looks impressed with $n's performance, and tips $m some coins.", FALSE, ch, 0, vict,
        TO_NOTVICT);
...
ACMDU(do_tribute)
{
  ...
  else
  {
    ...
    snprintf(buf, sizeof(buf), "$N knows of your accolades and offers you a tribute of %d coins.",
             gold);
    act(buf, FALSE, ch, 0, vict, TO_CHAR);
    snprintf(buf, sizeof(buf), "You know of $n's accolades and offer $m a tribute of %d coins.",
             gold);
    act(buf, FALSE, ch, 0, vict, TO_VICT);
    act("$N knows of $n's accolades and offers $m a tribute of some coins.", FALSE, ch, 0, vict,
        TO_NOTVICT);
...
ACMDU(do_forgeas)
{
  ...
  {
    send_to_char(ch, "The name you forge as cannot exceed 50 characters. ( not including color "
                     "code characters)\r\n");
    return;
  }
...
ACMD(do_relay)
{
  ...
  {
    send_to_char(
        ch, "That is an NPC.  Please specify a player name. Try using 2.name, 3.name, etc.\r\n");
    return;
  }
  ...
  act("A street urchin runs up and gives you a rolled piece of paper.", FALSE, 0, 0, recipient,
      TO_VICT);
  act("A street urchin runs up and gives $n a rolled piece of paper.", FALSE, recipient, 0, 0,
      TO_ROOM);
}
...
ACMD(do_forage)
{
  ...
  send_to_char(ch,
               "You attempt to forage for some food... Roll %d + %d (nature skill) for total %d "
               "vs. dc %d\r\n",
...
ACMD(do_retainer)
{
  ...
  else if (is_abbrev(arg1, "call"))
  {
    ...
    if (!retainer)
    {
      send_to_char(ch, "The system could not find the retainer mob. Please inform staff with code "
                       "ERRRET001.\r\n");
      return;
    }
  ...
  else if (is_abbrev(arg1, "sell"))
  {
    ...
    send_to_char(ch,
                 "Your retainer gives you a bank note worth %d coins, and then departs to sell the "
                 "items you gave them.\r\n",
                 gold);
  ...
  else if (is_abbrev(arg1, "mail"))
  {
    if ((retainer = get_retainer_from_room(ch)) == NULL)
    {
      send_to_char(ch, "You need to call your retainer in order to send a message. Use 'retainer "
                       "call' to do so.\r\n");
      return;
    }
    ...
    {
      send_to_char(ch, "You need to specify your mail recipient first by typing: retainer "
    ...
    if (IN_ROOM(recipient) != NOWHERE)
    {
      ...
      {
        send_to_char(
            ch, "Your retainer can only send to recipients in allied zones. This means you must be "
                "clanned and both you and your recipient are in a clan allied zone.\r\n");
        return;
      }
    }
    else
    ...
    act("You hand $p to youor retainer, who runs off to find your contact.", FALSE, 0, obj, ch,
        TO_VICT);
    act("$n hands $p to $s retainer, who runs off.", FALSE, ch, obj, 0, TO_ROOM);

    act("A hired retainer runs up and gives you a rolled piece of paper.", FALSE, 0, 0, recipient,
        TO_VICT);
    act("A hired retainer runs up and gives $n a rolled piece of paper.", FALSE, recipient, 0, 0,
        TO_ROOM);
...
ACMD(do_shortcut)
{
  ...
  {
    send_to_char(
        ch, "You must specify a player, mob or room vnum. Rooms vnum can "
  ...
  {
    send_to_char(
        ch, "You do not have a hometown set. This is required to use this ability.\r\n"
