...
| 35 | 1 | (295,38) to (295,38) | 108 m | Ocean | Islet |
...
| 72 | 3 | (755,79) to (756,80) | 108 m | Ocean | Islet |
...
| 109 | 2 | (326,107) to (326,108) | 108 m | Ocean | Islet |
...
| 146 | 5 | (258,151) to (260,153) | 108 m | Ocean | Islet |
...
| 183 | 1 | (220,195) to (220,195) | 107 m | Ocean | Islet |
...
| 220 | 1 | (579,228) to (579,228) | 128 m | Beach | Islet |
...
| 257 | 14 | (434,280) to (440,283) | 108 m | Ocean | Islet |
...
| 294 | 56 | (234,333) to (243,346) | 134 m | Beach | Islet |
...
| 331 | 3 | (362,413) to (364,413) | 108 m | Ocean | Islet |
...
| 368 | 1 | (99,439) to (99,439) | 108 m | Ocean | Islet |
...
| 405 | 2 | (766,480) to (767,480) | 108 m | Ocean | Islet |
...
| 442 | 1 | (735,516) to (735,516) | 108 m | Ocean | Islet |
...
| 479 | 2 | (539,551) to (539,552) | 130 m | Beach | Islet |
...
| 516 | 1 | (729,584) to (729,584) | 128 m | Beach | Islet |
...
| 553 | 3 | (276,629) to (278,629) | 108 m | Ocean | Islet |
...
| 590 | 3 | (719,694) to (720,695) | 108 m | Ocean | Islet |
...
| 627 | 8 | (209,757) to (210,761) | 129 m | Beach | Islet |
...
| 664 | 2 | (233,795) to (234,795) | 128 m | Beach | Islet |
...
| 701 | 1 | (76,897) to (76,897) | 128 m | Beach | Islet |
...
| 11 | 917 | 209 m | 186 m | Mountain Range 11 |
...
#### Mountain Range 2 Ridge Points (first 10):
...
Key factors affecting settlement viability:
...
| Crystal | Rare | Deep Mountains | Magic, Trade |
...
| Water | Impassable | Impassable | Boat required |
...
|00000001~3456766554~~~211000000000000000000000000000000000000000|
|11000001~4445544443~~~211000000000000000000000000000000000000000|
|~111000134555433444~2~110000000000000000000000000000000000000000|
|4~2~~~~~3555443344~2~~100000000000000000000000000000000000000000|
|43~3434~~556443~3~1111000000000000000000000000000000000000000000|
|44334444445543~~~~1000000000000000000000000000000000000000000000|
|34434344443~~211101000000000000000000000000000000000000000000000|
|~43~3333~~201000000000000000000000000000000000000000000000000000|
|2~~~~~~111000000000000000000000000000000000000000000000000000000|
...
#### Legend
- `~` Water
- `0-9` Elevation levels (0=lowest, 9=highest)
...
Analyzing accessibility between major geographical features.

### Distance Matrix (in tiles)

| From/To | P1 | P2 | P3 |
|---------|----|----|----|
| P1 (256,256) |   0 | 400 | 566 |
| P2 (256,656) | 400 |   0 | 400 |
| P3 (656,656) | 566 | 400 |   0 |

### Accessibility Scores
- **100**: Very accessible (<50 tiles)
- **75**: Accessible (50-200 tiles)
- **50**: Moderate (200-500 tiles)
- **25**: Remote (>500 tiles)


## Biodiversity Indices

Measuring ecological diversity across the world.

### Shannon-Weaver Diversity Index

- **H' = 0.482** (higher values indicate greater diversity)
- **H'max = 3.611** (maximum possible diversity)

### Simpson's Diversity Index

- **D = 0.174** (0 = no diversity, 1 = infinite diversity)

### Pielou's Evenness Index

- **J' = 0.133** (0 = uneven, 1 = perfectly even)

### Resource Diversity

| Resource Type | Presence Count | Coverage % |
|---------------|----------------|------------|
| Vegetation | 4096 | 100.0% |
| Minerals | 4096 | 100.0% |
| Water | 4096 | 100.0% |
| Herbs | 4096 | 100.0% |
| Game | 4096 | 100.0% |
...
Analyzing world exploration potential and coverage.

### Global Coverage Statistics

- **Explorable Area**: 100.0% of world
- **Easily Accessible**: 2.8% of world
- **Hazardous Terrain**: 0.4% of world
- **Total Tiles Sampled**: 16384

### Coverage by Climate Zone

| Climate Zone | Explored Tiles | Total Tiles | Coverage % |
|--------------|----------------|-------------|------------|
| Arctic | 3328 | 3328 | 100.0% |
| Subarctic | 3328 | 3328 | 100.0% |
| Temperate | 3200 | 3200 | 100.0% |
| Subtropical | 3328 | 3328 | 100.0% |
| Tropical | 3200 | 3200 | 100.0% |

### Exploration Difficulty Index

- **Easy** (Plains, Roads): 2.8%
- **Moderate** (Forest, Hills): 97.2%
- **Difficult** (Mountains, Deep Water): 0.4%


## Fractal Dimension Analysis

Measuring terrain complexity using box-counting method.

### Coastline Fractal Dimension

| Box Size | Boxes with Coast | log(1/size) | log(count) |
|----------|------------------|-------------|------------|
| 8 | 1504 | -2.079 | 7.316 |
| 16 | 899 | -2.773 | 6.801 |
| 32 | 361 | -3.466 | 5.889 |
...
**Estimated Fractal Dimension: D = 0.000**
- D = 1.0: Smooth coastline
- D = 1.2-1.3: Typical natural coastline
- D = 1.5+: Very complex, fjord-like coastline

### Mountain Range Complexity

- **Mountain Coverage**: 20 boxes (32x32)
- **Terrain Roughness**: Low (mostly flat)
